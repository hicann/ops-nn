...
private:
    ...
    __aicore__ inline void AvgPoolW(const uint8_t diFactor, const uint8_t hiFactor, const uint8_t wiFactor,
                                    int64_t curWoFactor);
    __aicore__ inline void AvgPoolH(const uint8_t diFactor, const uint8_t hiFactor, const int64_t curWoFactor,
                                    int64_t curHoFactor);
    __aicore__ inline void AvgPoolD(const uint8_t diFactor, const uint8_t hiFactor, const int64_t curWoFactor,
                                    int64_t curHoFactor);
    __aicore__ inline void TransOut(int64_t curDoFactor, int64_t curHoFactor, int64_t curWoFactor);
    __aicore__ inline void CopyOut(int64_t curNcFactor, int64_t curDoFactor, int64_t curHoFactor, int64_t curWoFactor,
                                   int64_t yGmOffset);
...
template <typename T>
__aicore__ inline void AvgPool3dNormal<T>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR workspace,
                                                const AvgPool3DTilingData* __restrict__ tiling, TPipe* pipe)
{
    InitTiling(tiling);
 ...
 */
template <typename T>
__aicore__ inline void AvgPool3dNormal<T>::TransInput(int64_t curNcFactor, const uint8_t diFactor,
...
template <typename T>
__aicore__ inline void AvgPool3dNormal<T>::CopyOut(int64_t curNcFactor, int64_t curDoFactor, int64_t curHoFactor,
...
template <typename T>
__aicore__ inline void AvgPool3dNormal<T>::AvgPoolW(const uint8_t diFactor, const uint8_t hiFactor,
                                                    const uint8_t wiFactor, int64_t curWoFactor)
{
...
template <typename T>
__aicore__ inline void AvgPool3dNormal<T>::AvgPoolH(const uint8_t diFactor, const uint8_t hiFactor, int64_t curWoFactor,
                                                    int64_t curHoFactor)
{
...
template <typename T>
__aicore__ inline void AvgPool3dNormal<T>::AvgPoolD(const uint8_t diFactor, const uint8_t hiFactor, int64_t curWoFactor,
                                                    int64_t curHoFactor)
{
    auto woFactorAlign = Ceil(curWoFactor, 8) * 8;
        ...
        for (auto doLoop = 0; doLoop < incoreDCnt; doLoop++) {
            ...
            for (auto hoLoop = 0; hoLoop < incoreHCnt; hoLoop++) {
                ...
                for (auto woLoop = 0; woLoop < incoreWCnt; woLoop++) {
                    ...
                    auto xGmOffset = ncCoreIdx * poolVars.DiHiWi + dStart * poolVars.HiWi + hStart * poolVars.Wi +
                                     wStart;
