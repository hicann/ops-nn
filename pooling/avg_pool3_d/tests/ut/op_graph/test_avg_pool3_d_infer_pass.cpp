...
TEST(AvgPool3DGraphInfer, InferDataTypeFP16)
{
    gert::OpInferDataTypeContextBuilder builder;
    builder.OpType("AvgPool3D").OpName("AvgPool3D");
    builder.IONum(1, 1);
    ...
    ASSERT_EQ(ops::InferDataTypeAvgPool3D(context), ge::GRAPH_SUCCESS);
    EXPECT_EQ(context->GetOutputDataType(0), ge::DT_FLOAT16);
}

TEST(AvgPool3DGraphInfer, InferDataTypeFP32)
{
    gert::OpInferDataTypeContextBuilder builder;
    builder.OpType("AvgPool3D").OpName("AvgPool3D");
    builder.IONum(1, 1);
...
TEST(AvgPool3DGraphInfer, InferDataTypeBF16)
{
    gert::OpInferDataTypeContextBuilder builder;
    builder.OpType("AvgPool3D").OpName("AvgPool3D");
    builder.IONum(1, 1);
...
TEST(AvgPool3DGraphInfer, InferDataTypeUnsupportedDtype)
{
    gert::OpInferDataTypeContextBuilder builder;
    builder.OpType("AvgPool3D").OpName("AvgPool3D");
    builder.IONum(1, 1);
    ...
    EXPECT_EQ(ops::InferDataTypeAvgPool3D(context), ge::GRAPH_FAILED);
}

TEST(AvgPool3DGraphInfer, RejectsNullContext) { EXPECT_EQ(ops::InferDataTypeAvgPool3D(nullptr), ge::GRAPH_FAILED); }
