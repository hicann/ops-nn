...
protected:
    static void SetUpTestCase() { std::cout << "MaxPoolV3Tiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "MaxPoolV3Tiling TearDown" << std::endl; }
};
...
TEST_F(MaxPoolV3Tiling, MaxPoolV3Tiling_NCHW_Test0)
{
    ...
    ExecuteTestCase(xShape, yShape, ksize, strides, padding_mode, pads, data_format, global_pooling, ceil_mode, dtype,
