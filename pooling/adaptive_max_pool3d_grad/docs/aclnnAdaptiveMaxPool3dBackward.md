...
- 确定性计算：
  <!-- npu="A3,910b" id11 -->
  - <term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>：aclnnAdaptiveMaxPool3dBackward默认非确定性实现，支持通过aclrtCtxSetSysParamOpt开启确定性。
  <!-- end id11 -->
  <!-- npu="950" id12 -->
  - <term>Ascend 950PR/Ascend 950DT</term>：aclnnAdaptiveMaxPool3dBackward默认确定性实现。
  <!-- end id12 -->
