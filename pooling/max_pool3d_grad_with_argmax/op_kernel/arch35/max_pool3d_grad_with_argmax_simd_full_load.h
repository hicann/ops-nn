...
class MaxPool3DGradWithArgmaxNCDHWFullLoadKernel : public Pool3DGradCommon::Pool3DGradNcdhwKernelBase {
public:
                                                ...
                                                Reg::RegTensor<int32_t>& indexIncReg)
{
    ...
    PoolUtils::Compute::FastDivImpl(ncIndexIncRegU32, (Reg::RegTensor<uint32_t>&)localIndexIncReg, magicHighReg,
                                    shiftHigh, pregT3);
