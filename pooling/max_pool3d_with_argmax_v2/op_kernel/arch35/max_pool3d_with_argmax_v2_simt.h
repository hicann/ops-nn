...
constexpr uint32_t DEFAULT_THREAD_DIM = 256;
...
template <typename VALUE_T, typename INDICES_T, int64_t Format_T, bool useINT64Index,
          uint32_t threadDim = DEFAULT_THREAD_DIM>
class MaxPool3DWithArgmaxV2Simt {
public:
    __aicore__ inline MaxPool3DWithArgmaxV2Simt(
        const MaxPool3DWithArgmaxV2Tiling::MaxPool3DWithArgmaxV2SimtTilingData* __restrict tilingData)
...
template <typename VALUE_T, typename INDICES_T, int64_t Format_T, bool useINT64Index, uint32_t threadDim>
__aicore__ inline void MaxPool3DWithArgmaxV2Simt<VALUE_T, INDICES_T, Format_T, useINT64Index, threadDim>::Init(
...
template <typename VALUE_T, typename INDICES_T, int64_t Format_T, bool useINT64Index, uint32_t threadDim>
__aicore__ inline void MaxPool3DWithArgmaxV2Simt<VALUE_T, INDICES_T, Format_T, useINT64Index, threadDim>::Process()
{
    Compute();
}

template <typename VAL_T, typename IDX_T, typename PROCESS_T, typename FASTDIV_T, uint32_t threadDim>
__simt_vf__ __aicore__ LAUNCH_BOUND(threadDim) inline void MaxPool3DNcdhw(
...
template <typename VAL_T, typename IDX_T, typename PROCESS_T, typename FASTDIV_T, uint32_t threadDim>
__simt_vf__ __aicore__ LAUNCH_BOUND(threadDim) inline void MaxPool3DNdhwc(
...
template <typename VALUE_T, typename INDICES_T, int64_t Format_T, bool useINT64Index, uint32_t threadDim>
__aicore__ inline void MaxPool3DWithArgmaxV2Simt<VALUE_T, INDICES_T, Format_T, useINT64Index, threadDim>::Compute()
    const
{
