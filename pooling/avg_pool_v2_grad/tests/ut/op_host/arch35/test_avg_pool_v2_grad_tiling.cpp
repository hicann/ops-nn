...
protected:
    static void SetUpTestCase() { std::cout << "AvgPoolV2GradTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AvgPoolV2GradTiling TearDown" << std::endl; }
};
...
static void ExecuteTestCase(gert::StorageShape xShape, gert::StorageShape yShape, gert::StorageShape gradShape,
                            std::vector<int64_t> ksize, std::vector<int64_t> strides, std::string padding_mode,
                            std::vector<int64_t> pads, std::string data_format, bool global_pooling, bool ceil_mode,
                            bool exclusive, int32_t divisor_override, ge::DataType dtype, ge::DataType dtypeIdx,
...
TEST_F(AvgPoolV2GradTiling, AvgPoolV2GradTiling_Test_nchw_tiling_1)
{
    ...
    ExecuteTestCase(xShape, yShape, gradShape, ksize, strides, padding_mode, pads, data_format, global_pooling,
                    ceil_mode, exclusive, divisor_override, dtype, dtypeIdx, except_tilingkey, shape_data);
}
