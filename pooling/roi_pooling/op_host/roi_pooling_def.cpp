...
/*!
 * \file roi_pooling_def.cpp
 * \brief op definition for roi_pooling
 */
#include "register/op_def_registry.h"

namespace ops {
class ROIPooling : public OpDef {
public:
    explicit ROIPooling(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        aicoreConfig.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "roi_pooling_apt");
