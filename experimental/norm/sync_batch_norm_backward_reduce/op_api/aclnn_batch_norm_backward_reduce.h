 ...
 */
ACLNN_API aclnnStatus aclnnBatchNormReduceBackwardGetWorkspaceSize(const aclTensor* gradOut, const aclTensor* input,
                                                                   const aclTensor* mean, const aclTensor* invstd,
                                                                   const aclTensor* weight, bool inputG, bool weightG,
                                                                   bool biasG, aclTensor* sumDy, aclTensor* sumDyXmu,
