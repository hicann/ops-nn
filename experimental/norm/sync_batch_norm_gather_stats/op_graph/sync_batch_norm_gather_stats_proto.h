...
* Must be one of the following types: float16, float32. Has the same type, shape and format as "total_sum".
* @li sample_count: A 1-D tensor. Number of data for each device. The format must be ND.
* Must be one of the following types: int32, float16, float32. The value of "sample_count" needs to be consistent with
the N-axis value of "total_sum".
* @li mean: A 1-D tensor. Runtime mean. The format must be ND.
* Must be one of the following types: float16, float32. The value of "mean" needs to be consistent with the C-axis value
of "total_sum".
* @li variance: A 1-D tensor. Runtime variance. The format must be ND.
* Must be one of the following types: float16, float32. Has the same type, shape and format as input "mean".
...
REG_OP(SyncBatchNormGatherStats)
    ...
    .INPUT(sample_count, TensorType({DT_INT32, DT_FLOAT16, DT_FLOAT}))
