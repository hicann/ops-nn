...
# dtype-dependent compare tolerance (mirrors batch_normalization_grad): low-precision
# types have a larger ULP, so the bar is relaxed accordingly instead of the float32-only
# 1e-5/1e-5 that never fits fp16/bf16.
TOL_CFG = {
    "float32": (1e-4, 1e-4),
    "float16": (1e-2, 1e-3),
    "bfloat16": (2e-2, 2e-3),
