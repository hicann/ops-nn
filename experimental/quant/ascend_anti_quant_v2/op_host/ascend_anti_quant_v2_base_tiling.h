...
/*!
 * \file ascend_anti_quant_v2_base_tiling.h
 * \brief
 */

#ifndef OPS_CUSTOM_OP_TILING_RUNTIME_ASCEND_ANTI_QUANT_V2_BASE_TILING_H
#define OPS_CUSTOM_OP_TILING_RUNTIME_ASCEND_ANTI_QUANT_V2_BASE_TILING_H
...
#include "op_host/tiling_base.h" // op_host
#include "op_common/op_host/util/platform_util.h"
#include "op_host/tiling_templates_registry.h" //op_host
#include "../op_kernel/arch22/ascend_anti_quant_v2_tilingdata.h"
...
public:
    explicit AscendAntiQuantV2Base(gert::TilingContext* context) : context_(context) {};
...
protected:
    ...
    uint32_t GetCoreNumWithMinFactor(int64_t factor, int64_t coreNum, int64_t minFactor) const;
    void CalcTiling();
    void CalcTilingKey();
    ...
    void CalcPerHeadUBFactor(int64_t gmBlockNum);
...
private:
    ...
    int64_t gmBlockSize_{512};
    int64_t ubBlockSize_{32};
    int64_t repeatSize_{64};
