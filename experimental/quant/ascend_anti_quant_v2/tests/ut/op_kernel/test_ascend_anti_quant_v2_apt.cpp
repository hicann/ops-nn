...
#include "../../../op_kernel/ascend_anti_quant_v2.cpp"
...
{
    size_t inputXSize = 128 * 512 * sizeof(int8_t);
    ...
    tilingDatafromBin->lcmN = 0;
    tilingDatafromBin->baseLenEx = 0;
    tilingDatafromBin->blockUnion = 0;
