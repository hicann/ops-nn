...
/*!
 * \file ascend_anti_quant_v2_per_tensor_no_offset_base.h
 * \brief ascendantiquantv2 kernel
 */

#ifndef ASCEND_ANTI_QUANT_V2_PER_TENSOR_NO_OFFSET_BASE_H_
#define ASCEND_ANTI_QUANT_V2_PER_TENSOR_NO_OFFSET_BASE_H_
...
class AscendAntiQuantV2PerTensorNoOffsetBase : public AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode> {
public:
    __aicore__ inline AscendAntiQuantV2PerTensorNoOffsetBase(const AscendAntiQuantV2TilingData* tilingData)
        : tilingData_(tilingData){};
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR scale, GM_ADDR offset, GM_ADDR y, TPipe* pipeIn);
    __aicore__ inline void Process();

private:
    __aicore__ inline void CopyXAndCompute(int64_t dataCount, int64_t offset, float sValue);
    ...
    __aicore__ inline void Compute(int64_t dataCount, float sValue);
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetBase<T, T1, T2, U, SqrtMode>::Init(GM_ADDR x, GM_ADDR scale,
                                                                                            ...
                                                                                            TPipe* pipeIn)
{
    ...
    pipeIn->InitBuffer(tmpBuf, 1 * 256);
}

template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetBase<T, T1, T2, U, SqrtMode>::Process()
{
    ...
    LocalTensor<float> floats = tmpBuf.Get<float>();
    ...
    for (int64_t i = 0; i < lenLoopNum; ++i) {
        CopyXAndCompute(tilingData_->baseLen, gmXOffset_ + i * tilingData_->baseLen, sValue);
    }
    if (lenLoopTail != 0) {
        CopyXAndCompute(lenLoopTail, gmXOffset_ + lenLoopNum * tilingData_->baseLen, sValue);
    }
    inQueueScale_.FreeTensor(sLocal);
}

template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetBase<T, T1, T2, U, SqrtMode>::CopyInScale()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetBase<T, T1, T2, U, SqrtMode>::CopyInX(int64_t xLen,
                                                                                               int64_t xInOffset)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetBase<T, T1, T2, U, SqrtMode>::Compute(int64_t dataCount,
                                                                                               float sValue)
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetBase<T, T1, T2, U, SqrtMode>::CopyXAndCompute(
    int64_t dataCount, int64_t offset, float sValue)
{
    CopyInX(dataCount, offset);
    Compute(dataCount, sValue);
    CopyOutY(dataCount, offset);
}

template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode>
__aicore__ inline void AscendAntiQuantV2PerTensorNoOffsetBase<T, T1, T2, U, SqrtMode>::CopyOutY(int64_t yLen,
                                                                                                int64_t yOutOffset)
{
