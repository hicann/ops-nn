...
#define TPL_PER_CHANNEL_NDDMA 2
...
ASCENDC_TPL_ARGS_DECL(AscendAntiQuantV2,
                      ASCENDC_TPL_UINT_DECL(perMode, 2, ASCENDC_TPL_UI_LIST, TPL_PER_TENSOR, TPL_PER_CHANNEL,
                                            TPL_PER_CHANNEL_NDDMA),
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ASCENDC_TPL_UINT_SEL(perMode, ASCENDC_TPL_UI_LIST, TPL_PER_TENSOR, TPL_PER_CHANNEL, TPL_PER_CHANNEL_NDDMA),
