...
protected:
    static void SetUpTestCase() { std::cout << "ReluV2ProtoTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ReluV2ProtoTest TearDown" << std::endl; }
};

TEST_F(ReluV2ProtoTest, relu_infer_shape_fp16)
{
...
TEST_F(ReluV2ProtoTest, relu_infer_shape_fp32)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(ReluV2ProtoTest, relu_infer_shape_4d_nchw)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(ReluV2ProtoTest, relu_infer_shape_8d)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(ReluV2ProtoTest, relu_infer_shape_empty)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(ReluV2ProtoTest, relu_infer_shape_scalar)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
...
TEST_F(ReluV2ProtoTest, relu_infer_shape_large)
{
    fe::PlatformInfo platformInfo;
    fe::OptionalInfo optiCompilationInfo;
    platformInfo.soc_info.ai_core_cnt = 64;
