...
#include "../../../../op_host/arch35/relu_v2_tiling_arch35.h"
...
TEST_F(ReluV2TilingTest, test_tiling_fp16_001)
{
...
TEST_F(ReluV2TilingTest, test_tiling_bf16_002)
{
    std::string op_type("ReluV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ReluV2TilingTest, test_tiling_fp32_003)
{
    std::string op_type("ReluV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ReluV2TilingTest, test_tiling_int8_004)
{
    std::string op_type("ReluV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ReluV2TilingTest, test_tiling_int32_005)
{
    std::string op_type("ReluV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ReluV2TilingTest, test_tiling_int64_006)
{
    std::string op_type("ReluV2");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
