...
#include "../../../op_api/aclnn_add_relu.h"
...
class l2_inplace_add_relu_test : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "inplace_add_relu_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "inplace_add_relu_test TearDown" << std::endl; }
};

TEST_F(l2_inplace_add_relu_test, case_1)
{
    auto tensor_desc = TensorDesc({1, 16, 1, 1}, ACL_FLOAT, ACL_FORMAT_NCHW);
    auto scalar_desc = ScalarDesc(1.0f);

    auto ut = OP_API_UT(aclnnInplaceAddRelu, INPUT(tensor_desc, tensor_desc, scalar_desc), OUTPUT());
...
TEST_F(l2_inplace_add_relu_test, case_nullptr)
{
    auto tensor_desc = TensorDesc({1, 16, 1, 1}, ACL_FLOAT, ACL_FORMAT_NCHW);

    auto ut = OP_API_UT(aclnnInplaceAddRelu, INPUT((aclTensor*)nullptr, (aclTensor*)nullptr, (aclScalar*)nullptr),
                        OUTPUT());
...
// 计算图三
TEST_F(l2_inplace_add_relu_test, case_001)
{
    ...
    auto ut = OP_API_UT(aclnnInplaceAddRelu, INPUT(self_tensor_desc, other_tensor_desc, scalar_desc), OUTPUT());
...
TEST_F(l2_inplace_add_relu_test, case_002)
{
...
TEST_F(l2_inplace_add_relu_test, case_003)
{
...
TEST_F(l2_inplace_add_relu_test, case_004)
{
...
TEST_F(l2_inplace_add_relu_test, case_005)
{
...
TEST_F(l2_inplace_add_relu_test, case_006)
{
...
TEST_F(l2_inplace_add_relu_test, case_007)
{
...
TEST_F(l2_inplace_add_relu_test, case_0010)
{
...
TEST_F(l2_inplace_add_relu_test, case_013)
{
...
TEST_F(l2_inplace_add_relu_test, case_014)
{
...
TEST_F(l2_inplace_add_relu_test, case_015)
{
...
// 空tensor
TEST_F(l2_inplace_add_relu_test, case_16)
{
...
TEST_F(l2_inplace_add_relu_test, case_017)
{
...
TEST_F(l2_inplace_add_relu_test, case_019)
{
...
// CheckNotNull
TEST_F(l2_inplace_add_relu_test, case_020)
{
    auto tensor_desc = TensorDesc({10, 5}, ACL_FLOAT, ACL_FORMAT_ND);

    auto ut = OP_API_UT(aclnnInplaceAddRelu, INPUT(tensor_desc, tensor_desc, nullptr), OUTPUT());
    // SAMPLE: only test GetWorkspaceSize
    uint64_t workspace_size = 0;
    aclnnStatus aclRet = ut.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);
    ...
    auto ut_2 = OP_API_UT(aclnnInplaceAddRelu, INPUT(nullptr, tensor_desc, scalar_desc), OUTPUT());
    // SAMPLE: only test GetWorkspaceSize
    aclRet = ut_2.TestGetWorkspaceSize(&workspace_size);
    EXPECT_EQ(aclRet, ACLNN_ERR_PARAM_NULLPTR);

    auto ut_3 = OP_API_UT(aclnnInplaceAddRelu, INPUT(tensor_desc, nullptr, scalar_desc), OUTPUT());
    // SAMPLE: only test GetWorkspaceSize
...
// CheckDtypeValid
TEST_F(l2_inplace_add_relu_test, case_021)
{
...
// CheckShape
TEST_F(l2_inplace_add_relu_test, case_022)
{
