...
#ifndef OP_API_INC_LEVEL2_ACLNN_SELU_GRAD_H_
#define OP_API_INC_LEVEL2_ACLNN_SELU_GRAD_H_
 ...
 * @param [in] gradOutput: npu device侧的aclTensor, 数据类型支持INT8、UINT8、INT32、FLOAT、FLOAT16、BFLOAT16，
 * shape为非空，支持非连续的Tensor，数据格式支持ND。
 * @param [in] result: npu device侧的aclTensor, 数据类型支持INT8、UINT8、INT32、FLOAT、FLOAT16、BFLOAT16，
 * shape与gradOutput保持相同，数据格式支持ND。
 * @param [in] gradInput: npu device侧的aclTensor, 数据类型支持INT8、UINT8、INT32、FLOAT、FLOAT16、BFLOAT16，
 * shape与gradOutput保持相同，数据格式支持ND。
