...
protected:
    ...
    static void RunTest(const IndexFillTestParams& params, int tilingKey)
    {
        ...
        const size_t kValueSize = 1 * sizeof(DTYPE_X);

        // 计算数据尺寸（Q=0时为二维：P*N，否则为三维：P*N*Q）
        size_t dataDim3 = (params.Q == 0) ? 1 : params.Q;
        size_t dataSize = params.P * params.N * dataDim3 * sizeof(DTYPE_X);
        size_t indicesSize = params.indicesNum * sizeof(DTYPE_INDICES);
...
{
    IndexFillTestParams params = {.P = 100,
                                  .N = 7,
                                  .Q = 89567,
                                  .indicesNum = 18,
...
{
    IndexFillTestParams params = {.P = 12,
                                  .N = 640,
                                  .Q = 128,
                                  .indicesNum = 600,
                                  .indicesProcessMode = 0,
...
{
    IndexFillTestParams params = {.P = 1000,
                                  .N = 32,
                                  .Q = 32,
                                  .indicesNum = 40,
                                  .indicesProcessMode = 0,
...
{
    IndexFillTestParams params = {.P = 1200,
                                  .N = 128,
                                  .Q = 0,
                                  .indicesNum = 128,
                                  .indicesProcessMode = 0,
