...
protected:
    static void SetUpTestCase() { cout << "inpace_index_fill_tensor_test SetUp" << endl; }
...
{
    int64_t dim = 1;
    auto tensor_self = TensorDesc({2, 2, 2, 2, 2, 2, 2, 2, 2, 2}, ACL_INT32, ACL_FORMAT_ND).ValueRange(-10, 10);
    auto index = IntArrayDesc(vector<int64_t>{0, 2});
    auto fillVal = ScalarDesc(static_cast<int32_t>(1));
