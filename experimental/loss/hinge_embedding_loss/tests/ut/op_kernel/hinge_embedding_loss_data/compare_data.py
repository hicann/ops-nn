...
"""Golden comparison helper for HingeEmbeddingLoss."""
...
def main():
    ...
    if actual.shape != golden.shape or not np.allclose(
        ...
        print(f"HingeEmbeddingLoss comparison failed, max error: {max_error}")
        return 1
    print("HingeEmbeddingLoss comparison passed")
    return 0
