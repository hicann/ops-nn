...
每个算子分为[两段式接口](../../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnBinaryCrossEntropyWithLogitsBackwardGetWorkspaceSize”接口获取计算所需 workspace 大小以及执行器，再调用“aclnnBinaryCrossEntropyWithLogitsBackward”接口执行计算。
