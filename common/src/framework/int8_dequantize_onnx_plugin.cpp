...
REGISTER_CUSTOM_OP("PartitionedCall")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::8::Int8Dequantize"), ge::AscendString("ai.onnx::9::Int8Dequantize"),
                   ge::AscendString("ai.onnx::10::Int8Dequantize"), ge::AscendString("ai.onnx::11::Int8Dequantize"),
                   ge::AscendString("ai.onnx::12::Int8Dequantize"), ge::AscendString("ai.onnx::13::Int8Dequantize"),
                   ge::AscendString("ai.onnx::14::Int8Dequantize"), ge::AscendString("ai.onnx::15::Int8Dequantize"),
