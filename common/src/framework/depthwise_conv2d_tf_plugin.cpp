...
/*!
 * \file depthwise_conv2d_tf_plugin.cpp
 * \brief
 */
#include <vector>
...
/*!
 * @brief Replace GE ParseParams fuction to process graph depthwise_conv2d node attrs
 * @param opSrc the source op info from tf.
 * @param op the dest GE op.
 * @return status whether this operation success.
 */
static Status ParseParamsDepthwiseConv2D(const ge::Operator& opSrc, ge::Operator& op)
{
...
REGISTER_CUSTOM_OP("DepthwiseConv2D")
    ...
    .ParseParamsByOperatorFn(ParseParamsDepthwiseConv2D)
