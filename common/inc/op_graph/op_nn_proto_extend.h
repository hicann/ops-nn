...
#define OPS_PROTO_DEF_GLOBALLPPOOL
    ...
    */
    ...
    .OUTPUT(
        y, TensorType({DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_INT64, DT_FLOAT16, DT_FLOAT, DT_DOUBLE}))
...
*/
#ifndef OPS_PROTO_DEF_GATHER
#define OPS_PROTO_DEF_GATHER
        REG_OP(Gather)
...
#define OPS_PROTO_DEF_UNSORTEDSEGMENTPROD
    ...
    * @li x: A Tensor of the same type as `y_grad`, but with a size that is twice as large as `y_grad` along the axis
    `dim`.
    ...
    */
    ...
    .INPUT(
        data, TensorType(
                  {DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT8, DT_INT16, DT_INT32, DT_INT64, DT_UINT8, DT_UINT16,
    ...
    .INPUT(
        x, TensorType(
               {DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT8, DT_INT16, DT_INT32, DT_INT64, DT_UINT8, DT_UINT16, DT_UINT32,
                DT_UINT64, DT_BOOL}))
    .OUTPUT(
        y, TensorType(
               {DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT8, DT_INT16, DT_INT32, DT_INT64, DT_UINT8, DT_UINT16, DT_UINT32,
    ...
    */
    ...
    .INPUT(
        x, TensorType(
               {DT_INT8, DT_UINT8, DT_INT16, DT_UINT16, DT_INT32, DT_INT64, DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_STRING,
    ...
    */
    ...
    .INPUT(
        x, TensorType(
               {DT_FLOAT, DT_FLOAT16, DT_INT8, DT_INT16, DT_UINT16, DT_UINT8, DT_INT32, DT_INT64, DT_DOUBLE, DT_BF16,
                DT_UINT32, DT_UINT64}))
    .OUTPUT(
        y, TensorType(
               {DT_FLOAT, DT_FLOAT16, DT_INT8, DT_INT16, DT_UINT16, DT_UINT8, DT_INT32, DT_INT64, DT_DOUBLE, DT_BF16,
    ...
    * @li dout:A multi-dimensional Tensor of float16 or float32 or bfloat16,specifying the gradient transferred from the
    upper layer. \n

    * @par Outputs:
    * gradient: Sigmoid cross entropy between the predictive value and target value. Has the same dimensions as
    "predict" . \n

    * @par Third-party framework compatibility
    * Compatible with the scenario where "reduction" is set to "none"of PyTorch operator
