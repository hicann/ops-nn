...
static void TestOneParamCase(const TilingTestParam& param)
{
    ...
    holder = gert::TilingContextFaker()
                 ...
                 .NodeInputTd(2, param.bias_dtype, param.x2_ori_format, param.x2_format)
...
static TilingTestParam ascend950_cases_params[] = {
    {"FusedMatMul_basic_test00",
     ...
     32,
     33554465UL,
     "32 4096 1280 8192 256 256 192 256 256 64 8192 2 1 1 1 0 0 16843264 0 256 1 8192 0 "},
    ...
    {"FusedMatMul_950_basic_06",
     ...
     32,
     50331681UL,
     "32 4096 1280 8192 256 256 256 256 256 64 8192 2 1 1 1 0 0 16843264 0 256 1 8192 0 "},
    ...
    {"FusedMatMul_950_gelu_float_tiling_failed",
     ...
     ge::DT_FLOAT,
     ge::GRAPH_FAILED},
    // GELU ERF with FP16 bias should select the built-in GELU path.
    {"FusedMatMul_950_gelu_erf_bias_fp16",
     "FusedMatMul",
     "gelu_erf",
     R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":true, "offset_x":0, "enable_hf32":0},
      "binary_attrs":{"bias_flag":true, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
     ...
     ge::DT_FLOAT16,
     ge::GRAPH_SUCCESS},
    {"FusedMatMul_950_gelu_erf_fp16_bias_bf16_failed",
     "FusedMatMul",
     "gelu_erf",
     R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":true, "offset_x":0, "enable_hf32":0},
      "binary_attrs":{"bias_flag":true, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
     ...
     ge::DT_BF16,
     ge::GRAPH_FAILED},
    {"FusedMatMul_950_gelu_erf_fp16_bias_fp32_success",
     "FusedMatMul",
     "gelu_erf",
     R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":true, "offset_x":0, "enable_hf32":0},
      "binary_attrs":{"bias_flag":true, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
     ...
     ge::DT_FLOAT,
     ge::GRAPH_SUCCESS},
    {"FusedMatMul_950_gelu_tanh_bf16_bias_bf16_success",
     "FusedMatMul",
     "gelu_tanh",
     R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":true, "offset_x":0, "enable_hf32":0},
      "binary_attrs":{"bias_flag":true, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
     ...
     ge::DT_BF16,
     ge::GRAPH_SUCCESS},
    {"FusedMatMul_950_gelu_tanh_bf16_bias_fp32_success",
     "FusedMatMul",
     "gelu_tanh",
     R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":true, "offset_x":0, "enable_hf32":0},
      "binary_attrs":{"bias_flag":true, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
    ...
    {"FusedMatMul_950_bmm_streamk_relu",
     ...
     85988353UL,
     ""},
    {"FusedMatMul_950_unsupported_fused_op_type",
     "FusedMatMul",
     "not_supported_op",
     R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":true, "offset_x":0, "enable_hf32":0},
      "binary_attrs":{"bias_flag":false, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
     ...
     ge::DT_FLOAT16,
     ge::GRAPH_FAILED},
    {"FusedMatMul_950_add_small_n_bfulload",
     "FusedMatMul",
     "add",
     R"({"_pattern": "MatMul", "attrs":{"transpose_a":false,"transpose_b":true, "offset_x":0, "enable_hf32":0},
      "binary_attrs":{"bias_flag":false, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
     ...
     16,
     16908321UL,
     "16 16384 32 4096 1024 32 48 1024 32 16 4096 1 1 1 1 0 0 33686016 0 1024 1 4096 0 ",
     ge::DT_FLOAT16,
     ge::DT_FLOAT16,
     ge::DT_FLOAT16,
     ge::GRAPH_SUCCESS},
