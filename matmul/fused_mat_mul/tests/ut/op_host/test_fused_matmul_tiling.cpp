...
static TilingTestParam ascend950_cases_params[] = {
    ...
    {"FusedMatMul_950_mmoe_fused_op_type_none_basic_asw",
     ...
     26,
     33UL,
     "26 128 4096 18856 128 160 128 128 160 32 18856 1 1 1 1 0 0 33686016 0 128 1 0 ",
     ge::DT_FLOAT,
     ge::DT_FLOAT,
     ge::DT_FLOAT},
    {"FusedMatMul_950_mmoe_fused_op_type_relu_basic_asw",
     ...
     26,
     83886113UL,
     "26 128 4096 4096 128 160 128 128 160 32 4096 1 1 1 1 0 0 33686016 0 128 1 0 ",
     ge::DT_FLOAT,
     ge::DT_FLOAT,
     ge::DT_FLOAT},
    ...
    {"FusedMatMul_950_mmoe_fused_op_type_none_streamk",
     ...
     28,
     4129UL,
     "28 128 2048 4096 128 256 256 128 256 64 1366 1 1 1 1 0 0 16843264 0 128 1 0 ",
     ge::DT_BF16,
     ge::DT_BF16,
     ge::DT_BF16},
    {"FusedMatMul_950_mmoe_fused_op_type_none_streamk2aswt",
     ...
     26,
     33UL,
     "26 128 2048 4096 128 80 256 128 80 128 4096 1 1 1 1 0 0 33686016 0 128 1 0 ",
     ge::DT_BF16,
     ge::DT_BF16,
     ge::DT_BF16},
    ...
    {"FusedMatMul_950_mmoe_fused_op_type_relu_streamk",
     ...
     28,
     83890209UL,
     "28 128 64 18856 128 64 256 128 64 128 674 1 1 1 1 0 0 16843264 0 128 1 0 ",
     ge::DT_BF16,
     ge::DT_BF16,
     ge::DT_FLOAT},
    ...
    {"FusedMatMul_950_mmoe_basic_aswt_noFixpip_aFullLoad_add",
     ...
     32,
     16842769UL,
     "32 4 18944 3584 16 320 48 16 320 16 3584 1 1 1 1 0 0 33686529 2 16 1 0 ",
     ge::DT_FLOAT,
     ge::DT_FLOAT,
     ge::DT_FLOAT},
    ...
    {"FusedMatMul_950_mmoe_basic_aswt_noFixpip_bFullLoad_add",
     ...
     32,
     16777249UL,
     "32 11024 62 56 352 64 64 352 64 16 56 1 1 1 1 0 0 33686017 0 352 1 0 ",
     ge::DT_FLOAT,
     ge::DT_FLOAT,
     ge::DT_FLOAT},
    ...
    {"FusedMatMul_950_mmoe_basic_aswt_fixpipe1v2_bFullLoad_add",
     ...
     32,
     19005441UL,
     "32 16798 255 90 128 256 96 128 256 32 90 8 1 1 1 0 0 33686529 0 128 1 0 ",
     ge::DT_FLOAT,
     ge::DT_FLOAT,
     ge::DT_FLOAT},
    ...
    {"FusedMatMul_950_mmoe_basic_aswt_fixpipe1v2_noFullLoad_add",
     ...
     32,
     18874369UL,
     "32 4028 6539 126 256 256 128 256 256 32 126 1 1 1 1 0 0 16843265 0 256 1 0 ",
     ge::DT_FLOAT,
     ge::DT_FLOAT,
     ge::DT_FLOAT},
    ...
    {"FusedMatMul_950_bmm_aswt_mul_x3_matrix_broadcast",
     ...
     {256, 256},
     {256, 256}},
    {"FusedMatMul_950_bmm_aFullLoad_empty",
     "FusedMatMul",
     "",
     R"({"_pattern": "BatchMatMul", "attrs":{"transpose_a":true,"transpose_b":false, "offset_x":0, "enable_hf32": 1},
      "binary_attrs":{"bias_flag":false, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
    ...
    {"FusedMatMul_950_bmm_aFullLoad_relu",
     ...
     32,
     83952689UL,
     "32 16 68112 16 16 128 32 256 128 32 16 1 1 1 1 0 0 16909313 0 256 1 0 1 1 ",
     ge::DT_FLOAT,
     ge::DT_FLOAT,
     ge::DT_FLOAT},
    {"FusedMatMul_950_bmm_aFullLoad_add",
     "FusedMatMul",
     "add",
     R"({"_pattern": "BatchMatMul", "attrs":{"transpose_a":true,"transpose_b":false, "offset_x":0, "enable_hf32": 1},
      "binary_attrs":{"bias_flag":false, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
     ...
     ge::DT_FLOAT,
     ge::DT_FLOAT},
    {"FusedMatMul_950_bmm_aFullLoad_mul",
     "FusedMatMul",
     "mul",
     R"({"_pattern": "BatchMatMul", "attrs":{"transpose_a":true,"transpose_b":false, "offset_x":0, "enable_hf32": 1},
      "binary_attrs":{"bias_flag":false, "nd_flag":true, "split_k_flag":false, "zero_flag":false, "weight_nz": false, "l2_size":134217728},"binary_mode_flag":true,
    ...
    {"FusedMatMul_950_bmm_bFullLoad_empty",
     ...
     32,
     132113UL,
     "32 9040 16 3984 128 16 96 128 256 32 3984 4 1 1 1 0 0 33686529 0 128 1 0 1 1 ",
     ge::DT_FLOAT,
     ge::DT_FLOAT,
     ge::DT_FLOAT},
