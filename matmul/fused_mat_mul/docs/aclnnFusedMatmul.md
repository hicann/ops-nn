  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tbody>
      <tr>
        ...
        <td>数据类型需要与x2满足数据类型推导规则（参见<a href="../../../docs/zh/context/互推导关系.md" target="_blank">互推导关系</a>）。</td>
      ...
      <tr>
        ...
        <td>数据类型需要与x1满足数据类型推导规则（参见<a href="../../../docs/zh/context/互推导关系.md" target="_blank">互推导关系</a>）。</td>
        <td>数据类型与x1保持一致</td>
        <td>ND</td>
        <td>2</td>
        <td>√</td>
      ...
      <tr>
        ...
        <td>仅当fusedOpType为""、"relu"、"add"、"mul"时生效，其他情况传入空指针即可。</td>
        <td>FLOAT16、BFLOAT16、FLOAT32</td>
        <td>ND</td>
        <td>1-2</td>
        <td>√</td>
      ...
      <tr>
        ...
        <td>数据类型需要与x1和x2推导后的数据类型一致（参见<a href="../../../docs/zh/context/互推导关系.md" target="_blank">互推导关系</a>）。</td>
        <td>FLOAT16、BFLOAT16、FLOAT32</td>
        <td>ND</td>
        <td>2</td>
        <td>√</td>
    ...
    <tr>
      ...
      <tr>
        ...
        <td>融合模式取值必须是""（表示不做融合）、"add"、"mul"、"gelu_erf"、"gelu_tanh"、"relu"中的一种。</td>
        <td>STRING</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
