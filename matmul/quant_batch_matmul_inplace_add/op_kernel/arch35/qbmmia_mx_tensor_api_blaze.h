...
__aicore__ inline void QbmmiaMxTensorApiKernel(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR scale, GM_ADDR perTokenScale,
                                               GM_ADDR cGM, const void* tilingData)
{
    ...
    const QMMIA::QuantBatchMatmulInplaceAddTilingData&
        qbmmiaTilingData = *static_cast<const QMMIA::QuantBatchMatmulInplaceAddTilingData*>(tilingData);
