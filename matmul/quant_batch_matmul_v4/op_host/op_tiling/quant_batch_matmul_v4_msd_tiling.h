...
protected:
    ...
    void InitPlatformInfo(const QuantBatchMatmulV3CompileInfo* compileInfoPtr_,
    ...
    bool AnalyzeScalePerGroup(const gert::Shape& x1ScaleShape, const gert::Shape& x2ScaleShape, int64_t x1ScaleShapeLen,
