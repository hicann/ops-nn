...
__aicore__ inline void QbmmMxL0CPingpongTensorApiKernel(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR scale, GM_ADDR bias,
                                                        GM_ADDR perTokenScale, GM_ADDR cGM, const void* tilingData)
{
    ...
    using DispatchPolicy = Blaze::Gemm::MatmulWithScaleMxL0CPingpong<FULL_LOAD_MODE, false>;
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class aLayout, class bLayout, class cLayout,
          uint64_t FULL_LOAD_MODE = 0>
__aicore__ inline void QbmmMxL0CPingpongWithoutBatchTensorApiKernel(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR scale,
                                                                    GM_ADDR bias, GM_ADDR perTokenScale, GM_ADDR cGM,
