...
__aicore__ inline void QbmmCubeTensorApiKernel(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR scale, GM_ADDR bias,
                                               GM_ADDR perTokenScale, GM_ADDR cGM, const void* tilingData)
{
    ...
    using BlockMmad = Blaze::Gemm::Block::BlockMmad<Blaze::Gemm::MatmulWithScaleFixpipeQuant<FULL_LOAD_MODE>, AType,
                                                    aLayout, AscendC::Std::tuple<BType, X2ScaleType>, bLayout, OutType,
