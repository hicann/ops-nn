...
__aicore__ inline void QbmmMxStreamKBasicApiKernel(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR scale, GM_ADDR bias,
                                                   ...
                                                   const void* tilingData)
{
    ...
    using BlockEpilogue = Blaze::Epilogue::Block::BlockEpilogueMatmulStreamK<WorkspaceType, OutType,
