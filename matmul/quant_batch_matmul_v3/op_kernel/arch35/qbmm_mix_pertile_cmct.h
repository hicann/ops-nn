...
__aicore__ inline void QbmmCmctPertileKernel(GM_ADDR x, GM_ADDR weight, GM_ADDR bias, GM_ADDR scale,
                                             ...
                                             const void* tilingParamsIn, AscendC::TPipe* que)
{
    ...
    using BlockMmad = Cmct::Gemm::Block::BlockMmadPertile<BlockMmadPolicy, AType, LayoutA, BType, LayoutB, CType,
                                                          LayoutC, biasType, LayoutBias, L1Tileshape, L0Tileshape>;
    using BlockEpilogue = Cmct::Gemm::Block::BlockEpiloguePertile<L0Tileshape, YType, CType, BiasType, ptScaleType,
    ...
    QbmmTiling qbmmParams{dataParams.batchA1,      dataParams.batchA2,  dataParams.batchA3,
                          dataParams.batchA4,      dataParams.batchB1,  dataParams.batchB2,
                          dataParams.batchB3,      dataParams.batchB4,  dataParams.batchC1,
                          dataParams.batchC2,      dataParams.batchC3,  dataParams.batchC4,

                          matmulTiling.kAL1,       matmulTiling.kBL1,   matmulTiling.nBufferNum,
                          dataParams.biasThreeDim, matmulTiling.isBias, matmulTiling.weightMustHitL2};
