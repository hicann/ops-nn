...
#define TPL_NO_VEC_EPILOGUE_WITH_MMAPI_WITHOUT_BATCH 9
#define TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_WITHOUT_BATCH 10
#define TPL_NO_VEC_EPILOGUE_WITH_MMAPI_MX_L0C_PINGPONG 11
#define TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_MX_L0C_PINGPONG 12
#define TPL_NO_VEC_EPILOGUE_WITH_MMAPI_MX_L0C_PINGPONG_WITHOUT_BATCH 13
#define TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_MX_L0C_PINGPONG_WITHOUT_BATCH 14
#define TPL_VEC_EPILOGUE_STREAMK_WITH_MMAPI 15
#define TPL_VEC_EPILOGUE_WITH_MMAPI_WITHOUT_BATCH 16
#define TPL_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_WITHOUT_BATCH 17
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(BIASMODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, TPL_EXCLUDE_FROM_TEMPLATE,
                          TPL_CUBE_BIAS_BF16_TEMPLATE, TPL_CUBE_BIAS_FP16_TEMPLATE),
    ASCENDC_TPL_UINT_DECL(KERNELTYPE, ASCENDC_TPL_8_BW, ASCENDC_TPL_UI_LIST, TPL_NO_VEC_EPILOGUE_WITH_MMAPI,
                          ...
                          TPL_NO_VEC_EPILOGUE_WITH_MMAPI_MX_L0C_PINGPONG_WITHOUT_BATCH,
                          TPL_NO_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_MX_L0C_PINGPONG_WITHOUT_BATCH,
                          TPL_VEC_EPILOGUE_STREAMK_WITH_MMAPI, TPL_VEC_EPILOGUE_WITH_MMAPI_WITHOUT_BATCH,
                          TPL_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_WITHOUT_BATCH),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL( // kernel type {2, 16, 17} * ATRANS {0} * BTRANS {0, 1} * APILEVEL {2}
        ...
        ASCENDC_TPL_UINT_SEL(KERNELTYPE, ASCENDC_TPL_UI_LIST, TPL_VEC_EPILOGUE_WITH_MMAPI,
                             TPL_VEC_EPILOGUE_WITH_MMAPI_WITHOUT_BATCH,
                             TPL_VEC_EPILOGUE_CUSTOM_GMTOAL1_WITH_MMAPI_WITHOUT_BATCH),
    ...
    ASCENDC_TPL_ARGS_SEL( // kernel type {9, 10} * ATRANS {0, 1} * BTRANS {0, 1}
    ...
    ASCENDC_TPL_ARGS_SEL( // kernel type {15} * ATRANS {0, 1} * BTRANS {0, 1}
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2), ASCENDC_TPL_UINT_SEL(ATRANS, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(BTRANS, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(BIASMODE, ASCENDC_TPL_UI_LIST, TPL_EXCLUDE_FROM_TEMPLATE),
    ...
    ASCENDC_TPL_ARGS_SEL( // kernel type {6, 7} * api level {0} * ATRANS {0, 1} * BTRANS {0, 1}
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIC_ONLY), ASCENDC_TPL_UINT_SEL(ATRANS, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(BTRANS, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(BIASMODE, ASCENDC_TPL_UI_LIST, TPL_EXCLUDE_FROM_TEMPLATE), // Bias Mode 只有0
    ...
    ASCENDC_TPL_ARGS_SEL( // kernel type {11, 12, 13, 14} * api level {2} * ATRANS {0, 1} * BTRANS {0, 1}
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIC_ONLY), ASCENDC_TPL_UINT_SEL(ATRANS, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(BTRANS, ASCENDC_TPL_UI_LIST, 0, 1),
        ASCENDC_TPL_UINT_SEL(BIASMODE, ASCENDC_TPL_UI_LIST, TPL_EXCLUDE_FROM_TEMPLATE),
