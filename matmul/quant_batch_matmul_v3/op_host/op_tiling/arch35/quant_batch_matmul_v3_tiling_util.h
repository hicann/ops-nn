...
inline bool IsTensorapiCapable()
{
    ...
    constexpr int32_t kMinTensorApiAscDevkitVersion = 90100000;
    return aclsysGetVersionNum(pkgName, &versionNum) == ACL_SUCCESS && versionNum >= kMinTensorApiAscDevkitVersion;
}
