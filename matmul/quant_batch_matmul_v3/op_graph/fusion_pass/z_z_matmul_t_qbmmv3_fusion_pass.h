...
#ifndef NN_Z_Z_MATMUL_T_QBMMV3_FUSION_PASS_H
#define NN_Z_Z_MATMUL_T_QBMMV3_FUSION_PASS_H

#include "ge/fusion/pass/pattern_fusion_pass.h"

namespace ops {

class __attribute__((visibility("default"))) ZZMatMulTOQBMMV3FusionPass : public ge::fusion::PatternFusionPass {
protected:
...
#endif // NN_Z_Z_MATMUL_T_QBMMV3_FUSION_PASS_H
