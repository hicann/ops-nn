...
static const aclTensor* AddMatmulProcess(
    AclnnAddmmTensor& addmmTensor, int8_t cubeMathType, bool enable16In32Out, aclOpExecutor* uniqueExecutor)
{
...
public:
    ...
    aclnnStatus Impl() override{
        ...
        bool enable16In32Out = NeedEnableFp32Output(
            matA->GetDataType(), matB->GetDataType(), output->GetDataType(), cubeMathType, nullptr, true);
    ...
    aclTensor* out, int8_t cubeMathType, uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    bool enable16In32Out = NeedEnableFp32Output(
        mat1->GetDataType(), mat2->GetDataType(), out->GetDataType(), cubeMathType, nullptr, true);
