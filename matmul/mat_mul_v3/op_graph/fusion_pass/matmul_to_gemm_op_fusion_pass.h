...
/*!
 * \file matmul_to_gemm_op_fusion_pass.h
 * \brief matmul+cast+AssignAdd to GemmOp fusion pass
 */
#ifndef NN_MATMUL_TO_GEMM_OP_FUSION_PASS_H
#define NN_MATMUL_TO_GEMM_OP_FUSION_PASS_H

#include "ge/fusion/pass/pattern_fusion_pass.h"

namespace ops {

class __attribute__((visibility("default"))) MatmulToGemmOpFusionPass : public ge::fusion::PatternFusionPass {
protected:
...
#endif // NN_MATMUL_TO_GEMM_OP_FUSION_PASS_H
