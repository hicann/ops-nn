...
#ifndef NN_GEMM_TO_MATMUL_FUSION_PASS_H
#define NN_GEMM_TO_MATMUL_FUSION_PASS_H

#include "ge/fusion/pass/pattern_fusion_pass.h"

namespace ops {

class __attribute__((visibility("default"))) GemmToMatmulFusionPass : public ge::fusion::PatternFusionPass {
protected:
...
#endif // NN_GEMM_TO_MATMUL_FUSION_PASS_H
