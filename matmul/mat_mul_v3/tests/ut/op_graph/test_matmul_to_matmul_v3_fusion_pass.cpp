...
TEST_F(MatMulToMatmulV3FusionPassTest, unsupportedPlatform910B1Fp16Fail)
{
    ...
    auto graph = BuildMatMulLikeGraph("unsupportedPlatform910B1Fp16", "MatMul", {10832, 4224}, {4224, 1408},
                                      {10832, 1408}, DT_FLOAT16, false, false);
...
{
    auto graph = BuildMatMulLikeGraph("matMulFp16FusionSuccess", "MatMul", {10832, 4224}, {4224, 1408}, {10832, 1408},
                                      DT_FLOAT16, false, false, {}, kOpImplModeHf32);
...
{
    auto graph = BuildMatMulLikeGraph("matMulFp32FusionSuccess", "MatMul", {122872, 6}, {6, 2}, {122872, 2}, DT_FLOAT,
...
{
    auto graph = BuildMatMulLikeGraph("matMulBf16FusionSuccess", "MatMul", {62080, 1536}, {1536, 384}, {62080, 384},
                                      DT_BF16, false, false, {}, kOpImplModeHf32);
...
{
    auto graph = BuildMatMulLikeGraph("matMulTransposeFp16FusionSuccess", "MatMul", {27392, 1024}, {2048, 27392},
                                      {1024, 2048}, DT_FLOAT16, true, true, {}, kOpImplModeHf32);
...
{
    auto graph = BuildMatMulLikeGraph("matMulV2Fp16FusionSuccess", "MatMulV2", {10832, 4224}, {4224, 1408},
                                      {10832, 1408}, DT_FLOAT16, false, false, {}, kOpImplModeHf32);
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulFp16", "BatchMatMul", {2, 3, 32, 64}, {2, 3, 64, 128},
                                      {2, 3, 32, 128}, DT_FLOAT16, false, false);
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulTransX1Fp16", "BatchMatMul", {2, 3, 64, 32}, {2, 3, 64, 128},
                                      {2, 3, 32, 128}, DT_FLOAT16, true, false);
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulV2Fp16", "BatchMatMulV2", {2, 3, 32, 64}, {2, 3, 64, 128},
                                      {2, 3, 32, 128}, DT_FLOAT16, false, false);
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulV2Bf16", "BatchMatMulV2", {2, 3, 32, 64}, {2, 3, 64, 128},
                                      {2, 3, 32, 128}, DT_BF16, false, false);
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulV2Fp32", "BatchMatMulV2", {2, 3, 32, 64}, {2, 3, 64, 128},
                                      {2, 3, 32, 128}, DT_FLOAT, false, false, {}, kOpImplModeHf32);
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulV2Int8", "BatchMatMulV2", {2, 3, 32, 64}, {2, 3, 64, 128},
                                      {2, 3, 32, 128}, DT_INT8, false, false);
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulV2Int32", "BatchMatMulV2", {2, 3, 32, 64}, {2, 3, 64, 128},
                                      {2, 3, 32, 128}, DT_INT32, false, false);
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulWithBiasUserShapeFp16", "BatchMatMul", {3000, 1, 60}, {3000, 60, 64},
                                      {3000, 1, 64}, DT_FLOAT16, false, false, {64});
...
{
    auto graph = BuildMatMulLikeGraph("batchMatMulV2WithBiasFp32Hf32", "BatchMatMulV2", {2, 3, 32, 64}, {2, 3, 64, 128},
                                      {2, 3, 32, 128}, DT_FLOAT, false, false, {128}, kOpImplModeHf32);
