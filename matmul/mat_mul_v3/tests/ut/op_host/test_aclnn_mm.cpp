...
TEST_F(l2_mm_test, mm_V3_FP16_FP16_FP32_KEEP_DTYPE)
{
    TensorDesc a_desc = TensorDesc({20480, 6656}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    TensorDesc b_desc = TensorDesc({6656, 8192}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    TensorDesc out_desc = TensorDesc({20480, 8192}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.005, 0.005);
    cout << "-----------Testing MMV3 trans_x1 = false trans_x2 = false ----------" << endl;
    MmCommonTest(a_desc, b_desc, out_desc, ACL_SUCCESS);
}

TEST_F(l2_mm_test, mm_V2_FP16_FP16_FP32_KEEP_DTYPE)
{
    auto tensor_1_desc = TensorDesc({256, 2048}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto tensor_2_desc = TensorDesc({2048, 1024}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto out_tensor_desc = TensorDesc({256, 1024}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2).Precision(0.005, 0.005);
    int8_t cube_math_type = 0;
    auto ut = OP_API_UT(aclnnMm, INPUT(tensor_1_desc, tensor_2_desc), OUTPUT(out_tensor_desc), cube_math_type);
...
TEST_F(l2_mm_test, mm_V3_BF16_BF16__FP32_KEEP_DTYPE)
{
    TensorDesc a_desc = TensorDesc({20480, 6656}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    TensorDesc b_desc = TensorDesc({6656, 8192}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    TensorDesc out_desc = TensorDesc({20480, 8192}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.005, 0.005);
    cout << "-----------Testing MMV3 trans_x1 = false trans_x2 = false ----------" << endl;
    MmCommonTest(a_desc, b_desc, out_desc, ACL_SUCCESS);
}

TEST_F(l2_mm_test, mm_V2_BF16_BF16_FP32_KEEP_DTYPE)
{
    auto tensor_1_desc = TensorDesc({256, 2048}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto tensor_2_desc = TensorDesc({2048, 1024}, ACL_BF16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto out_tensor_desc = TensorDesc({256, 1024}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2).Precision(0.005, 0.005);
    int8_t cube_math_type = 0;
    auto ut = OP_API_UT(aclnnMm, INPUT(tensor_1_desc, tensor_2_desc), OUTPUT(out_tensor_desc), cube_math_type);
