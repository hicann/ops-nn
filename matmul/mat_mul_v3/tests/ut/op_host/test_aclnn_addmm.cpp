...
TEST_F(l2_addmm_test, addmm_alpha_zero_beta_zero_success)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND950);
    auto self = TensorDesc({4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto mat1 = TensorDesc({4, 4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto mat2 = TensorDesc({4, 4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto out = TensorDesc({4, 4}, ACL_FLOAT16, ACL_FORMAT_ND).Precision(0.005, 0.005);
    auto beta = ScalarDesc(0.0f);
...
TEST_F(l2_addmm_test, inplace_addmm_alpha_zero_beta_zero_success)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND950);
    auto self = TensorDesc({4, 4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto mat1 = TensorDesc({4, 4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto mat2 = TensorDesc({4, 4}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto beta = ScalarDesc(0.f);
    auto alpha = ScalarDesc(0.0f);
    int8_t cubeMathType = ALLOW_FP32_DOWN_PRECISION;
...
// 接口整改异常用例 - 950
TEST_F(l2_addmm_test, addmm_950_fp16_fp16_fp32_keep_dtype)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND950);
    auto self = TensorDesc({16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_950_bf16_bf16_fp32_keep_dtype)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND950);
...
TEST_F(l2_addmm_test, addmm_950_fp16_fp16_use_fp32_add_with_2d_self)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND950);
    auto self = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_950_bf16_bf16_use_fp32_add_with_2d_self)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND950);
    auto self = TensorDesc({16, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
...
// 910b架构下使用USE_FP32_ADD的测试用例
TEST_F(l2_addmm_test, addmm_910b_fp16_fp16_use_hf32)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_910b_bf16_bf16_use_hf32)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_910b_fp16_fp16_keep_dtype)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_910b_bf16_bf16_keep_dtype)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_16in32out_fp16_fp16_fp32_use_hf32)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 32}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat2 = TensorDesc({32, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto out = TensorDesc({16, 16}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
    auto beta = ScalarDesc(1.0f);
    auto alpha = ScalarDesc(1.0f);
    int8_t cubeMathType = USE_HF32;
...
TEST_F(l2_addmm_test, addmm_16in32out_bf16_bf16_fp32_use_hf32)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 32}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat2 = TensorDesc({32, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto out = TensorDesc({16, 16}, ACL_FLOAT, ACL_FORMAT_ND).Precision(0.001, 0.001);
    auto beta = ScalarDesc(1.0f);
    auto alpha = ScalarDesc(1.0f);
    int8_t cubeMathType = USE_HF32;
...
TEST_F(l2_addmm_test, addmm_16in32out_fp16_fp16_fp32_allow_fp32_down_precision)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 32}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_16in32out_bf16_bf16_fp32_allow_fp32_down_precision)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 32}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_16in32out_fp16_fp16_fp32_use_fp32_add)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 32}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_16in32out_bf16_bf16_fp32_use_fp32_add)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16, 16}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 32}, ACL_BF16, ACL_FORMAT_ND).ValueRange(0, 2);
...
TEST_F(l2_addmm_test, addmm_910b_fp16_fp16_use_fp32_add_with_self_need_broadcast)
{
    op::SocVersionManager versionManager(op::SocVersion::ASCEND910B);
    auto self = TensorDesc({16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
    auto mat1 = TensorDesc({16, 16}, ACL_FLOAT16, ACL_FORMAT_ND).ValueRange(0, 2);
