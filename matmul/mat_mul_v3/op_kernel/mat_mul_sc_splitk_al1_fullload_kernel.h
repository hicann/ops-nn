...
template <class A_TYPE, class B_TYPE, class L0C_TYPE, class C_TYPE, class BIAS_TYPE,
          class BLOCK_TYPE = MatmulSingleCoreSplitKAL1FullLoadBlock, const MatmulConfig& MM_CFG = MM_CFG_NO_PRELOAD>
...
__aicore__ inline void MatMulBaseKernelSCSplitKAL1FullLoad<A_TYPE, B_TYPE, L0C_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE,
                                                           MM_CFG>::Init(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR workspaceGM,
                                                                         GM_ADDR biasGM,
                                                                         ...
                                                                         TPipe* pipe)
{
    ...
    const uint64_t mDim = static_cast<uint64_t>(block_.matmulTilingData_->matmulTiling.baseM *
                                                block_.matmulTilingData_->matmulTiling.stepM);
    const uint64_t kAL1Dim = block_.params_.kAL1FullLoadSize;
    const uint64_t mAligned = A_TYPE::isTrans ? MMV3CeilAlign(mDim, innerAlignedBlock) :
                                                MMV3CeilAlign(mDim, static_cast<uint64_t>(BLOCK_SIZE));
    const uint64_t kAL1Aligned = A_TYPE::isTrans ? MMV3CeilAlign(kAL1Dim, static_cast<uint64_t>(BLOCK_SIZE)) :
...
template <class A_TYPE, class B_TYPE, class L0C_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE,
          const MatmulConfig& MM_CFG>
__aicore__ inline void MatMulBaseKernelSCSplitKAL1FullLoad<A_TYPE, B_TYPE, L0C_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE,
                                                           MM_CFG>::InitInputs(GM_ADDR aGM, GM_ADDR bGM,
                                                                               GM_ADDR workspaceGM, GM_ADDR biasGM)
{
    aGlobal_.SetGlobalBuffer((__gm__ A_T*)aGM, static_cast<uint64_t>(block_.matmulTilingData_->matmulTiling.M) *
...
MatMulBaseKernelSCSplitKAL1FullLoad<A_TYPE, B_TYPE, L0C_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG>::SetOrgShape()
{
...
template <class A_TYPE, class B_TYPE, class L0C_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE,
          const MatmulConfig& MM_CFG>
__aicore__ inline void
MatMulBaseKernelSCSplitKAL1FullLoad<A_TYPE, B_TYPE, L0C_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG>::CopyInAL1()
{
    ...
    if constexpr (A_TYPE::format == CubeFormat::NZ) {
        ...
        nd2nzParams.ndNum = 1;
        uint64_t nDim = A_TYPE::isTrans ? kDim : static_cast<uint64_t>(block_.matmulTilingData_->matmulTiling.M);
        uint64_t dDim = A_TYPE::isTrans ? static_cast<uint64_t>(block_.matmulTilingData_->matmulTiling.M) : kDim;
        nd2nzParams.nValue = nDim;
        nd2nzParams.dValue = dDim;
        nd2nzParams.srcNdMatrixStride = 0;
        nd2nzParams.srcDValue = static_cast<uint64_t>(A_TYPE::isTrans ? block_.matmulTilingData_->matmulTiling.M :
                                                                        block_.matmulTilingData_->matmulTiling.Ka);
...
template <class A_TYPE, class B_TYPE, class L0C_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE,
          const MatmulConfig& MM_CFG>
__aicore__ inline void MatMulBaseKernelSCSplitKAL1FullLoad<A_TYPE, B_TYPE, L0C_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE,
                                                           MM_CFG>::ProcessNInnerBlock(uint64_t kIndex,
                                                                                       LocalTensor<A_T>& al1Local)
{
    if ASCEND_IS_AIC {
        mm_.SetSingleShape(block_.matmulTilingData_->matmulTiling.M, block_.params_.curCoreN,
...
template <class A_TYPE, class B_TYPE, class L0C_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE,
          const MatmulConfig& MM_CFG>
__aicore__ inline void
MatMulBaseKernelSCSplitKAL1FullLoad<A_TYPE, B_TYPE, L0C_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE,
                                    MM_CFG>::CastCurrentNBaseTile(GM_ADDR cGM, GM_ADDR srcAddr,
                                                                  TBuf<TPosition::VECCALC>& ubBuf)
{
    ...
    Cast32to16V220(reinterpret_cast<__gm__ typename C_TYPE::T*>(cGM) + offset,
                   reinterpret_cast<__gm__ float*>(srcAddr) + offset, singleSize, static_cast<uint32_t>(cols),
...
protected:
    ...
    MatMulBaseKernelSCSplitKAL1FullLoad<A_TYPE, B_TYPE, C_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG> directKernel_;
...
private:
    __aicore__ inline void InitInputs(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR cGM, GM_ADDR biasGM, GM_ADDR offsetWGM,
                                      GM_ADDR workspaceGM);
    __aicore__ inline void InitInner(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR biasGM, const MatmulTilingData* matmulTilingData,
                                     TPipe* pipe);
...
__aicore__ inline void
MatMulSingleCoreSplitKAL1FullLoadKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG>::Init(
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG>
__aicore__ inline void
MatMulSingleCoreSplitKAL1FullLoadKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG>::InitWithMatmulWorkspace(
    GM_ADDR aGM, GM_ADDR bGM, GM_ADDR cGM, GM_ADDR biasGM, GM_ADDR offsetWGM, GM_ADDR workspaceGM,
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG>
__aicore__ inline void
MatMulSingleCoreSplitKAL1FullLoadKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG>::InitInner(
    GM_ADDR aGM, GM_ADDR bGM, GM_ADDR biasGM, const MatmulTilingData* matmulTilingData, TPipe* pipe)
{
    if ASCEND_IS_AIC {
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG>
__aicore__ inline void
MatMulSingleCoreSplitKAL1FullLoadKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE, MM_CFG>::InitInputs(
    GM_ADDR aGM, GM_ADDR bGM, GM_ADDR cGM, GM_ADDR biasGM, GM_ADDR offsetWGM, GM_ADDR workspaceGM)
{
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG>
__aicore__ inline void MatMulSingleCoreSplitKAL1FullLoadKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE,
                                                               MM_CFG>::Process(uint8_t enAtomic)
{
    (void)enAtomic;
    using C_T = typename C_TYPE::T;
    if ASCEND_IS_AIV {
...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class BLOCK_TYPE, const MatmulConfig& MM_CFG>
__aicore__ inline bool MatMulSingleCoreSplitKAL1FullLoadKernel<A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, BLOCK_TYPE,
                                                               MM_CFG>::ShouldSkipAivCore() const
{
    using C_T = typename C_TYPE::T;
    if constexpr (sizeof(C_T) == sizeof(float)) {
        return true;
