...
# ----------------------------------------------------------------------------
"""Kernel-level golden for DualLevelQuantBatchMatmul.

op: dual_level_quant_batch_matmul
formula: y = dequant(dual_level_quant(x1) @ dual_level_quant(x2)) + bias
"""
...
def customize_inputs(
    ...
    *,
    ...
    transpose_x1=False,
    transpose_x2=True,
    level0_group_size=512,
    level1_group_size=32,
    **kwargs,
):
...
def _kernel_compute(
    ...
    **kwargs,
    ...
    num_l1_groups = (
        x1_l1.shape[-2] * x1_l1.shape[-1] if x1_l1.ndim >= 2 else x1_l1.shape[0]
    )
...
class DualLevelQuantBatchMatmulTestSpec:
    ...
    def golden(
        ...
        **kwargs,
        ...
        return _kernel_compute(
            ...
            level0_group_size=level0_group_size,
            level1_group_size=level1_group_size,
            **kwargs,
        )


__spec__ = {
    "dual_level_quant_batch_matmul": "DualLevelQuantBatchMatmulTestSpec",
}
