...
int AclnnBaddbmmTest(int32_t deviceId, aclrtStream& stream)
{
    ...
    std::unique_ptr<aclScalar, aclnnStatus (*)(const aclScalar*)> alphaTensorPtr(alpha, aclDestroyScalar);
    std::unique_ptr<aclScalar, aclnnStatus (*)(const aclScalar*)> betaTensorPtr(beta, aclDestroyScalar);
