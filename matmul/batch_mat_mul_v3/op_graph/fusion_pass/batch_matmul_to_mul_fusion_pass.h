...
#ifndef NN_BATCHMATMUL_TO_MUL_FUSION_PASS_H
#define NN_BATCHMATMUL_TO_MUL_FUSION_PASS_H

#include "ge/fusion/pass/pattern_fusion_pass.h"

namespace ops {

class __attribute__((visibility("default"))) BatchMatMul2MulFusionPass : public ge::fusion::PatternFusionPass {
protected:
...
#endif // NN_BATCHMATMUL_TO_MUL_FUSION_PASS_H
