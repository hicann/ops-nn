...
template <class A_TYPE, class B_TYPE, class C_TYPE, class BIAS_TYPE, class A_LAYOUT, class B_LAYOUT, class C_LAYOUT,
          bool A_BC, bool B_BC>
__aicore__ inline void BatchMatMulIterBatchBroadcastKernel(GM_ADDR aGM, GM_ADDR bGM, GM_ADDR biasGM, GM_ADDR cGM,
                                                           GM_ADDR workspaceGM,
                                                           const BatchMatMulV3TilingData& tilingData)
{
    ...
    SchedulerParams schParams = {static_cast<uint32_t>(tilingData.matMulTilingData.tCubeTiling.baseM),
