...
private:
    ...
    template <class T>
    __aicore__ inline T CopyInX1ScalePertile(__gm__ T* src, uint64_t offset);
    template <class T>
    ...
    __aicore__ inline void AddBias(__ubuf__ CalcType* mmAdd, __ubuf__ BiasType* bias, uint16_t mSize, uint32_t nSize0,
                                   uint32_t nSize1);
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::Init(const Params* params)
{
    if ASCEND_IS_AIC {
        return;
    }
    ...
    if (isPertile_) {
        constexpr uint32_t x1ScaleUbOffset = (AscendC::IsSameType<CType, YType>::value) ?
                                                 afterAddOffset :
                                                 afterAddOffset + elems * sizeof(YType);
        ...
        if (params->isBias == 1) {
            ...
            isBias_ = true;
            constexpr uint32_t afterx1ScaleUbOffset = x1ScaleUbOffset +
                                                      2 * PER_BLOCK_SIZE * QBMM_MAX_STEP_SCALEA_K * sizeof(X1ScaleType);
            biasUbPing_ = AscendC::LocalTensor<BiasType>(AscendC::TPosition::VECCALC, afterx1ScaleUbOffset,
                                                         PER_BLOCK_SIZE);
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline auto BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::GetL0c2UbPingTensor()
{
    constexpr uint32_t elems = UB_TWO_BANK_ELEMS_B32 * PER_BLOCK_SIZE;
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline auto BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::GetL0c2UbPongTensor()
{
    constexpr uint32_t elems = UB_TWO_BANK_ELEMS_B32 * PER_BLOCK_SIZE;
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::UpdateParamsForNextProblem(
    const TupleShape& problemShape)
{
    problemShape_ = problemShape;

    scaleM_ = Cmct::Gemm::CeilDiv(Get<MNK_M>(problemShape_), params_->groupSizeM);
    scaleN_ = Cmct::Gemm::CeilDiv(Get<MNK_N>(problemShape_), params_->groupSizeN);
    scaleK_ = Cmct::Gemm::CeilDiv(Get<MNK_K>(problemShape_), params_->groupSizeK);
}

QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::UpdateGlobalAddr(
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline int64_t BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::CalcX1OffsetPerGroup()
{
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::CalcX2OffsetPerGroup(
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
template <class T>
__aicore__ inline __ubuf__ T* BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::CopyInX1Scale(
...
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::CopyInBias()
{
    ...
    if (ubParams_.validN[1] != 0) {
        ...
        AscendC::DataCopyPad(biasUb[Align(ubParams_.validN[0], UB_ALIGN_SIZE / sizeof(BiasType))],
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
template <class T>
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::CopyInX2Scale(
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::UpdatePertileUBValidMN()
{
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::UpdatePertileUBParam()
{
    ubParams_.CopyOutWithSplitN = Get<MNK_N>(actualSingleShape_) > params_->groupSizeN ||
                                  Get<MNK_M>(actualSingleShape_) == 1;
    uint32_t fixpipeN = 0;
    if (ubParams_.CopyOutWithSplitN) {
        ...
        int64_t alignedNBase = Get<MNK_N>(actualSingleShape_) > PER_BLOCK_SIZE ?
                                   PER_BLOCK_SIZE :
                                   AscendC::ONE_BLK_SIZE * ubParams_.ndNum;
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::operator()(
...
BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::GetX1ScaleUbAddrPerGroup(int64_t x1ScaleOffset,
                                                                                              uint64_t kOffset,
                                                                                              uint64_t kElem)
{
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::ProcessAivSingleKPertile(
...
QBMM_BLOCK_EPILOGUE_PERTILE_CLASS_LOCAL_PARAMS
__aicore__ inline void BlockEpiloguePertile<QBMM_BLOCK_EPILOGUE_PERTILE_FUNC_LOCAL_PARAMS>::ProcessAivSingleKPerblock(
    int64_t x1ScaleOffset, __gm__ X2ScaleType* x2ScaleAddr[UB_SUB_BANK_NUM])
{
    auto mmAddUbAddr = reinterpret_cast<__ubuf__ CType*>(mmAddUb_.GetPhyAddr());
    ...
    uint32_t nSize1, uint16_t kSize, X2ScaleType x2Scale0, X2ScaleType x2Scale1, uint64_t x1ScaleKIdxInCache)
{
    ...
    uint16_t alignK = Align(kSize, QBMM_UB_ALIGN_SIZE / sizeof(X1ScaleType));
    __VEC_SCOPE__
    {
        for (uint16_t mIdx = 0; mIdx < mSize; mIdx++) {
            AscendC::Reg::RegTensor<X1ScaleType> x1ScaleReg, muledScaleReg;
            if constexpr (transA) {
            ...
            AscendC::Reg::MaskReg maskN = AscendC::Reg::UpdateMask<CType>(elementNum);
            AscendC::Reg::RegTensor<CType> l0cOutReg;
            AscendC::Reg::RegTensor<CalcType> addReg;
            AscendC::Reg::RegTensor<CalcType> ResReg, mulScaleOutReg;
            ...
            // l0c_out * scale
            AscendC::Reg::Muls(muledScaleReg, x1ScaleReg, x2Scale0, maskN);
            if constexpr (AscendC::IsSameType<CType, int32_t>::value) {
                constexpr static AscendC::Reg::CastTrait ctInt322Fp32 = {
                    AscendC::Reg::RegLayout::UNKNOWN, AscendC::Reg::SatMode::UNKNOWN,
                    AscendC::Reg::MaskMergeMode::ZEROING, AscendC::RoundMode::CAST_RINT};
                AscendC::Reg::RegTensor<CalcType> l0cOutRegAfterCast{};
                AscendC::Reg::Cast<CalcType, CType, ctInt322Fp32>(l0cOutRegAfterCast, l0cOutReg, maskN);
                AscendC::Reg::Mul(mulScaleOutReg, l0cOutRegAfterCast, muledScaleReg, maskN);
            } else {
                AscendC::Reg::Mul(mulScaleOutReg, l0cOutReg, muledScaleReg, maskN);
            }
            uint32_t dstUbOffset = offset;
            if constexpr (isFirstKLoop) {
                AscendC::Reg::DataCopy<CalcType, AscendC::Reg::StoreDist::DIST_NORM_B32>(dst + dstUbOffset,
                                                                                         mulScaleOutReg, maskN);
            } else {
                AscendC::Reg::DataCopy(addReg, dst + dstUbOffset);
                AscendC::Reg::Add(ResReg, mulScaleOutReg, addReg, maskN);
                // copy out from register to ub
                AscendC::Reg::DataCopy<CalcType, AscendC::Reg::StoreDist::DIST_NORM_B32>(dst + dstUbOffset, ResReg,
                                                                                         maskN);
            }
            // 2 ND
            ...
            elementNum = nSize1;
            maskN = AscendC::Reg::UpdateMask<CType>(elementNum);
            // copy input from ub to register, addr of ub should align to 32B
            ...
            // l0c_out * scale
            AscendC::Reg::Muls(muledScaleReg, x1ScaleReg, x2Scale1, maskN);
            if constexpr (AscendC::IsSameType<CType, int32_t>::value) {
                constexpr static AscendC::Reg::CastTrait ctInt322Fp32 = {
                    AscendC::Reg::RegLayout::UNKNOWN, AscendC::Reg::SatMode::UNKNOWN,
                    AscendC::Reg::MaskMergeMode::ZEROING, AscendC::RoundMode::CAST_RINT};
    ...
    X2ScaleType x2Scale0, X2ScaleType x2Scale1)
{
    __VEC_SCOPE__
    {
        for (uint16_t mIdx = 0; mIdx < mSize; mIdx++) {
            ...
            AscendC::Reg::MaskReg maskN = AscendC::Reg::UpdateMask<CType>(elementNum);
            AscendC::Reg::RegTensor<CType> l0cOutReg;
            AscendC::Reg::RegTensor<CType> addReg;
            AscendC::Reg::RegTensor<CType> ResReg, mulScaleOutReg;
            // copy input from ub to register, addr of ub should align to 32B
            uint32_t offset = mIdx * UB_TWO_BANK_ELEMS_B32;
            uint32_t l0cOutOffset = offset;
            AscendC::Reg::DataCopy(l0cOutReg, l0cOut + offset);
            // l0c_out * scale
            AscendC::Reg::Muls(mulScaleOutReg, l0cOutReg, scaleMul, maskN);
            uint32_t dstUbOffset = offset;
            if constexpr (isFirstKLoop) {
                AscendC::Reg::DataCopy<CType, AscendC::Reg::StoreDist::DIST_NORM_B32>(dst + dstUbOffset, mulScaleOutReg,
                                                                                      maskN);
            } else {
                AscendC::Reg::DataCopy(addReg, dst + dstUbOffset);
                AscendC::Reg::Add(ResReg, mulScaleOutReg, addReg, maskN);
                // copy out from register to ub
                AscendC::Reg::DataCopy<CType, AscendC::Reg::StoreDist::DIST_NORM_B32>(dst + dstUbOffset, ResReg, maskN);
            }
            // 2 ND
            if constexpr (ndNum == 1) {
                continue;
    ...
    __ubuf__ CalcType* mmAdd, __ubuf__ BiasType* bias, uint16_t mSize, uint32_t nSize0, uint32_t nSize1)
{
    __VEC_SCOPE__
    {
        ...
        for (uint16_t mIdx = 0; mIdx < mSize; mIdx++) {
            AscendC::Reg::RegTensor<BiasType> biasReg{};
            AscendC::Reg::RegTensor<CalcType> mmAddReg{};
            AscendC::Reg::DataCopy(biasReg, bias);
            mmAddOffset = mIdx * PER_BLOCK_SIZE;
            uint32_t elementNum = nSize0;
            AscendC::Reg::MaskReg maskN = AscendC::Reg::UpdateMask<CalcType>(elementNum);
            AscendC::Reg::DataCopy(mmAddReg, mmAdd + mmAddOffset);
            AscendC::Reg::Add(mmAddReg, mmAddReg, biasReg, maskN);
            AscendC::Reg::DataCopy<CalcType, AscendC::Reg::StoreDist::DIST_NORM_B32>(mmAdd + mmAddOffset, mmAddReg,
                                                                                     maskN);
            if constexpr (ndNum == 1) {
                continue;
            }
            elementNum = nSize1;
            maskN = AscendC::Reg::UpdateMask<CalcType>(elementNum);
            mmAddOffset += nSize0;
            AscendC::Reg::DataCopy(biasReg, bias + nSize0);
            AscendC::Reg::DataCopy(mmAddReg, mmAdd + mmAddOffset);
            AscendC::Reg::Add(mmAddReg, mmAddReg, biasReg, maskN);
            AscendC::Reg::DataCopy<CalcType, AscendC::Reg::StoreDist::DIST_NORM_B32>(mmAdd + mmAddOffset, mmAddReg,
                                                                                     maskN);
    ...
    const AscendC::LocalTensor<CalcType>& mmAddUb)
{
    ...
    if constexpr (AscendC::IsSameType<CalcType, BiasType>::value) {
        if (isBias_) {
            ...
            if (ubParams_.ndNum == 1) {
                AddBias<1U>((__ubuf__ CalcType*)mmAddUbAddr, (__ubuf__ BiasType*)biasUbAddr, ubParams_.validM,
                            ubParams_.validN[0], ubParams_.validN[1]);
            } else if (ubParams_.ndNum == 2) {
                AddBias<2U>((__ubuf__ CalcType*)mmAddUbAddr, (__ubuf__ BiasType*)biasUbAddr, ubParams_.validM,
                            ubParams_.validN[0], ubParams_.validN[1]);
            }
            AscendC::SetFlag<AscendC::HardEvent::V_MTE2>(biasPingPongID_);
            biasPingPongID_ = biasPingPongID_ ^ 1;
