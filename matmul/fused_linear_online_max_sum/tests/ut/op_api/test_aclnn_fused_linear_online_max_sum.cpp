...
protected:
    static void SetUpTestCase() { cout << "l2_fused_linear_online_max_sum_test SetUp" << endl; }
    static void TearDownTestCase() { cout << "l2_fused_linear_online_max_sum_test TearDown" << endl; }
    static void FusedLinearOnlineMaxSumCommonTest(vector<vector<int64_t>> shapes, vector<aclDataType> dtypes,
                                                  int64_t vocabStartIndex, int64_t vocabEndIndex,
                                                  aclnnStatus expect_status)
    {
        ...
        auto ut = OP_API_UT(
            aclnnFusedLinearOnlineMaxSum, INPUT(input_desc, weight_desc, target_desc, vocabStartIndex, vocabEndIndex),
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_input_empty_success)
{
    ...
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT16, ACL_INT32, ACL_FLOAT,  ACL_FLOAT,
                                  ACL_FLOAT,   ACL_UINT8,   ACL_INT32, ACL_FLOAT16};
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_bfloat16_success)
{
    ...
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_BF16,  ACL_BF16,  ACL_INT32, ACL_FLOAT, ACL_FLOAT,
                                  ACL_FLOAT, ACL_UINT8, ACL_INT32, ACL_BF16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACL_SUCCESS);
}
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_input_nullptr_invalid)
{
    ...
    auto ut = OP_API_UT(
        aclnnFusedLinearOnlineMaxSum, INPUT(input_desc, weight_desc, target_desc, 0, V),
        OUTPUT(logits_max_local_out_desc, sum_exp_logits_local_out_desc, predicted_logits_local_out_desc,
               target_mask_out_desc, masked_target_out_desc, vocab_parallel_logits_out_optional_desc));
...
TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_sum_exp_logits_local_out_nullptr_invalid)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
...
TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_predicted_logits_local_out_nullptr_invalid)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
...
TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_vocab_parallel_logits_out_optional_nullptr_success)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_input_dtype_invalid)
{
    ...
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT, ACL_FLOAT16, ACL_INT32, ACL_FLOAT,  ACL_FLOAT,
                                  ACL_FLOAT, ACL_UINT8,   ACL_INT32, ACL_FLOAT16};
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_weight_dtype_invalid)
{
    ...
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT, ACL_INT32, ACL_FLOAT,  ACL_FLOAT,
                                  ACL_FLOAT,   ACL_UINT8, ACL_INT32, ACL_FLOAT16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_target_dtype_invalid)
{
    ...
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT16, ACL_INT8,  ACL_FLOAT,  ACL_FLOAT,
                                  ACL_FLOAT,   ACL_UINT8,   ACL_INT32, ACL_FLOAT16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_logits_max_local_out_dtype_invalid)
{
    ...
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT16, ACL_INT32, ACL_FLOAT16, ACL_FLOAT,
                                  ACL_FLOAT,   ACL_UINT8,   ACL_INT32, ACL_FLOAT16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_sum_exp_logits_local_out_dtype_invalid)
{
    ...
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT16, ACL_INT32, ACL_FLOAT,  ACL_FLOAT16,
                                  ACL_FLOAT,   ACL_UINT8,   ACL_INT32, ACL_FLOAT16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}

TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_predicted_logtis_local_out_dtype_invalid)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT16, ACL_INT32, ACL_FLOAT,  ACL_FLOAT,
                                  ACL_FLOAT16, ACL_UINT8,   ACL_INT32, ACL_FLOAT16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_target_mask_out_dtype_invalid)
{
    ...
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT16, ACL_INT32, ACL_FLOAT,  ACL_FLOAT,
                                  ACL_FLOAT,   ACL_INT8,    ACL_INT32, ACL_FLOAT16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_masked_target_out_dtype_invalid)
{
    ...
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT16, ACL_INT32,   ACL_FLOAT,  ACL_FLOAT,
                                  ACL_FLOAT,   ACL_UINT8,   ACL_FLOAT16, ACL_FLOAT16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}

TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_vocab_parallel_logits_out_optional_dtype_invalid)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_FLOAT16, ACL_INT32, ACL_FLOAT, ACL_FLOAT,
                                  ACL_FLOAT,   ACL_UINT8,   ACL_INT32, ACL_FLOAT};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}
...
TEST_F(l2_fused_linear_online_max_sum_test, l2_fused_linear_online_max_sum_test_input_weight_dtype_not_same)
{
    ...
    int64_t V = 19936;
    vector<vector<int64_t>> shapes = {{BT, H}, {V, H}, {BT}, {BT}, {BT}, {BT}, {(BT + 7) / 8}, {BT}, {BT, V}};
    vector<aclDataType> dtypes = {ACL_FLOAT16, ACL_BF16,  ACL_INT32, ACL_FLOAT,  ACL_FLOAT,
                                  ACL_FLOAT,   ACL_UINT8, ACL_INT32, ACL_FLOAT16};
    FusedLinearOnlineMaxSumCommonTest(shapes, dtypes, 0, V, ACLNN_ERR_PARAM_INVALID);
}

TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_input_vocab_parallel_logits_out_optional_dtype_not_same)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
...
TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_vocab_parallel_logits_out_optional_dim_invalid)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
...
TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_predicted_logits_local_out_shape_invalid)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
...
TEST_F(l2_fused_linear_online_max_sum_test,
       l2_fused_linear_online_max_sum_test_vocab_parallel_logits_out_optional_shape_invalid)
{
    int64_t BT = 8192;
    int64_t H = 4096;
    int64_t V = 19936;
