...
public:
    ...
    __aicore__ inline void Init(uint64_t totalSize, uint64_t weightL1Space, uint64_t aPreloadSize,
...
WQBMM_CUBE_COMPUTE_TEMPLATE_PARAM
__aicore__ inline void WQBMM_CUBE_COMPUTE_CLASS::Init(uint64_t totalSize, uint64_t weightL1Space, uint64_t aPreloadSize,
                                                      const TCubeTiling* __restrict matmulTiling, AscendC::TPipe* tPipe)
{
    ...
    //  ② 无bias
    //  L1 (0~512KB): WeightL1_P0(128KB) | AL1_P0(124KB) | AL1_P1(124KB) |
    //  WeightL1_P1(128KB) | quantScale(8KB)
    // (2) L1 上有bias时:
    ...
    aF16L1_ = LocalTensor<xType>(TPosition::TSCM, aF16L1Offset * sizeof(xType),
                                 totalSize / sizeof(xType) - aF16L1Offset);
