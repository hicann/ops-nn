...
extern "C" aclnnStatus aclnnConvertWeightToINT4PackGetWorkspaceSize(const aclTensor* weight,
                                                                    const aclTensor* weightInt4Pack,
...
int aclnnWeightQuantBatchMatmulV3Test(int32_t deviceId, aclrtStream& stream)
{
    ...
    ret = CreateAclTensorB4(weightB4PackHostData, weightPackedShape, &weightB4PackDeviceAddr, weightPackedDtype,
                            &weightPacked, weightFormat);
    ...
    workspaceSize = 0;
    executor = nullptr;
    ret = aclnnWeightQuantBatchMatmulV3GetWorkspaceSize(x, weightPacked, antiquantScale, nullptr, nullptr, nullptr,
                                                        nullptr, groupSize, 0, yFp16, &workspaceSize, &executor);
