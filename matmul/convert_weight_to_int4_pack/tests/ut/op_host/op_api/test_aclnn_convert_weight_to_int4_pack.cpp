...
static ConvertWeightToINT4PackTestParam casesParams[] = {
    {"test_convert_weight_to_int4_pack_invalid_dtype_case03",
     {32, 64},
     {32, 64},
     ACL_INT8,
     ACL_INT4,
    ...
    {"test_convert_weight_to_int4_pack_invalid_dtype_case04",
     {32, 64},
     {32, 64},
     ACL_INT32,
     ACL_INT8,
     ...
     ACL_FORMAT_ND,
     ACLNN_ERR_PARAM_INVALID},
    {"test_convert_weight_to_int4_pack_invalid_format_case05",
     {32, 64},
     {32, 64},
     ACL_INT32,
     ACL_INT4,
     ...
     ACL_FORMAT_ND,
     ACLNN_ERR_PARAM_INVALID},
    {"test_convert_weight_to_int4_pack_invalid_format_case06",
     {32, 64},
     {32, 64},
     ACL_INT32,
     ACL_INT4,
     ...
     ACL_FORMAT_FRACTAL_NZ,
     ACLNN_ERR_PARAM_INVALID},
    {"test_convert_weight_to_int4_pack_invalid_shapedim_case07",
     {1, 1, 32, 64},
     {1, 1, 32, 64},
     ACL_INT32,
     ACL_INT4,
     ...
     ACL_FORMAT_ND,
     ACLNN_ERR_PARAM_INVALID},
    {"test_convert_weight_to_int4_pack_invalid_shape_int4_case08",
     {32, 63},
     {32, 63},
     ACL_INT32,
     ACL_INT4,
     ...
     ACL_FORMAT_ND,
     ACLNN_ERR_PARAM_INVALID},
    {"test_convert_weight_to_int4_pack_invalid_shape_int4_case09",
     {32, 64},
     {32, 32},
     ACL_INT32,
     ACL_INT4,
     ...
     ACL_FORMAT_ND,
     ACLNN_ERR_PARAM_INVALID},
    {"test_convert_weight_to_int4_pack_invalid_shape_int32_case10",
     {32, 74},
     {32, 74},
     ACL_INT32,
     ACL_INT32,
     ...
     ACL_FORMAT_ND,
     ACLNN_ERR_PARAM_INVALID},
    {"test_convert_weight_to_int4_pack_invalid_shape_int32_case11",
     {32, 64},
     {32, 32},
     ACL_INT32,
     ACL_INT32,
     ...
     ACL_FORMAT_ND,
     ACLNN_ERR_PARAM_INVALID},
    {"test_convert_weight_to_int4_pack_Format_Nz_case12",
     {32, 64},
     {32, 8},
     ACL_INT32,
     ACL_INT32,
...
INSTANTIATE_TEST_SUITE_P(ConvertWeightToINT4Pack, l2_ConvertWeightToINT4Pack_Ascend950_test,
