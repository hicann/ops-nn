...
#define TRANSPOSE_QUANT_BATCH_MAT_MUL_HIGH_LEVEL 0
#define TRANSPOSE_QUANT_BATCH_MAT_MUL_BASIC_LEVEL 1
#define TRANSPOSE_QUANT_BATCH_MAT_MUL_TENSOR_LEVEL 2
...
#define TRANSPOSE_QUANT_BATCH_MAT_MUL_HIFP8 2
#define TRANSPOSE_QUANT_BATCH_MAT_MUL_MXFP4 3

enum class TQBMMApiLevel : std::uint8_t {
    HIGH_LEVEL = TRANSPOSE_QUANT_BATCH_MAT_MUL_HIGH_LEVEL,
    BASIC_LEVEL = TRANSPOSE_QUANT_BATCH_MAT_MUL_BASIC_LEVEL,
    TENSOR_LEVEL = TRANSPOSE_QUANT_BATCH_MAT_MUL_TENSOR_LEVEL,
};
...
enum class TQBMMPrecisionMode : std::uint8_t {
    ...
    PRECISION_MODE_HIFP8 = TRANSPOSE_QUANT_BATCH_MAT_MUL_HIFP8,
    PRECISION_MODE_MXFP4 = TRANSPOSE_QUANT_BATCH_MAT_MUL_MXFP4
};
