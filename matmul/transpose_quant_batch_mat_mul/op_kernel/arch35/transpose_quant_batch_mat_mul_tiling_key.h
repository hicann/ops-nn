...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(BATCH_SPLIT, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
    ...
    ASCENDC_TPL_UINT_DECL(PRECISION_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_FP8,
                          ...
                          TRANSPOSE_QUANT_BATCH_MAT_MUL_MXFP4),
    ASCENDC_TPL_UINT_DECL(API_LEVEL, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_HIGH_LEVEL,
                          TRANSPOSE_QUANT_BATCH_MAT_MUL_BASIC_LEVEL, TRANSPOSE_QUANT_BATCH_MAT_MUL_TENSOR_LEVEL), );
// 模板参数组合
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(API_LEVEL, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_TENSOR_LEVEL)),
    // MXFP4: TENSOR_LEVEL
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIC_ONLY),
        ASCENDC_TPL_UINT_SEL(PERM_X1, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_PERM_X1_1_0_2),
        ASCENDC_TPL_UINT_SEL(PERM_X2, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_PERM_X2_0_1_2,
                             TRANSPOSE_QUANT_BATCH_MAT_MUL_PERM_X2_0_2_1),
        ASCENDC_TPL_UINT_SEL(BATCH_SPLIT, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_BATCH_SPLIT_FALSE),
        ASCENDC_TPL_UINT_SEL(PRECISION_MODE, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_MXFP4),
        ASCENDC_TPL_UINT_SEL(API_LEVEL, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_TENSOR_LEVEL)),
    // FP8: HIGH_LEVEL
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(API_LEVEL, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_HIGH_LEVEL)),
    // HIFP8: HIGH_LEVEL
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_AIC_ONLY),
        ASCENDC_TPL_UINT_SEL(PERM_X1, ASCENDC_TPL_UI_LIST, TRANSPOSE_QUANT_BATCH_MAT_MUL_PERM_X1_1_0_2),
