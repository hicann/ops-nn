...
/*!
 * \file test_transpose_quant_batch_mat_mul_hifp8.cpp
 * \brief Kernel UT for the Ascend950 HIFP8 fixpipe-quant tensor API path.
 */

#define DTYPE_X1 hifloat8_t
#define DTYPE_X2 hifloat8_t
#define DTYPE_X1_SCALE float
#define DTYPE_X2_SCALE uint64_t
#define DTYPE_Y half
...
class transpose_quant_batch_mat_mul_hifp8_test : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "transpose_quant_batch_mat_mul_hifp8_test SetUp\n" << endl; }
    static void TearDownTestCase() { cout << "transpose_quant_batch_mat_mul_hifp8_test TearDown\n" << endl; }
};
...
// HIFP8 TENSOR_LEVEL, AIC-only (M=64, Batch=1, K=64, N=64)
TEST_F(transpose_quant_batch_mat_mul_hifp8_test, transpose_quant_batch_mat_mul_hifp8_tensor_level)
{
    ...
    size_t shape_x1_scale = sizeof(float);
    size_t shape_x2_scale = N * sizeof(uint64_t);
    ...
    auto transpose_quant_batch_mat_mul_hifp8_wrapper = [](GM_ADDR x1, GM_ADDR x2, GM_ADDR bias, GM_ADDR x1_scale,
        ...
        ::transpose_quant_batch_mat_mul<
            ...
            TRANSPOSE_QUANT_BATCH_MAT_MUL_BATCH_SPLIT_FALSE, TRANSPOSE_QUANT_BATCH_MAT_MUL_HIFP8,
            TRANSPOSE_QUANT_BATCH_MAT_MUL_TENSOR_LEVEL>(x1, x2, bias, x1_scale, x2_scale, y, workspace, tiling);
    };
    ICPU_RUN_KF(transpose_quant_batch_mat_mul_hifp8_wrapper, 4, x1GM, x2GM, nullptr, x1_scaleGM, x2_scaleGM, outputGM,
                workspace, tiling);
