...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_expm1)
...
- Description: Performs exponential operation on each tensor in the input tensor list and subtracts 1 from the result.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachExpm1GetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachExpm1** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>Input tensor list for the exponential-minus-one operation, corresponding to `x` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>All tensors within this parameter must share the same data type. </li><li>The data type and format must be the same as those of `out`.</li></ul></td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output tensor list for the exponential-minus-one operation, corresponding to `y` in the formula.</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachExpm1GetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachExpm1** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachExpm1.
  ...
  // Call the second-phase API of aclnnForeachExpm1.
