...
TEST_F(ForeachCommonTiling, foreach_expm1_test_tiling_int16_5)
{
    std::string op_type("ForeachExpm1");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_expm1_test_tiling_int8_7)
{
    std::string op_type("ForeachExpm1");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
...
TEST_F(ForeachCommonTiling, foreach_expm1_test_tiling_uint8_8)
{
    std::string op_type("ForeachExpm1");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
