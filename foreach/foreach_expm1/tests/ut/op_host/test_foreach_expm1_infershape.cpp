...
protected:
    static void SetUpTestCase() { std::cout << "ForeachExpm1 SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ForeachExpm1 TearDown" << std::endl; }
};
...
TEST_F(ForeachExpm1Test, infer_dtype_int_to_float)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachExpm1")->infer_datatype;
    ASSERT_NE(infer_datatype_func, nullptr);
