...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_mul_list)
...
- Description: Performs element-wise multiplication on corresponding tensors in two input tensor lists.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachMulListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachMulList** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x1</td>
      <td>Input</td>
      <td>First input tensor list for the multiplication operation, corresponding to `x1` in the formula.</td>
    ...
    <tr>
      <td>x2</td>
      <td>Input</td>
      <td>Second input tensor list for the multiplication operation, corresponding to `x2` in the formula.</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachMulListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachMulList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachMulList.
  ...
  // Call the second-phase API of aclnnForeachMulList.
