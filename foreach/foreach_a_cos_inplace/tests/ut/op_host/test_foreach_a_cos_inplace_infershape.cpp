...
#include "log/log.h"
#include "../../../op_graph/foreach_a_cos_inplace_proto.h"

class ForeachACosInplaceTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(ForeachACosInplaceTest, infer_shape_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachACosInplace")->infer_shape;
...
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachACosInplace")->infer_datatype;
