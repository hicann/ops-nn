...
- Description: Performs the subtraction operation on each tensor in the input tensor list and the tensor **scalar**.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachSubScalarGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachSubScalar** is called to perform computation.
```Cpp
...
- **Parameters:**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>List of the first input tensors in the subtraction operation, corresponding to `x` in the formula.</td>
    ...
    <tr>
      <td>scalar</td>
      <td>Input</td>
      <td>Second input tensor in the subtraction operation, corresponding to `scalar` in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The number of elements is 1. </li><li>The data type has a certain mapping relationship with the data type of the input parameter `x`: <ul><li>When the data type of `x` is FLOAT32, FLOAT16, or INT32, its data type is the same as that of `x`. </li><li>When the data type of `x` is BFLOAT16, its data type must be FLOAT32.</li></ul></td>
...
- **Returns:**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      <td>The number of scalar elements is not 1.</td></tr>
    </tr>
  </tbody></table>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, obtained by calling the first-phase API aclnnForeachSubScalarGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachSubScalar** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachSubScalar.
  ...
  // Call the second-phase API of aclnnForeachSubScalar.
