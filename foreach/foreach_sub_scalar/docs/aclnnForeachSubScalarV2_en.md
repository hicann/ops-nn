...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_sub_scalar)
...
- Description: Performs the subtraction operation on each tensor in the input tensor list and the scalar **scalar**. Compared with [aclnnForeachSubScalar](./aclnnForeachSubScalar_en.md), this API changes the input parameter **scalar** from aclTensor to aclScalar. You should select a proper API based on the actual situation.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachSubScalarV2GetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachSubScalarV2** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>List of tensors of the minuend in the subtraction operation, corresponding to `x` in the formula.</td>
    ...
    <tr>
      <td>scalar</td>
      <td>Input</td>
      <td>Minuend in the subtraction operation, corresponding to `scalar` in the formula.</td>
      <td>The data type has a certain mapping relationship with the data type of the input parameter `x`: <ul><li>When the data type of `x` is FLOAT32 or BFLOAT16, its data type can be FLOAT32 or DOUBLE. </li><li>When the data type of `x` is FLOAT16, its data type can be FLOAT16 or DOUBLE. </li><li>When the data type of `x` is INT32, its data type can be INT32 or INT64.</li></ul></td>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, obtained by calling the first-phase API aclnnForeachSubScalarV2GetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachSubScalarV2** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachSubScalarV2.
  ...
  // Call the second-phase API of aclnnForeachSubScalarV2.
