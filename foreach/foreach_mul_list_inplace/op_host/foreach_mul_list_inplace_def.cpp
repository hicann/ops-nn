...
/*!
 * \file foreach_mul_list_inplace_def.cpp
 * \brief
 */
...
class ForeachMulListInplace : public OpDef {
public:
    explicit ForeachMulListInplace(const char* name) : OpDef(name)
    {
        this->Input("x1")
            .ParamType(DYNAMIC)
