...
#include "log/log.h"
#include "../../../op_graph/foreach_mul_list_inplace_proto.h"

class ForeachMulListInplaceTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(ForeachMulListInplaceTest, infer_shape_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachMulListInplace")->infer_shape;
...
TEST_F(ForeachMulListInplaceTest, infer_datatype_success)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachMulListInplace")->infer_datatype;
