...
- Description: Performs element-wise addition on the two tensor lists. The addition coefficient can be adjusted by the **alpha** parameter.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachAddListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachAddList** is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The tensor contains only one element. </li><li>The data type depends on that of `x1`:<ul><li>When `x1` is of the FLOAT32, FLOAT16, or INT32 type, the data type remains consistent with that of `x1`. </li><li>When `x1` is of the BFLOAT16 type, the data type must be FLOAT32.</li></ul></li></ul></td>
...
- **Returns**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      <td>alpha does not contain exactly one element.</td>
    </tr>
  </tbody></table>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachAddListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachAddList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachAddList.
  ...
  // Call the second-phase API of aclnnForeachAddList.
