...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_sub_list)
...
- Description: Subtracts elements in two tensor lists one by one and adjusts the subtraction coefficient using the **alpha** parameter.
  Compared with [aclnnForeachSubList](./aclnnForeachSubList_en.md), the input parameter **alpha** of this API is changed from aclTensor to aclScalar. You should select a proper API based on the actual situation.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachSubListV2GetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachSubListV2** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
    <tr>
      <td>x1</td>
      <td>Input</td>
      <td>List of tensors of the minuend in the subtraction operation, corresponding to `x1` in the formula.</td>
    ...
    <tr>
      <td>x2</td>
      <td>Input</td>
      <td>List of tensors of the subtrahend in the subtraction operation, corresponding to `x2` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>The data type, data format, and shape must be the same as those of the input parameter `x1`. </li><li>The data types of all tensors in this parameter must be the same.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16, INT32</td>
      <td>ND</td>
      <td>0–8</td>
      <td>×</td>
    ...
    <tr>
      <td>alpha</td>
      <td>Input</td>
      <td>Coefficient of the subtrahend in the subtraction operation, corresponding to `alpha` in the formula.</td>
      <td>The data type has a certain mapping relationship with the data type of the input parameter `x1`: <ul><li>When the data type of `x1` is FLOAT32 or BFLOAT16, its data type can be FLOAT32 or DOUBLE. </li><li>When the data type of `x1` is INT32, its data type can be INT32 or INT64.</li></ul></td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>List of output tensors of the subtraction operation, corresponding to `y` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>The data types of all tensors in this parameter must be the same. </li><li>The data type and format are the same as those of the input parameter `x1`, and the shape size must be greater than or equal to that of `x1`.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16, INT32</td>
      <td>ND</td>
      <td>0–8</td>
      <td>×</td>
...
- **Returns:**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      <td>The data types of x1, x2, and out are inconsistent.</td>
    </tr>
    <tr>
      <td>The shape of x1, x2, or out does not meet the constraints.</td>
    </tr>
    <tr>
      <td>The data types of tensors in x1, x2, or out are inconsistent.</td>
    </tr>
    <tr>
      <td>The tensor in x1, x2, or out has more than eight dimensions.</td>
    </tr>
  </tbody></table>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, obtained by calling the first-phase API aclnnForeachSubListV2GetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachSubListV2** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachSubListV2.
  ...
  // Call the second-phase API of aclnnForeachSubListV2.
