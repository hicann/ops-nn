...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_pow_scalar_list)
...
- Description: Raises each tensor in the input tensor list **x** to the power of the corresponding scalar in the scalar exponent list.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachPowScalarListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachPowScalarList** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>scalars</td>
      <td>Input</td>
      <td>Exponent list for the power computation, corresponding to `exponent` in the formula.</td>
      <td><ul><li>The number of elements is equal to the number of tensors in `x`. </li><li>The data type depends on that of `x`:<ul><li>When `x` is of the FLOAT32, FLOAT16, or BFLOAT16 type, the data type must be FLOAT32. </li><li>When x is of the INT32 type, the data type must be INT64. </li></ul></li><li>Its absolute value must be less than or equal to (2^31 – 1).</li></ul></td>
      <td>FLOAT32, INT64</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachPowScalarListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachPowScalarList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachPowScalarList.
  ...
  // Call the second-phase API of aclnnForeachPowScalarList.
