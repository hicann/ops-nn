...
- Description: Adds the specified tensor value to each tensor in the tensor list.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachAddScalarGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachAddScalar** is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>scalar</td>
      <td>Input</td>
      <td>Input tensor for the addition operation, corresponding to `scalar` in the formula.</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachAddScalarGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachAddScalar** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachAddScalar.
  ...
  // Call the second-phase API of aclnnForeachAddScalar.
