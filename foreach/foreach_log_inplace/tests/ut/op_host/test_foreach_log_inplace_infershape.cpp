...
#include "log/log.h"
#include "../../../op_graph/foreach_log_inplace_proto.h"

class ForeachLogInplaceTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(ForeachLogInplaceTest, infer_shape_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLogInplace")->infer_shape;
...
TEST_F(ForeachLogInplaceTest, infer_datatype_success)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachLogInplace")->infer_datatype;
