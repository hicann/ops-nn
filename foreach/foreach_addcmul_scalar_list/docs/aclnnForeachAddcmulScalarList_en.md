...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_addcmul_scalar_list)
...
- Description: Performs element-wise multiplication on tensor lists **x2** and **x3**, multiplies the result element-wise by the tensor **scalars**, and then adds the result element-wise to tensor list **x1**.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachAddcmulScalarListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachAddcmulScalarList** is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>scalars</td>
      <td>Input</td>
      <td>First input tensor for multiplication in mixed operations, corresponding to `scalars` in the formula.</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachAddcmulScalarListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachAddcmulScalarList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachAddcmulScalarList.
  ...
  // Call the second-phase API of aclnnForeachAddcmulScalarList.
