...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_sigmoid)
...
- Description: Performs the sigmoid function operation on each tensor in the input tensor list.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachSigmoidGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachSigmoid** is called to perform computation.
...
- **Parameters:**
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>List of input tensors on which the sigmoid function operation is performed, corresponding to `x` in the formula.</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>List of output tensors on which the sigmoid function operation is performed, corresponding to `y` in the formula.</td>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, obtained by calling the first-phase API aclnnForeachSigmoidGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachSigmoid** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachSigmoid.
  ...
  // Call the second-phase API of aclnnForeachSigmoid.
