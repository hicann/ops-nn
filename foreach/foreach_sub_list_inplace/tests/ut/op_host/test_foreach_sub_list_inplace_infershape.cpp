...
#include "log/log.h"
#include "../../../op_graph/foreach_sub_list_inplace_proto.h"

class ForeachSubListInplaceTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(ForeachSubListInplaceTest, infer_shape_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSubListInplace")->infer_shape;
    ...
    gert::StorageShape x_shape_4 = {{12}, {}};
    gert::StorageShape x_shape_5 = {{13}, {}};
    gert::StorageShape x_shape_6 = {{14}, {}};
...
TEST_F(ForeachSubListInplaceTest, infer_datatype_success)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSubListInplace")->infer_datatype;
