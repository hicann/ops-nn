...
/*!
 * \file foreach_sub_list_inplace_def.cpp
 * \brief
 */
...
class ForeachSubListInplace : public OpDef {
public:
    explicit ForeachSubListInplace(const char* name) : OpDef(name)
    {
        this->Input("x1")
            .ParamType(DYNAMIC)
