...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_sqrt)
...
- Description: Performs the square root operation on each tensor in the input tensor list.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachSqrtGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachSqrt** is called to perform computation.
...
- **Parameters:**
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>List of input tensors on which the square root operation is performed, corresponding to `x` in the formula.</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>List of output tensors on which the square root operation is performed, corresponding to `y` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>The data types of all tensors in this parameter must be the same. </li><li>The data type and format must be the same as those of the input parameter `x`.</li><ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>0–8</td>
      <td>√</td>
    ...
    - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>: The shape size of the input parameter `x` is less than or equal to that of the output parameter `out`.
- **Returns:**
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, obtained by calling the first-phase API aclnnForeachSqrtGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachSqrt.
  ...
  // Call the second-phase API of aclnnForeachSqrt.
