...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_lerp_list)
...
- Description: Performs element-wise linear interpolation on corresponding tensors in two tensor lists using **weight** as the interpolation coefficients.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachLerpListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachLerpList** is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    <tr>
      <td>x1</td>
      <td>Input</td>
      <td>First input tensor list for the linear interpolation operation, corresponding to `x1` in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>All tensors within this parameter must share the same data type. </li><li>The shape must be the same as that of `x2` and `weight`.</li></ul></td>
    ...
    <tr>
      <td>x2</td>
      <td>Input</td>
      <td>Second input tensor list for the linear interpolation operation, corresponding to `x2` in the formula.</td>
    ...
    <tr>
      <td>weight</td>
      <td>Input</td>
      <td>Tensor list of interpolation coefficients for the linear interpolation operation, corresponding to `weight` in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>All tensors within this parameter must share the same data type. </li><li>The data type, data format, and shape must be the same as those of `x1`.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>0–8</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output tensor list for the linear interpolation operation, corresponding to `y` in the formula.</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>The passed x1, x2, weight, or out is a null pointer.</td>
    </tr>
    <tr>
      <td rowspan="2">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="2">161002</td>
      <td>The data type of x1, x2, weight, or out is not supported.</td>
    </tr>
    <tr>
      <td>The data types of x1, x2, weight, and out do not match.</td>
    </tr>
    <tr>
      <td rowspan="3">ACLNN_ERR_INNER_TILING_ERROR</td>
      <td rowspan="3">561002</td>
      <td>The shape of x1, x2, weight, or out does not meet the constraints.</td>
    </tr>
    <tr>
      <td>The data types of tensors in x1, x2, weight, or out do not match.</td>
    </tr>
    <tr>
      <td>A tensor in x1, x2, weight, or out has more than eight dimensions.</td>
    </tr>
  </tbody></table>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachLerpListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachLerpList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachLerpList.
  ...
  // Call the second-phase API of aclnnForeachLerpList.
