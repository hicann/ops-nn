...
/*!
 * \file foreach_mul_scalar_inplace_proto.h
 * \brief
 */
#ifndef OPS_OP_PROTO_INC_FOREACH_MUL_SCALAR_INPLACE_H_
#define OPS_OP_PROTO_INC_FOREACH_MUL_SCALAR_INPLACE_H_
 ...
 *        the dtype can be BFloat16, Float16, Int32 or Float32, and the format supports ND.
 ...
 */
#ifndef OPS_PROTO_DEF_FOREACHMULSCALARINPLACE
#define OPS_PROTO_DEF_FOREACHMULSCALARINPLACE
...
#endif // OPS_PROTO_DEF_FOREACHMULSCALARINPLACE
} // namespace ge
#endif // OPS_OP_PROTO_INC_FOREACH_MUL_SCALAR_INPLACE_H_
