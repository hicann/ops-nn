...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_pow_list)
...
- Description: Raises each tensor in the input tensor list to the power of the corresponding tensor in **x2** element-wise.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachPowListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachPowList** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x1</td>
      <td>Input</td>
      <td>Tensor list of bases for the power computation, corresponding to `x1` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>All tensors within this parameter must share the same data type. </li><li>The shape must be the same as that of `x2`.</li></ul></td>
    ...
    <tr>
      <td>x2</td>
      <td>Input</td>
      <td>Tensor list of exponents for the power computation, corresponding to `x2` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>All tensors within this parameter must share the same data type. </li><li>The data type, data format, and shape must be the same as those of `x1`. </li><li>Its absolute value must be less than or equal to (2^31 – 1).</li></ul></td>
      <td>FLOAT32, FLOAT16, INT32, BFLOAT16</td>
      <td>ND</td>
      <td>0–8</td>
      <td>√</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachPowListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachPowList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachPowList.
  ...
  // Call the second-phase API of aclnnForeachPowList.
