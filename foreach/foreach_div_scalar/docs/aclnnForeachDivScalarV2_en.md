...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_div_scalar)
...
- Description: Divides each tensor in tensor list **x** by the scalar **scalar**. Compared with [aclnnForeachDivScalar](./aclnnForeachDivScalar_en.md), this API modifies the structure type of the input parameter **scalar** from aclTensor to aclScalar. Select the appropriate API based on actual requirements.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachDivScalarV2GetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachDivScalarV2** is called to perform computation.
...
- **Parameters**
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>scalar</td>
      <td>Input</td>
      <td>Second input scalar for the division operation, corresponding to `scalar` in the formula.</td>
      <td>The data type depends on that of `x`:<ul><li>When `x` is of the FLOAT32 or BFLOAT16 type, the data type must be FLOAT32 or DOUBLE.</li>
      <li>When `x` is of the FLOAT16 type, the data type must be FLOAT16 or DOUBLE.</li></ul></td>
...
- **Returns**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      <td>The data type of x, scalar, or out is not supported.
      <tr>
      <td>The data types of x and out do not match.</li>
      <tr>
      <td>The shape of x or out does not meet the constraints.</li>
      <tr>
      <td>The data types of tensors in x or out do not match.</li>
      <tr>
      <td>A tensor in x or out has more than eight dimensions.</li>
      </td>
    </tr>
  </tbody></table>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachDivScalarV2GetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachDivScalarV2** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachDivScalarV2.
  ...
  // Call the second-phase API of aclnnForeachDivScalarV2.
