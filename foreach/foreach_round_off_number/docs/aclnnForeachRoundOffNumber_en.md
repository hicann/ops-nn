...
- Description: Rounds off each tensor in the input tensor list with a specified precision. The rounding mode can be specified using **roundMode**.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachRoundOffNumberGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachRoundOffNumber** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>roundMode</td>
      <td>Input</td>
      <td>Input tensors to be rounded, corresponding to `roundMode` in the formula.</td>
...
- **Returns:**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      <td>The number of roundMode elements is not 1.</td>
    </tr>
  </tbody></table>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, obtained by calling the first-phase API aclnnForeachRoundOffNumberGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachRoundOffNumber** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachRoundOffNumber.
  ...
  // Call the second-phase API of aclnnForeachRoundOffNumber.
