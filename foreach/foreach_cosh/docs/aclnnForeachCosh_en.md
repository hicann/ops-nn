...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_cosh)
...
- Description: Performs element-wise hyperbolic cosine operation.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachCoshGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachCosh** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>Input tensor list for the hyperbolic cosine operation, corresponding to `x` in the formula.</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output tensor list for the hyperbolic cosine operation, corresponding to `y` in the formula.</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachCoshGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachCosh** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachCosh.
  ...
  // Call the second-phase API of aclnnForeachCosh.
