...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_norm)
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachNormGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachNorm** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>Input tensor list for the norm computation, corresponding to `x` in the formula.</td>
    ...
    <tr>
      <td>scalar</td>
      <td>Input</td>
      <td>Order for the norm computation, corresponding to `p` in the formula.</td>
      <td>-</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output tensor list for the norm computation, corresponding to `y` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>All tensors within this parameter must share the same data type. </li><li>The shape size must be 1. </li><li>The data type and format must be the same as those of `x`, and the shape size must be greater than or equal to that of `x`.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>0–8</td>
      <td>√</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The shape size of out is not 1.</td>
    </tr>
    <tr>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachNormGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachNorm.
  ...
  // Call the second-phase API of aclnnForeachNorm.
