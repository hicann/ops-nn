...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_div_scalar_list)
...
- Description: Performs element-wise division of each tensor in tensor list **x** by the corresponding scalar in scalar list **scalars**.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachDivScalarListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachDivScalarList** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>First input tensor list for the division operation, corresponding to `x` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>A tensor list can contain a maximum of 50 tensors. </li><li>All tensors within this parameter must share the same data type.</li></ul></td>
    ...
    <tr>
      <td>scalars</td>
      <td>Input</td>
      <td>Second input scalar list for the division operation, corresponding to `scalars` in the formula.</td>
      <td>The number of elements is equal to the number of tensors in `x`.</td>
      <td>FLOAT32</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output tensor list for the division operation, corresponding to `y` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>The length of the tensor list `out` must be equal to that of `x`. </li><li>All tensors within this parameter must share the same data type. </li><li>The data type and format must be the same as those of `x`, and the shape size must be greater than or equal to that of `x`.</li></ul></td>
      <td>BFLOAT16, FLOAT16, FLOAT32</td>
      <td>ND</td>
      <td>0–8</td>
      <td>√</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>The passed x, scalars, or out is a null pointer.</td>
    </tr>
    <tr>
      <td rowspan="2">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="2">161002</td>
      <td>The data type of x, scalars, or out is not supported.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>The length of the tensor list x is not supported.</td>
    </tr>
    <tr>
      <td>The lengths of tensor lists x, scalars, and out are inconsistent.</td>
    </tr>
  </tbody></table>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachDivScalarListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachDivScalarList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachDivScalarList.
  ...
  // Call the second-phase API of aclnnForeachDivScalarList.
