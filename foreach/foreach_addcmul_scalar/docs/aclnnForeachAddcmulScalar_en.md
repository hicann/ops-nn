...
- Description: Performs element-wise multiplication on tensor lists **x2** and **x3**, multiplies the result by the tensor **scalar**, and then adds the result element-wise to tensor list **x1**.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachAddcmulScalarGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachAddcmulScalar** is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>scalar</td>
      <td>Input</td>
      <td>First input tensor for multiplication in mixed operations, corresponding to `scalar` in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The tensor contains only one element. </li><li>The data format is the same as that of `x1`.</li></ul></td>
  ...
  - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>:
    ...
    - When `x1` is of the FLOAT32, FLOAT16, or INT32 type, the data type remains consistent with that of `x1`.
    - When `x1` is of the BFLOAT16 type, the data type must be FLOAT32.
- **Returns**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      <td>The data types of tensors in x1, x2, x3, or out do not match.</td>
    </tr>
    <tr>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachAddcmulScalarGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachAddcmulScalar** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachAddcmulScalar.
  ...
  // Call the second-phase API of aclnnForeachAddcmulScalar.
