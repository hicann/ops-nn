...
#include "../../../../op_kernel/arch35/foreach_abs_tiling_data.h"
#include "../../../../op_kernel/arch35/foreach_abs_tiling_key.h"

using namespace ut_util;

class ForeachAbsArch35TilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "ForeachAbsArch35TilingTest SetUp" << std::endl; }
    static void TearDownTestCase() { std::cout << "ForeachAbsArch35TilingTest TearDown" << std::endl; }
};
...
static void DoCase(std::initializer_list<int64_t> xShape, ge::DataType dt, uint64_t expectKey)
{
    ...
    std::map<std::string, std::string> soc_version_infos = {
        {std::string("Short_SoC_version"), std::string("Ascend950")}};
...
TEST_F(ForeachAbsArch35TilingTest, foreach_abs_float16)
{
    DoCase({4, 4}, ge::DT_FLOAT16, GET_TPL_TILING_KEY(FOREACH_ABS_TPL_SCH_MODE_FLOAT16));
}

TEST_F(ForeachAbsArch35TilingTest, foreach_abs_float32)
{
    DoCase({4, 4}, ge::DT_FLOAT, GET_TPL_TILING_KEY(FOREACH_ABS_TPL_SCH_MODE_FLOAT32));
}

TEST_F(ForeachAbsArch35TilingTest, foreach_abs_bfloat16)
{
    DoCase({4, 4}, ge::DT_BF16, GET_TPL_TILING_KEY(FOREACH_ABS_TPL_SCH_MODE_BFLOAT16));
}
