...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_maximum_list)
...
- Description: Computes the element-wise maximum of each pair of corresponding tensors in tensor lists **x1** and **x2**.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachMaximumListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachMaximumList** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>x1</td>
      <td>Input</td>
      <td>First input tensor list for the maximum operation, corresponding to `x1` in the formula.</td>
    ...
    <tr>
      <td>x2</td>
      <td>Input</td>
      <td>Second input tensor list for the maximum operation, corresponding to `x2` in the formula.</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachMaximumListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachMaximumList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachMaximumList.
  ...
  // Call the second-phase API of aclnnForeachMaximumList.
