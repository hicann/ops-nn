...
#include "log/log.h"
#include "../../../op_graph/foreach_sub_scalar_inplace_proto.h"

class ForeachSubScalarInplaceTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(ForeachSubScalarInplaceTest, infer_shape_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSubScalarInplace")->infer_shape;
...
TEST_F(ForeachSubScalarInplaceTest, infer_datatype_success)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachSubScalarInplace")->infer_datatype;
