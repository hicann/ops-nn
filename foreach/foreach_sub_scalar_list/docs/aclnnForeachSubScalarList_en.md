...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_sub_scalar_list)
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachSubScalarListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachSubScalarList** is called to perform computation.
...
- **Parameters:**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>scalars</td>
      <td>Input</td>
      <td>List of the second input scalars in the subtraction operation, corresponding to `x2` in the formula.</td>
      <td><ul><li>The number of elements is equal to the number of tensors in `x`. </li><li>The data type has a certain mapping relationship with the data type of the input parameter `x`: <ul><li>When the data type of `x` is FLOAT32, FLOAT16, or BFLOAT16, its data type of `scalars` must be FLOAT32. </li><li>When the data type of the input parameter `x` is INT32, its data type of `scalars` must be INT64.</li></ul></td>
      <td>FLOAT32, INT64</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, obtained by calling the first-phase API aclnnForeachSubScalarListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachSubScalarList.
  ...
  // Call the second-phase API of aclnnForeachSubScalarList.
