...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_add_scalar_list)
...
- Description: Performs element-wise addition on the input tensor list and input scalar list.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachAddScalarListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachAddScalarList** is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>The number of elements is equal to the number of tensors in `x`. </li><li>The data type depends on that of `x`:<ul><li>When `x` is of the FLOAT32, FLOAT16, or BFLOAT16 type, `scalars` must be FLOAT32. </li><li>When `x` is of the INT32 type, `scalars` must be INT64.</li></ul></li></ul></td>
      <td>FLOAT32, INT64</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachAddScalarListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachAddScalarList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachAddScalarList.
  ...
  // Call the second-phase API of aclnnForeachAddScalarList.
