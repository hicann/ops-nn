...
class ForeachAddListInplaceTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(ForeachAddListInplaceTest, infer_shape_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddListInplace")->infer_shape;
...
TEST_F(ForeachAddListInplaceTest, infer_datatype_success)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachAddListInplace")->infer_datatype;
