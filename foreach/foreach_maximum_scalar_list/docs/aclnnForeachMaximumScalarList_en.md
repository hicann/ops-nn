...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_maximum_scalar_list)
...
- Description: Computes the element-wise maximum of each tensor in tensor list **x** and the corresponding scalar in scalar list **scalars**.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachMaximumScalarListGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachMaximumScalarList** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>scalars</td>
      <td>Input</td>
      <td>Input scalar list for the maximum operation, corresponding to `scalars` in the formula.</td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachMaximumScalarListGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachMaximumScalarList** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachMaximumScalarList.
  ...
  // Call the second-phase API of aclnnForeachMaximumScalarList.
