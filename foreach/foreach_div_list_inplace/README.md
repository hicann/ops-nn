...
- 算子功能：对两个张量列表执行逐元素相除，结果原地写回第一个列表。
- 计算公式：
...
| 调用方式 | 样例代码 | 说明 |
| --- | --- | --- |
| aclnn接口 | [test_aclnn_foreach_div_list_inplace](examples/arch35/test_aclnn_foreach_div_list_inplace.cpp) | 通过[aclnnForeachDivListInplace](docs/aclnnForeachDivListInplace.md)接口方式调用ForeachDivListInplace算子。 |
