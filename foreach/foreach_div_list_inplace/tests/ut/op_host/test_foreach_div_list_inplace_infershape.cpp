...
#include "log/log.h"
#include "../../../op_graph/foreach_div_list_inplace_proto.h"

class ForeachDivListInplaceTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(ForeachDivListInplaceTest, infer_shape_success)
{
    auto infer_shape_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachDivListInplace")->infer_shape;
...
TEST_F(ForeachDivListInplaceTest, infer_datatype_success)
{
    auto infer_datatype_func = gert::OpImplRegistry::GetInstance().GetOpImpl("ForeachDivListInplace")->infer_datatype;
