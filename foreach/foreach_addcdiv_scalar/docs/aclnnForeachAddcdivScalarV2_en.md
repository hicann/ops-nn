...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_addcdiv_scalar)
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachAddcdivScalarV2GetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachAddcdivScalarV2** is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>All tensors within this parameter must share the same data type. </li><li>The shape must be the same as that of `x2` and `x3`.</li></ul></td>
    ...
    <tr>
      <td>scalar</td>
      <td>Input</td>
      <td>Second input scalar for multiplication in mixed operations, corresponding to `scalar` in the formula.</td>
      <td>The data type depends on that of `x1`:<ul><li>When `x1` is of the FLOAT32 or BFLOAT16 type, the data type must be FLOAT32 or DOUBLE. </li><li>When `x1` is of the FLOAT16 type, the data type must be FLOAT16 or DOUBLE.</li></ul></td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>The passed x1, x2, x3, scalar, or out is a null pointer.</td>
    </tr>
    <tr>
      <td rowspan="5">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="5">161002</td>
      <td>The data type of x1, x2, x3, scalar, or out is not supported.</td>
    </tr>
    <tr>
      <td>The data types of x1, x2, x3, and out do not match.</td>
    </tr>
    <tr>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachAddcdivScalarV2GetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachAddcdivScalarV2** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachAddcdivScalarV2.
  ...
  // Call the second-phase API of aclnnForeachAddcdivScalarV2.
