...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/foreach/foreach_pow_scalar_and_tensor)
...
- Description: Raises the input scalar **scalar** to the power of each tensor in the input tensor list **x**.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachPowScalarAndTensorGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachPowScalarAndTensor** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      <td>scalar</td>
      <td>Input</td>
      <td>Base for the power computation, corresponding to `scalar` in the formula.</td>
      <td>The data type depends on that of `x`:<ul><li>When `x` is of the FLOAT32, FLOAT16, or BFLOAT16 type, the data type must be FLOAT32 or DOUBLE. </li><li>When `x` is of the INT32 type, the data type must be INT64.</li></ul></td>
    ...
    <tr>
      <td>x</td>
      <td>Input</td>
      <td>Input tensor list as exponents of the power computation, corresponding to `x` in the formula.</td>
      <td><ul><li>Empty tensors are supported. </li><li>Its absolute value must be less than or equal to (2^31 – 1).</li></ul></td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachPowScalarAndTensorGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachPowScalarAndTensor** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachPowScalarAndTensor.
  ...
  // Call the second-phase API of aclnnForeachPowScalarAndTensor.
