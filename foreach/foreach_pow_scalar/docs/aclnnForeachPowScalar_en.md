...
- Description: Raises each tensor in the input tensor list **x** to the power of the tensor **scale**.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnForeachPowScalarGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnForeachPowScalar** is called to perform computation.
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>The tensor contains only one element. </li><li>The data type depends on that of `x`:<ul><li>When `x` is of the FLOAT32, FLOAT16, or INT32 type, the data type remains consistent with that of `x`. </li><li>When `x` is of the BFLOAT16 type, the data type must be FLOAT32. </li></ul></li><li>Its absolute value must be less than or equal to (2^31 – 1).</li></ul></td>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnForeachPowScalarGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic computation:
  - **aclnnForeachPowScalar** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnForeachPowScalar.
  ...
  // Call the second-phase API of aclnnForeachPowScalar.
