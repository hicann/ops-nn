...
protected:
    ge::graphStatus InputDtypeCheck(ge::DataType dyDtype, ge::DataType xDtype, ge::DataType varianceDtype,
                                    ge::DataType meanDtype, ge::DataType gammaDtype);
    bool CheckShapeSame(const size_t leftIndex, const size_t rightIndex, const bool isLeftInput,
