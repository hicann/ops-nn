...
class l2_fast_layer_norm_test : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "layer_norm_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "layer_norm_test TearDown" << endl; }
};

// float32
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_float32_nd_float32_nd)
{
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_double_nd_double_nd)
{
...
// error input dtype
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_error_input_dtype)
{
...
// error weight dtype
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_error_weight_dtype)
{
...
// error bias dtype
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_error_bias_dtype)
{
    auto inputDesc = TensorDesc({2, 6, 5, 6}, ACL_FLOAT, ACL_FORMAT_NCHW).ValueRange(-2, 2);
    auto weightDesc = TensorDesc({6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto biasDesc = TensorDesc({6, 5, 6}, ACL_UINT64, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_weight_bias_diff_dtype)
{
    auto inputDesc = TensorDesc({2, 6, 5, 6}, ACL_FLOAT, ACL_FORMAT_NCHW).ValueRange(-2, 2);
    auto weightDesc = TensorDesc({6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
// error out dtype
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_error_out_dtype)
{
    auto inputDesc = TensorDesc({2, 6, 5, 6}, ACL_FLOAT, ACL_FORMAT_NCHW).ValueRange(-2, 2);
    auto weightDesc = TensorDesc({6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto biasDesc = TensorDesc({6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_float32_hwcn_float32_hwcn_all_reduce)
{
...
// ndhwc, float32
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_float32_ndhwc_float32_ndhwc)
{
...
// ncdhw, float32
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_float32_ncdhw_float32_ncdhw)
{
...
// M = 0
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_0_2_7_18_float_nd_7_18_float_nd)
{
...
// N = 0
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_2_0_4_float_nd_0_4_float_nd)
{
...
// error input len
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_error_input_len)
{
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_error_normalizedShape_len)
{
    auto inputDesc = TensorDesc({2, 6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_diff_weight_and_normalizedShape)
{
    auto inputDesc = TensorDesc({2, 6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto weightDesc = TensorDesc({6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto biasDesc = TensorDesc({6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_error_input_and_normalizedShape_shape)
{
    auto inputDesc = TensorDesc({2, 6, 5, 6}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_error_weight_and_bias_shape)
{
...
// input nullptr
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_input_nullptr)
{
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_normalizedShape_nullptr)
{
...
// out nullptr
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_out_nullptr)
{
    auto inputDesc = TensorDesc({7, 8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto weightDesc = TensorDesc({8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto biasDesc = TensorDesc({8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
// meanOut nullptr
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_meanOout_nullptr)
{
    auto inputDesc = TensorDesc({7, 8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto weightDesc = TensorDesc({8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto biasDesc = TensorDesc({8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
// rstdOut nullptr
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_rstdOut_nullptr)
{
    auto inputDesc = TensorDesc({7, 8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto weightDesc = TensorDesc({8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
    auto biasDesc = TensorDesc({8, 9}, ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-2, 2);
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_float16_mix_dtype)
{
...
TEST_F(l2_fast_layer_norm_test, ascend910B2_aclnnFastLayerNorm_bfloat16_mix_dtype)
{
