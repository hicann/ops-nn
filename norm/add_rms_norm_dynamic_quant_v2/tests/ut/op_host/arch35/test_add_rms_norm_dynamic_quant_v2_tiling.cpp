...
#include "../../../../op_host/arch35/add_rms_norm_dynamic_quant_v2_tiling_arch35.h"

using namespace ut_util;
using namespace std;
using namespace ge;

class AddRmsNormDynamicQuantV2TilingArch35 : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "AddRmsNormDynamicQuantV2TilingArch35 SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddRmsNormDynamicQuantV2TilingArch35 TearDown" << std::endl; }
};
                            ...
                            ge::graphStatus status = ge::GRAPH_SUCCESS)
{
 ...
 "hardware_info": {"BT_SIZE": 0, "load3d_constraints": "1",
    ...
    // compile info
    optiling::AddRmsNormDynamicQuantV2CompileInfo compile_info;
    ...
    auto holder = [&]() {
        if (num_inputs == 6) {
            return gert::TilingContextFaker()
                ...
                .NodeOutputTd(3, input_dtype, ge::FORMAT_ND, ge::FORMAT_ND)
                .NodeOutputTd(4, input_dtype, ge::FORMAT_ND, ge::FORMAT_ND)
...
TEST_F(AddRmsNormDynamicQuantV2TilingArch35, add_rms_norm_dynamic_quant_v2_tiling_001)
{
    gert::StorageShape input_shape = {{24, 1, 11264}, {24, 1, 11264}};
    gert::StorageShape gamma_shape = {{11264}, {11264}};
    gert::StorageShape out_shape = {{24, 1, 11264}, {24, 1, 11264}};
    gert::StorageShape reduce_shape = {{24, 1}, {24, 1}};

    ExecuteTestCase(input_shape, gamma_shape, out_shape, reduce_shape, 5, ge::DT_FLOAT16, ge::DT_INT8,
                    {true, true, true, true}, 2, 50);
}

TEST_F(AddRmsNormDynamicQuantV2TilingArch35, add_rms_norm_dynamic_quant_v2_tiling_002)
{
    ...
    ExecuteTestCase(input_shape, gamma_shape, out_shape, reduce_shape, 6, ge::DT_FLOAT16, ge::DT_INT8,
                    {true, true, true, true}, 2, 51);
}

TEST_F(AddRmsNormDynamicQuantV2TilingArch35, add_rms_norm_dynamic_quant_v2_tiling_003)
{
    gert::StorageShape input_shape = {{124, 1, 5000}, {124, 1, 5000}};
    gert::StorageShape gamma_shape = {{5000}, {5000}};
    gert::StorageShape out_shape = {{124, 1, 5000}, {124, 1, 5000}};
    gert::StorageShape reduce_shape = {{124, 1}, {124, 1}};

    ExecuteTestCase(input_shape, gamma_shape, out_shape, reduce_shape, 4, ge::DT_FLOAT16, ge::DT_INT8,
                    {true, true, true, true}, 2, 48);
}

TEST_F(AddRmsNormDynamicQuantV2TilingArch35, add_rms_norm_dynamic_quant_v2_tiling_004)
{
    gert::StorageShape input_shape = {{124, 1, 7000}, {124, 1, 7000}};
    gert::StorageShape gamma_shape = {{7000}, {7000}};
    gert::StorageShape out_shape = {{124, 1, 7000}, {124, 1, 7000}};
    gert::StorageShape reduce_shape = {{124, 1}, {124, 1}};

    ExecuteTestCase(input_shape, gamma_shape, out_shape, reduce_shape, 6, ge::DT_FLOAT16, ge::DT_INT8,
                    {true, true, true, true}, 2, 49);
}

TEST_F(AddRmsNormDynamicQuantV2TilingArch35, add_rms_norm_dynamic_quant_v2_tiling_005)
{
    gert::StorageShape input_shape = {{124, 0, 7000}, {124, 0, 7000}};
    gert::StorageShape gamma_shape = {{7000}, {7000}};
    gert::StorageShape out_shape = {{124, 0, 7000}, {124, 0, 7000}};
    gert::StorageShape reduce_shape = {{124, 0}, {124, 0}};

    ExecuteTestCase(input_shape, gamma_shape, out_shape, reduce_shape, 6, ge::DT_FLOAT16, ge::DT_INT8,
                    {true, true, true, true}, 2, 49);
}

TEST_F(AddRmsNormDynamicQuantV2TilingArch35, add_rms_norm_dynamic_quant_v2_tiling_006)
{
    gert::StorageShape input_shape = {{124, 1, 0}, {124, 1, 0}};
    gert::StorageShape gamma_shape = {{0}, {0}};
    gert::StorageShape out_shape = {{124, 1, 0}, {124, 1, 0}};
    gert::StorageShape reduce_shape = {{124, 1}, {124, 1}};

    ExecuteTestCase(input_shape, gamma_shape, out_shape, reduce_shape, 6, ge::DT_FLOAT16, ge::DT_INT8,
                    {true, true, true, true}, 2, 4);
}
