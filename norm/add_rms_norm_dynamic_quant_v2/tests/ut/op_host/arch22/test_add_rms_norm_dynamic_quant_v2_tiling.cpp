...
/*!
 * \file test_add_rms_norm_dynamic_quant_v2_tiling.cpp
 * \brief
 */
...
class AddRmsNormDynamicQuantV2TilingArch22 : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "AddRmsNormDynamicQuantV2TilingArch22 SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddRmsNormDynamicQuantV2TilingArch22 TearDown" << std::endl; }
};

static void ExecuteTestCase(gert::StorageShape input_shape, gert::StorageShape gamma_shape,
                            gert::StorageShape out_shape, gert::StorageShape reduce_shape, ge::DataType output_dtype,
                            int expected_tiling_key, float epsilon = 0.01f, ge::graphStatus status = ge::GRAPH_SUCCESS)
{
...
TEST_F(AddRmsNormDynamicQuantV2TilingArch22, add_rms_norm_dynamic_quant_v2_tiling_001)
{
    ...
    ExecuteTestCase(input_shape, gamma_shape, out_shape, reduce_shape, ge::DT_INT8, 2);
}

TEST_F(AddRmsNormDynamicQuantV2TilingArch22, add_rms_norm_dynamic_quant_v2_tiling_002)
{
    ...
    ExecuteTestCase(input_shape, gamma_shape, out_shape, reduce_shape, ge::DT_INT8, 3);
}
