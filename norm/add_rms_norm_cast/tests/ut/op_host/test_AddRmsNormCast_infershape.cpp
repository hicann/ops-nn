...
protected:
    static void SetUpTestCase() { std::cout << "AddRmsNormCast Proto Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddRmsNormCast Proto Test TearDown" << std::endl; }
};
