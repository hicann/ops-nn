...
/* !
 * \file batch_norm_ext2_infer_last_channel_continuous_a.h
 * \brief
 */

#ifndef BATCH_NORM_EXT2_INFER_LAST_CHANNEL_CONTINUOUS_A_H
#define BATCH_NORM_EXT2_INFER_LAST_CHANNEL_CONTINUOUS_A_H
...
class BatchNormExt2InferLastChannelContinuousA {
...
public:
    __aicore__ inline BatchNormExt2InferLastChannelContinuousA(){};

    __aicore__ inline BatchNormExt2InferLastChannelContinuousA(
        const BatchNormExt2InferLastChannelTilingData* tilingDataIn)
    {
