...
/* !
 * \file batch_norm_ext2_infer_last_channel_small_a.h
 * \brief
 */

#ifndef BATCH_NORM_EXT2_INFER_LAST_CHANNEL_SMALL_A_H
#define BATCH_NORM_EXT2_INFER_LAST_CHANNEL_SMALL_A_H

#include "kernel_tiling/kernel_tiling.h"
#include "kernel_operator.h"
#include "batch_norm_ext2_base.h"
...
class BatchNormExt2InferLastChannelSmallA {
    static constexpr int32_t BUFFER_NUM = 2;
    static constexpr int32_t BUFFER_DEPTH = 1;

    static constexpr uint16_t VECTOR_LENGTH = BatchNormExt2Ops::VECTOR_LENGTH;
    static constexpr uint16_t VL_FP32 = VECTOR_LENGTH / sizeof(float);
    static constexpr int64_t BLOCK_SIZE = BatchNormExt2Ops::BLOCK_SIZE;
...
public:
    __aicore__ inline BatchNormExt2InferLastChannelSmallA(){};

    __aicore__ inline BatchNormExt2InferLastChannelSmallA(const BatchNormExt2InferLastChannelTilingData* tilingDataIn)
    {
...
private:
    const BatchNormExt2InferLastChannelTilingData* tilingData_;
