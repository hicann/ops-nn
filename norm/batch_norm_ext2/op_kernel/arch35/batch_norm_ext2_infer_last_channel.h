...
/*!
 * \file batch_norm_ext2_infer_last_channel.h
 * \brief
 */

#ifndef NORM_BATCH_NORM_EXT2_INFER_LAST_CHANNEL_H
#define NORM_BATCH_NORM_EXT2_INFER_LAST_CHANNEL_H
...
class BatchNormExt2InferLastChannel {
public:
    __aicore__ inline BatchNormExt2InferLastChannel(){};

    __aicore__ inline BatchNormExt2InferLastChannel(const BatchNormExt2InferLastChannelTilingData* tilingDataIn)
    {
...
#endif // NORM_BATCH_NORM_EXT2_INFER_LAST_CHANNEL_H
