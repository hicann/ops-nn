...
/*!
 * \file batch_norm_ext2_ra_welford.h
 * \brief
 */
#ifndef NORM_BATCH_NORM_EXT2_RA_WELFORD_H
#define NORM_BATCH_NORM_EXT2_RA_WELFORD_H
...
class BatchNormExt2RAWelford {
public:
    __aicore__ inline BatchNormExt2RAWelford(const BatchNormExt2RAWelfordTilingData* tilingData, TPipe* pipeIn)
    {
        this->pipe = pipeIn;
        this->r = tilingData->r;
...
#endif // NORM_BATCH_NORM_EXT2_RA_WELFORD_H
