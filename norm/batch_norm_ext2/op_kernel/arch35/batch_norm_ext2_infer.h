...
/*!
 * \file batch_norm_ext2_infer.h
 * \brief
 */

#ifndef NORM_BATCH_NORM_EXT2_INFER_H
#define NORM_BATCH_NORM_EXT2_INFER_H
...
class BatchNormExt2Infer {
public:
    __aicore__ inline BatchNormExt2Infer(){};

    __aicore__ inline BatchNormExt2Infer(const BatchNormExt2InferTilingData* tilingDataIn)
    {
...
#endif // NORM_BATCH_NORM_EXT2_INFER_H
