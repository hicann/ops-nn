...
/* !
 * \file batch_norm_ext2_infer_small_ab1.h
 * \brief
 */

#ifndef BATCH_NORM_EXT2_INFER_SMALL_AB1_H
#define BATCH_NORM_EXT2_INFER_SMALL_AB1_H
...
class BatchNormExt2InferSmallAB1 {
...
public:
    __aicore__ inline BatchNormExt2InferSmallAB1(){};

    __aicore__ inline BatchNormExt2InferSmallAB1(const BatchNormExt2InferTilingData* tilingDataIn)
    {
...
private:
    const BatchNormExt2InferTilingData* tilingData_;
