...
/*!
 * \file batch_norm_ext2_ra_full_reduce.h
 * \brief
 */
#ifndef NORM_BATCH_NORM_EXT2_RA_FULL_REDUCE_H
#define NORM_BATCH_NORM_EXT2_RA_FULL_REDUCE_H
...
class BatchNormExt2RAFullReduce {
public:
    __aicore__ inline BatchNormExt2RAFullReduce(const BatchNormExt2RAFullReduceTilingData* tilingData, TPipe* pipeIn)
    {
        this->pipe = pipeIn;
...
#endif // NORM_BATCH_NORM_EXT2_RA_FULL_REDUCE_H
