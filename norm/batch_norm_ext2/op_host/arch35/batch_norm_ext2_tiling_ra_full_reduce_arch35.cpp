...
/*!
 * \file batch_norm_ext2_tiling_ra_full_reduce_arch35.cpp
 * \brief
 */
...
class BatchNormExt2RAFullReduceTilingBase : public BatchNormExt2RegbaseTilingBase {
public:
    explicit BatchNormExt2RAFullReduceTilingBase(gert::TilingContext* context) : BatchNormExt2RegbaseTilingBase(context)
    {}
    ~BatchNormExt2RAFullReduceTilingBase() override = default;
...
private:
    ...
    BatchNormExt2RAFullReduceTilingData batchNormTilingData;
};

bool BatchNormExt2RAFullReduceTilingBase::IsNeedChangeToWelford(int64_t elemSize)
{
...
ge::graphStatus BatchNormExt2RAFullReduceTilingBase::BinaryAddTiling()
{
...
ge::graphStatus BatchNormExt2RAFullReduceTilingBase::DoOpTiling()
{
    // dim
...
uint64_t BatchNormExt2RAFullReduceTilingBase::GetTilingKey() const { return TILINGKEY_RA_FULL_REDUCE; }

ge::graphStatus BatchNormExt2RAFullReduceTilingBase::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNormExt2, BatchNormExt2RAFullReduceTilingBase, 10000);
} // namespace optiling
