...
/*!
 * \file batch_norm_ext2_tiling_ra_welford_arch35.cpp
 * \brief
 */
...
namespace optiling {
class BatchNormExt2RAWelfordTilingBase : public BatchNormExt2RegbaseTilingBase {
public:
    explicit BatchNormExt2RAWelfordTilingBase(gert::TilingContext* context) : BatchNormExt2RegbaseTilingBase(context) {}
    ~BatchNormExt2RAWelfordTilingBase() override = default;
...
private:
    BatchNormExt2RAWelfordTilingData batchNormTilingData;
};

void BatchNormExt2RAWelfordTilingBase::SetInputInfo()
{
    // dim
...
ge::graphStatus BatchNormExt2RAWelfordTilingBase::BinaryAddTiling(int64_t elemSize, int64_t aFactor)
{
    // rFactor
...
ge::graphStatus BatchNormExt2RAWelfordTilingBase::DoOpTiling()
{
    SetInputInfo();
    // core num
...
uint64_t BatchNormExt2RAWelfordTilingBase::GetTilingKey() const { return TILINGKEY_RA_WELFORD; }

ge::graphStatus BatchNormExt2RAWelfordTilingBase::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNormExt2, BatchNormExt2RAWelfordTilingBase, 15000);
} // namespace optiling
