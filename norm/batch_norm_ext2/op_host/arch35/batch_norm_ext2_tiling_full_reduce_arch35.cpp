...
/*!
 * \file batch_norm_ext2_tiling_full_reduce_arch35.cpp
 * \brief
 */
...
namespace optiling {
class BatchNormExt2FullReduceTilingBase : public BatchNormExt2RegbaseTilingBase {
public:
    explicit BatchNormExt2FullReduceTilingBase(gert::TilingContext* context) : BatchNormExt2RegbaseTilingBase(context)
    {}
    ~BatchNormExt2FullReduceTilingBase() override = default;
...
private:
    ...
    BatchNormExt2FullReduceRegbaseTilingData batchNormTilingData;
};

ge::graphStatus BatchNormExt2FullReduceTilingBase::DoOpTiling()
{
    // dim
...
uint64_t BatchNormExt2FullReduceTilingBase::GetTilingKey() const { return TILINGKEY_FULL_REDUCE; }

ge::graphStatus BatchNormExt2FullReduceTilingBase::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNormExt2, BatchNormExt2FullReduceTilingBase, 20000);
} // namespace optiling
