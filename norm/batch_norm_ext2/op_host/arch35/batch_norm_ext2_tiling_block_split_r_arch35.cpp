...
/*!
 * \file batch_norm_ext2_tiling_block_split_r_arch35.cpp
 * \brief
 */
...
namespace optiling {
class BatchNormExt2BlockSplitRTiling : public BatchNormExt2RegbaseTilingBase {
public:
    explicit BatchNormExt2BlockSplitRTiling(gert::TilingContext* context) : BatchNormExt2RegbaseTilingBase(context) {}
    ~BatchNormExt2BlockSplitRTiling() override = default;

    void Reset(gert::TilingContext* context) override { BatchNormExt2RegbaseTilingBase::Reset(context); }
...
private:
    BatchNormExt2BlockSplitRTilingData batchNormTilingData;
};

void BatchNormExt2BlockSplitRTiling::SetInputInfo()
{
    // dim
...
bool BatchNormExt2BlockSplitRTiling::BinaryAddTiling(const int64_t binaryAddNum, int64_t& binaryAddK,
...
ge::graphStatus BatchNormExt2BlockSplitRTiling::DoOpTiling()
{
    SetInputInfo();
    ...
    OP_CHECK_IF(rUbFactor == 0, OP_LOGI(context_->GetNodeName(), "BatchNormExt2BlockSplitRTiling rUbFactor == 0"),
    ...
    OP_CHECK_IF(res0 == false || res1 == false,
                OP_LOGI(context_->GetNodeName(), "BatchNormExt2BlockSplitRTiling BinaryAddTiling param invalid"),
                return ge::GRAPH_PARAM_INVALID);
...
uint64_t BatchNormExt2BlockSplitRTiling::GetTilingKey() const { return TILINGKEY_BLOCK_SPLIT_R; }

ge::graphStatus BatchNormExt2BlockSplitRTiling::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNormExt2, BatchNormExt2BlockSplitRTiling, 12000);
} // namespace optiling
