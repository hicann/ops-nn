...
/*!
 * \file batch_norm_ext2_tiling_def.h
 * \brief
 */

#ifndef __BATCH_NORM_EXT2_TILING_DEF_H__
#define __BATCH_NORM_EXT2_TILING_DEF_H__
...
#pragma pack(1)
struct BatchNormExt2FullReduceRegbaseTilingData {
    int64_t r1;
    int64_t r0;
    int64_t a;
    int64_t aFactor;
...
struct BatchNormExt2RAFullReduceTilingData {
    int64_t r1;
    int64_t a;
    int64_t aFactor;
    int64_t aBlockFactor;
...
struct BatchNormExt2WelfordRegbaseTilingData {
    int64_t r1;
    int64_t r0;
    int64_t a0;
    int64_t loopR1outer;
...
struct BatchNormExt2RAWelfordTilingData {
    int64_t r;
    int64_t rFactor;
    int64_t a;
    int64_t aFactor;
...
struct BatchNormExt2BlockSplitRTilingData {
    int64_t patternR;
    int64_t patternA;
...
struct BatchNormExt2RARBlockSplitRTilingData {
    int64_t patternR1;
    int64_t patternA;
    int64_t patternR0;
    int64_t patternAAlign;
...
struct BatchNormExt2InferTilingData {
    int64_t totalTiles;
...
struct BatchNormExt2InferLastChannelTilingData {
    int64_t totalTiles;
    int64_t tilesPerCore;
    int64_t totalALen;
    int64_t aOuter;
