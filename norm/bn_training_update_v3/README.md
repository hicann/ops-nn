...
<table style="undefined;table-layout: fixed; width: 1005px"><colgroup>
  ...
  <tbody>
    ...
    <tr>
      <td>epsilon</td>
      <td>必选属性</td>
      <td><ul><li>表示添加到save_variance上的小量，以确保数值稳定，对应公式中的<code>ε</code>。</li></ul></td>
      <td>FLOAT32</td>
      <td>-</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>输出</td>
      <td><ul><li>表示本batch的逐通道方差（无偏估计，即save_variance * num/(num-1)），对应公式中的<code>batch_variance</code>。</li><li>shape为[C]。</li></ul></td>
      <td>FLOAT32</td>
      <td>ND</td>
    </tr>
    <tr>
      <td>reserve_1</td>
      <td>输出</td>
      <td><ul><li>表示本batch的逐通道均值（save_mean，与batch_mean相同），供反向传播使用，对应公式中的<code>reserve_1</code>。</li><li>shape为[C]。</li></ul></td>
      <td>FLOAT32</td>
      <td>ND</td>
    </tr>
    <tr>
      <td>reserve_2</td>
      <td>输出</td>
      <td><ul><li>表示本batch的逐通道方差（save_variance，有偏估计），供反向传播使用，对应公式中的<code>reserve_2</code>。</li><li>shape为[C]。</li></ul></td>
      <td>FLOAT32</td>
      <td>ND</td>
    </tr>
  </tbody></table>
