...
inference mode.
*@li data_format: An optional string. Defaults to "NCDHW". Should be same as y_backprop/x/x_backprop's dtype.
...
* Compatible with the TensorFlow operators FusedBatchNorm3DGrad, FusedBatchNorm3DGradV2 and FusedBatchNorm3DGradV3.
*/
