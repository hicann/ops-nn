...
/* !
 * \file batch_norm3d_grad_rar_split_core_r0.h
 * \brief
 */

#ifndef __BATCH_NORM3D_GRAD_SPLIT_CORE_R0_H__
#define __BATCH_NORM3D_GRAD_SPLIT_CORE_R0_H__
...
class BatchNorm3DGradRARSplitCoreR0 {
public:
    __aicore__ inline BatchNorm3DGradRARSplitCoreR0(TPipe* pipeIn,
                                                    const BatchNorm3DGradRARSplitCoreR0TilingData* tilingDataIn)
    {
        pipe_ = pipeIn;
...
private:
    const BatchNorm3DGradRARSplitCoreR0TilingData* tilingData_{nullptr};
    TPipe* pipe_{nullptr};
...
#endif // __BATCH_NORM3D_GRAD_SPLIT_CORE_R0_H__
