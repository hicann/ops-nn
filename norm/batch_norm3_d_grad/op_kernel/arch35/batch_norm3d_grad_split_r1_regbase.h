...
/* !
 * \file batch_norm3d_grad_split_r1.h
 * \brief
 */

#ifndef BATCH_NORM3D_GRAD_SPLIT_R1_REGBASE_H
#define BATCH_NORM3D_GRAD_SPLIT_R1_REGBASE_H
...
class BatchNorm3DGradRARSplitR1 {
public:
    __aicore__ inline BatchNorm3DGradRARSplitR1(TPipe* pipe) { pipe_ = pipe; }
...
#endif // BATCH_NORM3D_GRAD_SPLIT_R1_REGBASE_H
