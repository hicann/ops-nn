...
/* !
 * \file batch_norm3d_grad_tiling_rar_split_core_r0.cpp
 * \brief
 */
...
namespace optiling {
static constexpr uint64_t BATCH_NORM3D_GRAD_RAR_SPLIT_CORE_R0_TILING_KEY = 1100;
...
class BatchNorm3DGradRARSplitCoreR0 : public BatchNorm3DGradTilingBase {
public:
    explicit BatchNorm3DGradRARSplitCoreR0(gert::TilingContext* context)
...
private:
    ...
    BatchNorm3DGradRARSplitCoreR0TilingData tilingData_;
...
bool BatchNorm3DGradRARSplitCoreR0::IsCapable()
{
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR0::DoOpTiling()
{
    ...
    tilingData_.r0Inner = r0Inner_;
    tilingData_.r0Tail = r0Tail_;

    return ge::GRAPH_SUCCESS;
}

ge::graphStatus BatchNorm3DGradRARSplitCoreR0::DoOpTilingStage0()
{
    ...
    OP_CHECK_IF(
        ...
        OP_LOGE_WITHOUT_REPORT(context_,
                               "BatchNorm3DGrad RAR R0 split core template is not capable. Shape (%ld, %ld, %ld), "
    ...
    OP_LOGD(context_,
            "BatchNorm3DGrad R0 split core template Stage0, r1Outer: %ld, r0InnerOuter: %ld, cache buffer count: %ld.",
    ...
    tilingData_.r1InnerStg0 = r1Inner;
    tilingData_.r1OuterStg0 = r1Outer;
    tilingData_.r1TailStg0 = r1Tail;
    tilingData_.r0InnerInnerStg0 = r0InnerInner;
    tilingData_.r0InnerOuterStg0 = r0InnerOuter;
    tilingData_.r0InnerTailStg0 = r0InnerTail;
    tilingData_.r0TailOuterStg0 = r0TailOuter;
    tilingData_.r0TailTailStg0 = r0TailTail;
    tilingData_.r0TailTailAlignedStg0 = r0TailTailAligned;
...
int64_t BatchNorm3DGradRARSplitCoreR0::GetCacheID(const int64_t idx)
{
    return __builtin_popcountll(idx ^ (idx + CONST_ONE)) - CONST_ONE;
}

int64_t BatchNorm3DGradRARSplitCoreR0::ComputeBinaryAddParams(int64_t fusedR, int64_t lastCoreFusedR)
{
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR0::DoOpTilingStage1()
{
    ...
    OP_LOGD(context_, "BatchNorm3DGrad R0 split core template Stage1, weightBaseLen: %ld, aFactor: %ld, aInner: %ld.",
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR0::DoOpTilingStage2()
{
    int64_t aInner = CONST_ONE;
    int64_t aInnerAligned = blockFp32Nums_;
    ...
    tilingData_.r1InnerStg2 = r1Inner;
    tilingData_.r1OuterStg2 = r1Outer;
    tilingData_.r1TailStg2 = r1Tail;
    tilingData_.r0InnerInnerStg2 = r0InnerInner;
    tilingData_.r0InnerOuterStg2 = r0InnerOuter;
    tilingData_.r0InnerTailStg2 = r0InnerTail;
    tilingData_.r0TailOuterStg2 = r0TailOuter;
    tilingData_.r0TailTailStg2 = r0TailTail;
    tilingData_.r0TailTailAlignedStg2 = r0TailTailAligned;
...
uint64_t BatchNorm3DGradRARSplitCoreR0::GetTilingKey() const { return BATCH_NORM3D_GRAD_RAR_SPLIT_CORE_R0_TILING_KEY; }

ge::graphStatus BatchNorm3DGradRARSplitCoreR0::GetWorkspaceSize()
{
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR0::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNorm3DGrad, BatchNorm3DGradRARSplitCoreR0, 2100);
