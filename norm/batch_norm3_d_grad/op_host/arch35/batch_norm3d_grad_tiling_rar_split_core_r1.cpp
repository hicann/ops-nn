...
/* !
 * \file batch_norm3d_grad_tiling_rar_split_core_r1.cpp
 * \brief
 */
...
namespace optiling {
static constexpr uint64_t BATCH_NORM3D_GRAD_RAR_SPLIT_CORE_R1_TILING_KEY = 1000;
...
class BatchNorm3DGradRARSplitCoreR1 : public BatchNorm3DGradTilingBase {
public:
    explicit BatchNorm3DGradRARSplitCoreR1(gert::TilingContext* context)
        : BatchNorm3DGradTilingBase(context, tilingData_.baseTilingData)
    {}
...
private:
    ...
    BatchNorm3DGradRARSplitCoreR1TilingData tilingData_;
...
bool BatchNorm3DGradRARSplitCoreR1::IsCapable()
{
    // 走RA模板
    if (r0Dim == CONST_ONE) {
        return false;
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR1::DoOpTiling()
{
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR1::DoOpTilingStage0()
{
    ...
    OP_LOGD(context_,
            "BatchNorm3DGrad R1 split core template Stage0, r0Outer: %ld, r1InnerOuter: %ld, cache buffer count: %ld.",
...
int64_t BatchNorm3DGradRARSplitCoreR1::GetCacheID(const int64_t idx)
{
    return __builtin_popcountll(idx ^ (idx + CONST_ONE)) - CONST_ONE;
}

int64_t BatchNorm3DGradRARSplitCoreR1::ComputeBinaryAddParams(int64_t fusedR, int64_t lastCoreFusedR)
{
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR1::DoOpTilingStage1()
{
    ...
    OP_LOGD(context_, "BatchNorm3DGrad R1 split core template Stage1, weightBaseLen: %ld, aFactor: %ld, aInner: %ld.",
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR1::DoOpTilingStage2()
{
    int64_t aInner = CONST_ONE;
    int64_t aInnerAligned = blockFp32Nums_;
    int64_t r1InnerInner = CONST_ONE;
...
uint64_t BatchNorm3DGradRARSplitCoreR1::GetTilingKey() const { return BATCH_NORM3D_GRAD_RAR_SPLIT_CORE_R1_TILING_KEY; }

ge::graphStatus BatchNorm3DGradRARSplitCoreR1::GetWorkspaceSize()
{
...
ge::graphStatus BatchNorm3DGradRARSplitCoreR1::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNorm3DGrad, BatchNorm3DGradRARSplitCoreR1, 2000);
