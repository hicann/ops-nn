...
/* !
 * \file batch_norm3d_grad_tiling_ra_split_r.cpp
 * \brief
 */

#include "register/op_impl_registry.h"
#include "op_host/tiling_templates_registry.h"
#include "batch_norm3d_grad_tiling_ra_split_r.h"
...
bool BatchNorm3DGradTilingRASplitR::IsCapable()
{
...
ge::graphStatus BatchNorm3DGradTilingRASplitR::DoOpTiling()
{
...
ge::graphStatus BatchNorm3DGradTilingRASplitR::Stage0Stage1UbTiling()
{
    // 一次计算一个tiling块
...
ge::graphStatus BatchNorm3DGradTilingRASplitR::Stage2UbTiling()
{
...
uint64_t BatchNorm3DGradTilingRASplitR::GetTilingKey() const { return BNG_RA_SPLIT_R_TILING_KEY; }

ge::graphStatus BatchNorm3DGradTilingRASplitR::GetWorkspaceSize()
{
...
void BatchNorm3DGradTilingRASplitR::PrintTilingData()
{
    OP_LOGI(context_->GetNodeName(),
            "BatchNorm3DGradTilingRASplitR tilingData: useCoreNum is %ld, rDim is %ld, aDim is %ld, "
...
ge::graphStatus BatchNorm3DGradTilingRASplitR::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNorm3DGrad, BatchNorm3DGradTilingRASplitR, BNG_RA_SPLIT_R_TK_BASE);
