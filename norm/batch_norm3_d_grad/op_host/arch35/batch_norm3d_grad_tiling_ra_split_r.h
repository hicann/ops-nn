...
/* !
 * \file batch_norm3d_grad_tiling_ra_split_r.h
 * \brief
 */

#ifndef __BATCH_NORM3D_GRAD_TILING_RA_SPLIT_H__
#define __BATCH_NORM3D_GRAD_TILING_RA_SPLIT_H__

#include "batch_norm3d_grad_tiling.h"

namespace optiling {

class BatchNorm3DGradTilingRASplitR : public BatchNorm3DGradTilingBase {
public:
    explicit BatchNorm3DGradTilingRASplitR(gert::TilingContext* context)
        : BatchNorm3DGradTilingBase(context, baseTilingData_)
    {}
...
private:
    ...
    BatchNorm3DGradBaseTilingData baseTilingData_;
    BatchNorm3DGradRASplitRTilingData tilingData_;
};

} // namespace optiling

#endif // __BATCH_NORM3D_GRAD_TILING_RA_SPLIT_H__
