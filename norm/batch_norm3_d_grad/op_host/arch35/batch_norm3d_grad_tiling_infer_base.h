...
/* !
 * \file batch_norm3d_grad_tiling_infer_base.h
 * \brief
 */

#ifndef BATCH_NORM3D_GRAD_TILING_INFER_BASE_H_
#define BATCH_NORM3D_GRAD_TILING_INFER_BASE_H_
...
class BatchNorm3DGradInferBase : public Ops::NN::Optiling::TilingBaseClass {
public:
    explicit BatchNorm3DGradInferBase(gert::TilingContext* context) : Ops::NN::Optiling::TilingBaseClass(context)
    {
        Reset();
    }
    ~BatchNorm3DGradInferBase() override = default;
