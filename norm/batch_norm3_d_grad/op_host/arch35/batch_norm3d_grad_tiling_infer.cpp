...
/* !
 * \file batch_norm3d_grad_tiling_infer.cpp
 * \brief
 */
...
class BatchNorm3DGradInferTiling : public BatchNorm3DGradInferBase {
public:
    explicit BatchNorm3DGradInferTiling(gert::TilingContext* context) : BatchNorm3DGradInferBase(context) {}
    ~BatchNorm3DGradInferTiling() override = default;
...
protected:
    bool IsCapable() override
    {
        ...
        OP_LOGD(context_, "BatchNorm3DGradInferTiling RAR template is capable, fused shape: (%ld, %ld, %ld)", r1Dim,
                aDim, r0Dim);
        return true;
    }
...
private:
    ...
    BatchNorm3DGradInferTilingData tilingData_;
};

ge::graphStatus BatchNorm3DGradInferTiling::DoOpTilingForStage0()
{
...
void BatchNorm3DGradInferTiling::DoRecomputeTilingSplitR1()
{
...
void BatchNorm3DGradInferTiling::DoRecomputeTilingSplitR0()
{
...
void BatchNorm3DGradInferTiling::DoBinaryAddTiling(BatchNorm3DGradBinaryAddTilingData& tilingData, int64_t quotient)
{
...
ge::graphStatus BatchNorm3DGradInferTiling::DoOpTilingForStage1()
{
...
ge::graphStatus BatchNorm3DGradInferTiling::DoOpTiling()
{
    DoOpTilingForStage0();
    DoOpTilingForStage1();
    return ge::GRAPH_SUCCESS;
...
uint64_t BatchNorm3DGradInferTiling::GetTilingKey() const { return TILINGKEY_INFER_BASE + subTilingKey; }

ge::graphStatus BatchNorm3DGradInferTiling::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNorm3DGrad, BatchNorm3DGradInferTiling, 91000);
} // namespace optiling
