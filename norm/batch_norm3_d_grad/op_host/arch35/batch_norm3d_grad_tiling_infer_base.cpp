...
/* !
 * \file batch_norm3d_grad_tiling_infer_base.cpp
 * \brief
 */
...
void BatchNorm3DGradInferBase::Reset()
{
    usedCoreNums_ = 0;
    blockSize_ = 0;
    vlFp32_ = 0;
...
void BatchNorm3DGradInferBase::CalcBasicInfo()
{
...
ge::graphStatus BatchNorm3DGradInferBase::GetPlatformInfo()
{
    auto compileInfo = static_cast<const BatchNorm3DGradCompileInfo*>(context_->GetCompileInfo());
...
const gert::Shape& BatchNorm3DGradInferBase::EnsureNotScalar(const gert::Shape& in_shape)
{
...
ge::graphStatus BatchNorm3DGradInferBase::CheckBigShapesFormatValid()
{
...
ge::graphStatus BatchNorm3DGradInferBase::CheckSmallShapesValid()
{
...
ge::graphStatus BatchNorm3DGradInferBase::CheckDtypeValid()
{
    bool invalid = true;
...
ge::graphStatus BatchNorm3DGradInferBase::GetShapeAttrsInfo()
{
    if (context_ == nullptr) {
        OP_LOGE_WITHOUT_REPORT("BatchNorm3DGradInferBase", "TilingContext is nullptr.");
        return ge::GRAPH_FAILED;
    }
...
ge::graphStatus BatchNorm3DGradInferBase::GetDyInfo()
{
...
ge::graphStatus BatchNorm3DGradInferBase::DoLibApiTiling() { return ge::GRAPH_SUCCESS; }

ge::graphStatus BatchNorm3DGradInferBase::GetWorkspaceSize()
{
    // 计算workspace大小
