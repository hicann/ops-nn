...
static ge::graphStatus BatchNorm3DGradInferShape(gert::InferShapeContext* context)
{
    if (context == nullptr) {
        return GRAPH_FAILED;
    }
...
static ge::graphStatus BatchNorm3DGradInferDataType(gert::InferDataTypeContext* context)
{
    if (context == nullptr) {
        return GRAPH_FAILED;
    }
...
IMPL_OP_INFERSHAPE(BatchNorm3DGrad).InferShape(BatchNorm3DGradInferShape).InferDataType(BatchNorm3DGradInferDataType);
} // namespace ops
