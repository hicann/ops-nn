...
protected:
    static void SetUpTestCase() { std::cout << "BatchNorm3DGradTest Proto Test SetUp" << std::endl; }
...
TEST_F(BatchNorm3DGradTestInferShapeTest, BatchNorm3DGrad_InferDtype_case_0)
{
    ...
    auto data_type_func = gert::OpImplRegistry::GetInstance().GetOpImpl("BatchNorm3DGrad")->infer_datatype;
