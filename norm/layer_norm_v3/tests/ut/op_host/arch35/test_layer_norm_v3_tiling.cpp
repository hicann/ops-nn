...
/*!
 * \file test_layer_norm_v3_tiling.cpp
 * \brief
 */
...
#include "../../../../op_host/arch35/layer_norm_v3_tiling_arch35.h"
using namespace ut_util;
using namespace std;
using namespace ge;

class LayerNormV3TilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "LayerNormV3Tiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "LayerNormV3Tiling TearDown" << std::endl; }
};
...
TEST_F(LayerNormV3TilingTest, layer_norm_v3_tiling_regbase_two_pass)
{
    ...
    platform_info.Init();
    // compile info
    optiling::LayerNormV3OpInfo compile_info;

    std::string op_type("LayerNormV3");
...
TEST_F(LayerNormV3TilingTest, layer_norm_v3_tiling_regbase_norm_not_equal_params)
{
    ...
    gert::StorageShape beta_shape = {{8, 64}, {8, 64}};
    gert::StorageShape y_shape = {{4, 8, 64}, {4, 8, 64}};
    gert::StorageShape mean_shape = {{4, 8, 1}, {4, 8, 1}};
    gert::StorageShape rstd_shape = {{4, 8, 1}, {4, 8, 1}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeOutputTd(1, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(2, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeAttrs({{"begin_norm_axis", Ops::NN::AnyValue::CreateFrom<int64_t>(2)},
                                  {"begin_params_axis", Ops::NN::AnyValue::CreateFrom<int64_t>(1)},
                                  {"epsilon", Ops::NN::AnyValue::CreateFrom<float>(1e-05)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
...
TEST_F(LayerNormV3TilingTest, layer_norm_v3_tiling_regbase_welford_multi_reduce)
{
    ...
    gert::StorageShape beta_shape = {{16384}, {16384}};
    gert::StorageShape y_shape = {{2, 2, 16384}, {2, 2, 16384}};
    gert::StorageShape mean_shape = {{2, 1, 1}, {2, 1, 1}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeOutputTd(2, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeAttrs({{"begin_norm_axis", Ops::NN::AnyValue::CreateFrom<int64_t>(1)},
                                  {"begin_params_axis", Ops::NN::AnyValue::CreateFrom<int64_t>(2)},
                                  {"epsilon", Ops::NN::AnyValue::CreateFrom<float>(1e-05)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
                      .Build();
...
TEST_F(LayerNormV3TilingTest, layer_norm_v3_tiling_regbase_welford_multi_params)
{
    ...
    gert::StorageShape beta_shape = {{2, 32768}, {2, 32768}};
    gert::StorageShape y_shape = {{2, 2, 32768}, {2, 2, 32768}};
    gert::StorageShape mean_shape = {{2, 2, 1}, {2, 2, 1}};
    gert::StorageShape rstd_shape = {{2, 2, 1}, {2, 2, 1}};
