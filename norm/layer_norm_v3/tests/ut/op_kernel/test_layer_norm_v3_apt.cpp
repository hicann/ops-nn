...
/*!
 * \file test_layer_norm_v3_apt.cpp
 * \brief
 */
...
#include "layer_norm_v3_tiling_def.h"
                    ...
                    const std::string& dtype, int64_t tilingKey, uint32_t blockNum, uint8_t* tiling)
{
    ...
    ICPU_RUN_KF(layer_norm_v3, realBlockNum, x, gamma, beta, y, mean, rstd, workspace, tiling);
...
TEST_F(layer_norm_v3_test, test_two_pass_float32)
{
...
TEST_F(layer_norm_v3_test, test_welford_float32)
{
...
TEST_F(layer_norm_v3_test, test_two_pass_perf_float32)
{
    std::vector<int64_t> xShape = {32, 64};
    std::vector<int64_t> gammaShape = {64};
    std::string dtype = "float";
...
TEST_F(layer_norm_v3_test, test_no_reduce_float32)
{
    std::vector<int64_t> xShape = {32, 64};
    std::vector<int64_t> gammaShape = {64};
    std::string dtype = "float";
...
TEST_F(layer_norm_v3_test, test_two_pass_half)
{
    std::vector<int64_t> xShape = {32, 64};
    std::vector<int64_t> gammaShape = {64};
