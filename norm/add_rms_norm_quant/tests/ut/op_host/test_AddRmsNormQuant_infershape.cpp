...
protected:
    static void SetUpTestCase() { std::cout << "AddRmsNormQuant Proto Test SetUp" << std::endl; }
...
TEST_F(AddRmsNormQuant, AddRmsNormQuant_InferDtype_case_0)
{
    ...
    if (data_type_func != nullptr) {
        ...
        auto context_holder = gert::InferDataTypeContextFaker()
                                  ...
                                  .InputDataTypes({&input_ref, &input_ref, &input_ref, &scale_ref, &scale_ref,
                                                   &zero_point_ref, &zero_point_ref})
