        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t i = 0; i < outerLoopTimes; ++i) {
                ...
                for (uint16_t j = 0; j < innerLoopTimes; ++j) {
                    ...
                    AscendC::Reg::Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(dxReg, rstdReg, dyReg, pMask);
                    AscendC::Reg::Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(dxReg, dxReg, gammaReg, pMask);
