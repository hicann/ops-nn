...
__aicore__ inline void LoadOneTensorBrcVL(const __ubuf__ void* input, Reg::RegTensor<float>& dst, uint32_t offset)
{
    LoadAlign<float, Reg::LoadDist::DIST_BLK>(dst, (__ubuf__ float*)(input) + offset);
}
