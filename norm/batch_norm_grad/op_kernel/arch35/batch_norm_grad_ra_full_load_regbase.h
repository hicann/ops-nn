            ...
            __VEC_SCOPE__
            {
                ...
                for (uint16_t i = 0; i < outerLoop; ++i) {
                    ...
                    for (uint16_t j = 0; j < vfFoldLoopStep1; ++j) {
                        ...
                        Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(x1Reg, dy1Reg, x1Reg, pMask);
                        ...
                        Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(xFold1Reg, dyFold1Reg, xFold1Reg, pMask);
                        ...
                        Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(x2Reg, dy2Reg, x2Reg, pMask);
                        ...
                        Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(xFold2Reg, dyFold2Reg, xFold2Reg, pMask);
