...
/*!
 * \file gemma_rms_norm_apt.cpp
 * \brief gemma rmsnorm kernel file
 */
#include "../rms_norm/arch35/rms_norm_regbase_perf.h"
#include "../rms_norm/arch35/rms_norm_regbase_split_d.h"
