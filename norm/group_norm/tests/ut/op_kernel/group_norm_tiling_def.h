...
/*!
 * \file group_norm_tiling_def.h
 * \brief
 */

#ifndef __GROUP_NORM_TILING_DEF_H__
#define __GROUP_NORM_TILING_DEF_H__
...
#define GET_TILING_DATA(tiling_data, tiling_arg) \
    GET_TILING_DATA_WITH_STRUCT(GroupNormTilingData, tiling_data, tiling_arg)
