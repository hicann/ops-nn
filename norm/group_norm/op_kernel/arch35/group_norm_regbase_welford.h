...
/*!
 * \file group_norm_regbase_welford.h
 * \brief
 */
#ifndef GROUP_NORM_REGBASE_WELFORD_H_
#define GROUP_NORM_REGBASE_WELFORD_H_

#include "group_norm_regbase_base.h"
namespace GroupNorm {
using namespace AscendC;
template <typename T1, typename T2, int32_t BUFFER_NUM = 2>
class GroupNormWelford {
public:
    __aicore__ inline GroupNormWelford(){};
