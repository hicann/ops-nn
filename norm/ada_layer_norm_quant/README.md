...
<table style="undefined;table-layout: fixed; width: 1005px"><colgroup>
  ...
  <tbody>
    <tr>
      <td>x</td>
      <td>输入</td>
      <td>表示输入待处理的数据。对应公式中的`x`。shape为[B…, S, H]，其中B支持0到6个维度。</td>
    ...
    <tr>
      <td>epsilon</td>
      <td>可选属性</td>
      <td><ul><li>表示添加到分母中的值，以确保数值稳定，用于防止除0错误，对应公式中的`epsilon`。</li><li>建议传较小的正数，默认值为1e-5。</li></ul></td>
      <td>FLOAT32</td>
      <td>-</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>quant_scale</td>
      <td>输出</td>
      <td>表示量化系数。对应公式中的`quant_scale`。shape为[B…, S]，其中B支持0到6个维度，维度数量和大小与`x`中的B保持一致，S与`x`中S维一致。</td>
      <td>FLOAT32</td>
      <td>ND</td>
    </tr>
  </tbody></table>
