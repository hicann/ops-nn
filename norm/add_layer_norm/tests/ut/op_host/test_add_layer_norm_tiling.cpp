...
protected:
    static void SetUpTestCase() { std::cout << "AddLayerNormTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "AddLayerNormTiling TearDown" << std::endl; }
};
...
TEST_F(AddLayerNormTiling, add_layer_norm_tiling_regbase_fullload_003)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeOutputTd(2, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeOutputTd(3, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                      .NodeAttrs({{"epsilon", Ops::NN::AnyValue::CreateFrom<float>(0.01f)},
                                  {"additional_output", Ops::NN::AnyValue::CreateFrom<bool>(false)}})
                      .TilingData(param.get())
                      .Workspace(ws_size)
                      .Build();
