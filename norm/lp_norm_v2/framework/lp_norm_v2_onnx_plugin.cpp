...
REGISTER_CUSTOM_OP("PartitionedCall")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::1::LpNormalization"), ge::AscendString("ai.onnx::8::LpNormalization"),
                   ge::AscendString("ai.onnx::9::LpNormalization"), ge::AscendString("ai.onnx::10::LpNormalization"),
                   ge::AscendString("ai.onnx::11::LpNormalization"), ge::AscendString("ai.onnx::12::LpNormalization"),
                   ge::AscendString("ai.onnx::13::LpNormalization"), ge::AscendString("ai.onnx::14::LpNormalization"),
                   ge::AscendString("ai.onnx::15::LpNormalization"), ge::AscendString("ai.onnx::16::LpNormalization"),
                   ge::AscendString("ai.onnx::17::LpNormalization"), ge::AscendString("ai.onnx::18::LpNormalization")})
