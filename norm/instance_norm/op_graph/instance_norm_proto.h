...
* @li x: Empty tensors are supported, but only allows the reduction axis to have shape 0, the dim N and dim C must not
be empty. Must be one of the following types: bfloat16, float16, float32. 4D/5D with format NCHW/NHWC/NCDHW/NDHWC. 2D~8D
with format ND, the second dim is fixed as the dim C.
