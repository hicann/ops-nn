...
TEST_F(kv_rms_norm_rope_cache_test, test_case_0001)
{
    ...
    size_t kCacheSize = 64 * 288 * 1 * 576 * sizeof(half);
    size_t ckvCacheSize = 64 * 288 * 1 * 576 * sizeof(half);
    ...
    tilingDatafromBin->cacheLength = 288;
    tilingDatafromBin->epsilon = 1e-5;
    tilingDatafromBin->reciprocal = 1.0f / 512.0;
