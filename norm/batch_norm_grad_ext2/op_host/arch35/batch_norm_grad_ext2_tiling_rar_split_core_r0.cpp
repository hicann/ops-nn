...
/* !
 * \file batch_norm_grad_ext2_tiling_rar_split_core_r0.cpp
 * \brief
 */
...
namespace optiling {
static constexpr uint64_t BATCH_NORM_GRAD_EXT2_RAR_SPLIT_CORE_R0_TILING_KEY = 1100;
...
class BatchNormGradExt2RARSplitCoreR0 : public BatchNormGradExt2TilingBase {
public:
    explicit BatchNormGradExt2RARSplitCoreR0(gert::TilingContext* context)
...
private:
    ...
    BatchNormGradExt2RARSplitCoreR0TilingData tilingData_;
...
bool BatchNormGradExt2RARSplitCoreR0::IsCapable()
{
...
ge::graphStatus BatchNormGradExt2RARSplitCoreR0::DoOpTiling()
{
...
ge::graphStatus BatchNormGradExt2RARSplitCoreR0::DoOpTilingStage0()
{
    ...
    OP_LOGD(
        context_,
        "BatchNormGradExt2 R0 split core template Stage0, r1Outer: %ld, r0InnerOuter: %ld, cache buffer count: %ld.",
...
int64_t BatchNormGradExt2RARSplitCoreR0::GetCacheID(const int64_t idx)
{
    return __builtin_popcountll(idx ^ (idx + CONST_ONE)) - CONST_ONE;
}

int64_t BatchNormGradExt2RARSplitCoreR0::ComputeBinaryAddParams(int64_t fusedR, int64_t lastCoreFusedR)
{
...
ge::graphStatus BatchNormGradExt2RARSplitCoreR0::DoOpTilingStage1()
{
    ...
    OP_LOGD(context_, "BatchNormGradExt2 R0 split core template Stage1, weightBaseLen: %ld, aFactor: %ld, aInner: %ld.",
...
ge::graphStatus BatchNormGradExt2RARSplitCoreR0::DoOpTilingStage2()
{
    int64_t aInner = CONST_ONE;
    int64_t aInnerAligned = blockFp32Nums_;
...
uint64_t BatchNormGradExt2RARSplitCoreR0::GetTilingKey() const
{
    return BATCH_NORM_GRAD_EXT2_RAR_SPLIT_CORE_R0_TILING_KEY;
}

ge::graphStatus BatchNormGradExt2RARSplitCoreR0::GetWorkspaceSize()
{
...
ge::graphStatus BatchNormGradExt2RARSplitCoreR0::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNormGradExt2, BatchNormGradExt2RARSplitCoreR0, 2100);
