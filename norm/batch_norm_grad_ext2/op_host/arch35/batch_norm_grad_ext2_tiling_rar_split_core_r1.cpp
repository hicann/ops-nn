...
/* !
 * \file batch_norm_grad_ext2_tiling_rar_split_core_r1.cpp
 * \brief
 */
...
namespace optiling {
static constexpr uint64_t BATCH_NORM_GRAD_EXT2_RAR_SPLIT_CORE_R1_TILING_KEY = 1000;
...
class BatchNormGradExt2RARSplitCoreR1 : public BatchNormGradExt2TilingBase {
public:
    explicit BatchNormGradExt2RARSplitCoreR1(gert::TilingContext* context)
        : BatchNormGradExt2TilingBase(context, tilingData_.baseTilingData)
    {}
...
private:
    ...
    BatchNormGradExt2RARSplitCoreR1TilingData tilingData_;
...
bool BatchNormGradExt2RARSplitCoreR1::IsCapable()
{
    // 走RA模板
    if (r0Dim == CONST_ONE) {
        return false;
    ...
    if (aDim > static_cast<int64_t>(coreNum) / A_SPLIT_CORE_TEMPLATE_ENABLE_FACTOR) {
        OP_LOGD(context_, "RAR split core template not support shape: (%ld, %ld, %ld), aDim > %ld", r1Dim, aDim, r0Dim,
                static_cast<int64_t>(coreNum) / A_SPLIT_CORE_TEMPLATE_ENABLE_FACTOR);
        return false;
    }

    // r1 开核后大于一半
    if (r1Dim < static_cast<int64_t>(coreNum)) {
        OP_LOGD(context_, "RAR split core template not support shape: (%ld, %ld, %ld), r1Dim < %ld", r1Dim, aDim, r0Dim,
    ...
    if (r1Dim * r0Dim * R1_SPLIT_CORE_TEMPLATE_ENABLE_FACTOR < static_cast<int64_t>(ubSize)) {
        OP_LOGD(context_, "RAR split core template not support shape: (%ld, %ld, %ld), r0Dim * r1Dim < %ld", r1Dim,
                aDim, r0Dim, ubSize / R1_SPLIT_CORE_TEMPLATE_ENABLE_FACTOR);
        return false;
    }
...
ge::graphStatus BatchNormGradExt2RARSplitCoreR1::DoOpTiling()
{
    ...
    tilingData_.r1Dim = r1Dim;
    tilingData_.aDim = aDim;
    tilingData_.aDimAligned = aDimAligned_;
    tilingData_.r0Dim = r0Dim;
    tilingData_.usedCoreNums = usedCoreNums_;
    tilingData_.r1Inner = r1Inner_;
    tilingData_.r1Tail = r1Tail_;

    return ge::GRAPH_SUCCESS;
}

ge::graphStatus BatchNormGradExt2RARSplitCoreR1::DoOpTilingStage0()
{
    ...
    OP_CHECK_IF(
        ...
        OP_LOGE_FOR_INVALID_VALUE_WITH_REASON(context_->GetNodeName(), "factorMax", std::to_string(factorMax).c_str(),
                                              "RAR R1 split core template is not capable in stage0"),
    ...
    OP_LOGD(
        context_,
        "BatchNormGradExt2 R1 split core template Stage0, r0Outer: %ld, r1InnerOuter: %ld, cache buffer count: %ld.",
    ...
    tilingData_.r0InnerStg0 = r0Inner;
    tilingData_.r0OuterStg0 = r0Outer;
    tilingData_.r0TailStg0 = r0Tail;
    tilingData_.r0TailAlignedStg0 = r0TailAligned;
    tilingData_.r1InnerInnerStg0 = r1InnerInner;
    tilingData_.r1InnerOuterStg0 = r1InnerOuter;
    tilingData_.r1InnerTailStg0 = r1InnerTail;
    tilingData_.r1TailOuterStg0 = r1TailOuter;
    tilingData_.r1TailTailStg0 = r1TailTail;
    tilingData_.aInnerStg0 = aInner;
    tilingData_.aInnerAlignedStg0 = aInnerAligned;
    tilingData_.aOuterStg0 = aOuter;
    tilingData_.aTailStg0 = aTail;

    return ge::GRAPH_SUCCESS;
}

int64_t BatchNormGradExt2RARSplitCoreR1::GetCacheID(const int64_t idx)
{
    return __builtin_popcountll(idx ^ (idx + CONST_ONE)) - CONST_ONE;
}

int64_t BatchNormGradExt2RARSplitCoreR1::ComputeBinaryAddParams(int64_t fusedR, int64_t lastCoreFusedR)
{
    ...
    tilingData_.binAddBasicBlockLoop = binAddBasicBlockLoop;
    tilingData_.binAddMainFoldCount = mainFoldCount;
    tilingData_.binAddCacheBufferCount = binAddCacheBufferCount;
    tilingData_.binAddResultCacheID = binAddResultCacheID;

    tilingData_.lastCoreBinAddBasicBlockLoop = lastCoreBinAddBasicBlockLoop;
    tilingData_.lastCoreBinAddMainFoldCount = lastCoreMainFoldCount;
    tilingData_.lastCoreBinAddResultCacheID = lastCoreBinAddResultCacheID;

    return binAddCacheBufferCount;
}

ge::graphStatus BatchNormGradExt2RARSplitCoreR1::DoOpTilingStage1()
{
    ...
    OP_CHECK_IF(
        factorMax <= 0,
        OP_LOGE_FOR_INVALID_VALUE_WITH_REASON(context_->GetNodeName(), "factorMax", std::to_string(factorMax).c_str(),
                                              "RAR R1 split core template is not capable in stage1"),
        return ge::GRAPH_PARAM_INVALID);
    ...
    OP_LOGD(context_, "BatchNormGradExt2 R1 split core template Stage1, weightBaseLen: %ld, aFactor: %ld, aInner: %ld.",
            weightBaseLen, aFactor, aInner);

    tilingData_.aInnerStg1 = aInner;
    tilingData_.aOuterStg1 = aOuter;
    tilingData_.aTailStg1 = aTail;

    return ge::GRAPH_SUCCESS;
}

ge::graphStatus BatchNormGradExt2RARSplitCoreR1::DoOpTilingStage2()
{
    int64_t aInner = CONST_ONE;
    int64_t aInnerAligned = blockFp32Nums_;
    int64_t r1InnerInner = CONST_ONE;
    ...
    OP_CHECK_IF(
        factorMax <= 0,
        OP_LOGE_FOR_INVALID_VALUE_WITH_REASON(context_->GetNodeName(), "factorMax", std::to_string(factorMax).c_str(),
                                              "RAR R1 split core template is not capable in stage2"),
        return ge::GRAPH_PARAM_INVALID);
    ...
    tilingData_.r0InnerStg2 = r0Inner;
    tilingData_.r0OuterStg2 = r0Outer;
    tilingData_.r0TailStg2 = r0Tail;
    tilingData_.r0TailAlignedStg2 = r0TailAligned;
    tilingData_.r1InnerInnerStg2 = r1InnerInner;
    tilingData_.r1InnerOuterStg2 = r1InnerOuter;
    tilingData_.r1InnerTailStg2 = r1InnerTail;
    tilingData_.r1TailOuterStg2 = r1TailOuter;
    tilingData_.r1TailTailStg2 = r1TailTail;
    tilingData_.aInnerStg2 = aInner;
    tilingData_.aInnerAlignedStg2 = aInnerAligned;
    tilingData_.aOuterStg2 = aOuter;
    tilingData_.aTailStg2 = aTail;

    return ge::GRAPH_SUCCESS;
}

uint64_t BatchNormGradExt2RARSplitCoreR1::GetTilingKey() const
{
    return BATCH_NORM_GRAD_EXT2_RAR_SPLIT_CORE_R1_TILING_KEY;
}

ge::graphStatus BatchNormGradExt2RARSplitCoreR1::GetWorkspaceSize()
{
...
ge::graphStatus BatchNormGradExt2RARSplitCoreR1::PostTiling()
{
...
REGISTER_OPS_TILING_TEMPLATE(BatchNormGradExt2, BatchNormGradExt2RARSplitCoreR1, 2000);
