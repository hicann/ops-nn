...
/* !
 * \file batch_norm_grad_ext2_tiling.h
 * \brief
 */

#ifndef AIR_CXX_RUNTIME_V2_OP_IMPL_BATCH_NORM_GRAD_EXT2_H_
#define AIR_CXX_RUNTIME_V2_OP_IMPL_BATCH_NORM_GRAD_EXT2_H_
...
static constexpr const char* outputParamNames[] = {"x_backprop", "scale_backprop", "offset_backprop", "reserve_space_3",
                                                   "reserve_space_4"};
...
struct BatchNormGradExt2CompileInfo {
    int32_t coreNum;
    int64_t ubSize;
    int64_t blockSize;
    int64_t vlFp32;
...
class BatchNormGradExt2TilingBase : public Ops::NN::Optiling::TilingBaseClass {
public:
    explicit BatchNormGradExt2TilingBase(gert::TilingContext* context, BatchNormGradExt2BaseTilingData& baseTiling)
...
protected:
    ...
    BatchNormGradExt2BaseTilingData& baseTilingData;
};

class BatchNormGradExt2RARFullLoadTilingBase : public BatchNormGradExt2TilingBase {
public:
    explicit BatchNormGradExt2RARFullLoadTilingBase(gert::TilingContext* context)
        : BatchNormGradExt2TilingBase(context, tilingData.baseTilingData)
    {}
...
private:
    ...
    BatchNormGradExt2RARFullLoadTilingData tilingData;
};

class BatchNormGradExt2RARRecomputeTilingBase : public BatchNormGradExt2TilingBase {
public:
    explicit BatchNormGradExt2RARRecomputeTilingBase(gert::TilingContext* context)
        : BatchNormGradExt2TilingBase(context, tilingData.baseTilingData)
    {}
...
private:
    ...
    BatchNormGradExt2RARRecomputeTilingData tilingData;
};

class BatchNormGradExt2RAFullLoadTilingBase : public BatchNormGradExt2TilingBase {
public:
    explicit BatchNormGradExt2RAFullLoadTilingBase(gert::TilingContext* context)
        : BatchNormGradExt2TilingBase(context, tilingData.baseTilingData)
    {}
...
private:
    ...
    int64_t binaryAddUbNeed{0};
    int64_t binaryAddQuotient{0};
    BatchNormGradExt2RAFullLoadTilingData tilingData;
};

class BatchNormGradExt2RARecomputeTilingBase : public BatchNormGradExt2TilingBase {
public:
    explicit BatchNormGradExt2RARecomputeTilingBase(gert::TilingContext* context)
        : BatchNormGradExt2TilingBase(context, tilingData.baseTilingData)
    {}
...
private:
    ...
    int64_t binaryAddUbNeed{0};
    int64_t binaryAddQuotient{0};
    BatchNormGradExt2RARecomputeTilingData tilingData;
};

} // namespace optiling

#endif // AIR_CXX_RUNTIME_V2_OP_IMPL_BATCH_NORM_GRAD_EXT2_H_
