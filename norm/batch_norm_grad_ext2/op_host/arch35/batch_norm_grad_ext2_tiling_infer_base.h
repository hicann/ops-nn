...
/* !
 * \file batch_norm_grad_ext2_tiling_infer_base.h
 * \brief
 */

#ifndef BATCH_NORM_GRAD_EXT2_TILING_INFER_BASE_H_
#define BATCH_NORM_GRAD_EXT2_TILING_INFER_BASE_H_
...
class BatchNormGradExt2InferBase : public Ops::NN::Optiling::TilingBaseClass {
public:
    explicit BatchNormGradExt2InferBase(gert::TilingContext* context) : Ops::NN::Optiling::TilingBaseClass(context)
    {
        Reset();
    }
    ~BatchNormGradExt2InferBase() override = default;
...
protected:
    const char* opName_ = "BatchNormGradExt2InferBase";
