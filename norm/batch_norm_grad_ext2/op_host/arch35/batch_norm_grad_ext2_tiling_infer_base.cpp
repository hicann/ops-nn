...
/* !
 * \file batch_norm_grad_ext2_tiling_infer_base.cpp
 * \brief
 */
...
void BatchNormGradExt2InferBase::CalcBasicInfo()
{
...
ge::graphStatus BatchNormGradExt2InferBase::GetPlatformInfo()
{
    auto compileInfo = static_cast<const BatchNormGradExt2CompileInfo*>(context_->GetCompileInfo());
...
const gert::Shape& BatchNormGradExt2InferBase::EnsureNotScalar(const gert::Shape& in_shape)
{
...
ge::graphStatus BatchNormGradExt2InferBase::CheckBigShapesFormatValid()
{
...
ge::graphStatus BatchNormGradExt2InferBase::CheckSmallShapesValid()
{
...
ge::graphStatus BatchNormGradExt2InferBase::CheckDtypeValid()
{
    bool invalid = true;
...
ge::graphStatus BatchNormGradExt2InferBase::GetShapeAttrsInfo()
{
    if (context_ == nullptr) {
        OP_LOGE_WITHOUT_REPORT("BatchNormGradExt2InferBase", "TilingContext is nullptr.");
        return ge::GRAPH_FAILED;
    }
    ...
    OP_CHECK_IF(CheckBigShapesFormatValid() != ge::GRAPH_SUCCESS,
                OP_LOGE_WITHOUT_REPORT(context_, "Check shape or format error."), return ge::GRAPH_FAILED);

    auto ret = GetDyInfo();
    OP_CHECK_IF(ret != ge::GRAPH_SUCCESS, OP_LOGE_WITHOUT_REPORT(context_, "GetShapeAttrsInfo failed."), return ret);
    ...
    OP_CHECK_IF(CheckDtypeValid() != ge::GRAPH_SUCCESS, OP_LOGE_WITHOUT_REPORT(context_, "Input dtypes are invalid."),
                return ge::GRAPH_FAILED);
    return ge::GRAPH_SUCCESS;
}

ge::graphStatus BatchNormGradExt2InferBase::GetDyInfo()
{
...
ge::graphStatus BatchNormGradExt2InferBase::DoLibApiTiling() { return ge::GRAPH_SUCCESS; }

ge::graphStatus BatchNormGradExt2InferBase::GetWorkspaceSize()
{
    // 计算workspace大小
