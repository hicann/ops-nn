...
/* !
 * \file batch_norm_grad_ext2_tiling_ra_split_r.h
 * \brief
 */

#ifndef __BATCH_NORM_GRAD_EXT2_TILING_RA_SPLIT_H__
#define __BATCH_NORM_GRAD_EXT2_TILING_RA_SPLIT_H__

#include "batch_norm_grad_ext2_tiling.h"

namespace optiling {

class BatchNormGradExt2TilingRASplitR : public BatchNormGradExt2TilingBase {
public:
    explicit BatchNormGradExt2TilingRASplitR(gert::TilingContext* context)
        : BatchNormGradExt2TilingBase(context, baseTilingData_)
    {}
...
private:
    ...
    BatchNormGradExt2BaseTilingData baseTilingData_;
    BatchNormGradExt2RASplitRTilingData tilingData_;
};

} // namespace optiling

#endif // __BATCH_NORM_GRAD_EXT2_TILING_RA_SPLIT_H__
