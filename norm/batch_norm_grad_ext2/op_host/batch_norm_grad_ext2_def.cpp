...
namespace ops {
class BatchNormGradExt2 : public OpDef {
public:
    explicit BatchNormGradExt2(const char* name) : OpDef(name)
    {
        // input
        this->Input("y_backprop")
            ...
            .Format({ge::FORMAT_NCDHW, ge::FORMAT_NCDHW, ge::FORMAT_NCDHW, ge::FORMAT_NCHW, ge::FORMAT_NCHW,
                     ge::FORMAT_NCHW, ge::FORMAT_NHWC, ge::FORMAT_NHWC, ge::FORMAT_NHWC, ge::FORMAT_NDHWC,
        ...
        regbaseCfg.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "batch_norm_grad_ext2");
        this->AICore().AddConfig("ascend950", regbaseCfg);
    }
};

OP_ADD(BatchNormGradExt2);
} // namespace ops
