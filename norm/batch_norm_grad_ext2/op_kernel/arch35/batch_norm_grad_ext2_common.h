...
/* !
 * \file batch_norm_grad_ext2_common.h
 * \brief
 */
#ifndef __BATCH_NORM_GRAD_EXT2_COMMON_H__
#define __BATCH_NORM_GRAD_EXT2_COMMON_H__

#include "kernel_operator.h"
#include "batch_norm_grad_ext2_tiling_data.h"
