...
/*!
 * \file batch_norm_grad_ext2_tiling_data.h
 * \brief batch_norm_grad_ext2 plain tiling-data structs, shared by host tiling and kernel.
 */

#ifndef NORM_BATCH_NORM_GRAD_EXT2_TILING_DATA_H
#define NORM_BATCH_NORM_GRAD_EXT2_TILING_DATA_H

#include <cstdint>

struct BatchNormGradExt2BaseTilingData {
    int64_t r1Dim = 0;
    int64_t aDim = 0;
    int64_t r0Dim = 0;
    int64_t rAlign = 0;
...
struct BatchNormGradExt2TilingData {
    int64_t dummy = 0;
};

struct BatchNormGradExt2BinaryAddTilingData {
    int64_t binaryAddQuotient = 0;
    int64_t binaryAddk = 0;
    int64_t binaryAddLastNum = 0;
};

struct BatchNormGradExt2RARFullLoadTilingData {
    BatchNormGradExt2BaseTilingData baseTilingData;
    BatchNormGradExt2BinaryAddTilingData binaryAddTilingData;
...
struct BatchNormGradExt2RARRecomputeTilingData {
    BatchNormGradExt2BaseTilingData baseTilingData;
    BatchNormGradExt2BinaryAddTilingData generalBinAddTilingData;
    BatchNormGradExt2BinaryAddTilingData tailBinAddTilingData;
...
struct BatchNormGradExt2RAFullLoadTilingData {
    BatchNormGradExt2BaseTilingData baseTilingData;
    BatchNormGradExt2BinaryAddTilingData binaryAddTilingData;
    int64_t numBlocks = 0;
...
struct BatchNormGradExt2RARecomputeTilingData {
    BatchNormGradExt2BaseTilingData baseTilingData;
    BatchNormGradExt2BinaryAddTilingData binaryAddTilingData;
    int64_t numBlocks = 0;
    int64_t mainBlockFactor = 0;
...
struct BatchNormGradExt2RASplitRTilingData {
    int64_t rDim = 0;
    int64_t aDim = 0;
...
struct BatchNormGradExt2InferChannelLastDxTilingData {
...
struct BatchNormGradExt2InferChannelLastTilingData {
    BatchNormGradExt2InferChannelLastDxTilingData dxTilingData;
...
struct BatchNormGradExt2InferDxTilingData {
    int64_t totalTiles = 0;
    int64_t tilesPerCore = 0;
    int64_t usedCoreNums = 0;
    int64_t r1Dim = 0;
...
struct BatchNormGradExt2InferTilingData {
    BatchNormGradExt2InferDxTilingData baseTilingData;
    BatchNormGradExt2BinaryAddTilingData generalBinAddTilingData;
    BatchNormGradExt2BinaryAddTilingData tailBinAddTilingData;
    int64_t blockNum = 0;
    int64_t tailBlockNum = 0;
...
struct BatchNormGradExt2FullLoadTilingData {
    int64_t b1Dim = 0;
    int64_t aDim = 0;
    int64_t b0Dim = 0;
    int64_t bAlign = 0;
...
struct BatchNormGradExt2RARSplitCoreR1TilingData {
    BatchNormGradExt2BaseTilingData baseTilingData;
    int64_t r1Dim = 0;
    int64_t aDim = 0;
...
struct BatchNormGradExt2RARSplitCoreR0TilingData {
    BatchNormGradExt2BaseTilingData baseTilingData;
    int64_t r1Dim = 0;
    int64_t aDim = 0;
    int64_t aDimAligned = 0;
...
#endif // NORM_BATCH_NORM_GRAD_EXT2_TILING_DATA_H
