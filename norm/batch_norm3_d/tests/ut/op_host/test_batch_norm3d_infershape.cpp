...
class BatchNorm3DInfershapeTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "BatchNorm3DTest SetUp" << std::endl; }
...
TEST_F(BatchNorm3DInfershapeTest, batch_norm3d_infershape_test_0)
{
    ...
    gert::Shape input_scale_shape = {3};
...
TEST_F(BatchNorm3DInfershapeTest, batch_norm3d_inferdtype_test_0)
{
    ...
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("BatchNorm3D"), nullptr);
    auto inferDtypeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("BatchNorm3D")->infer_datatype;
