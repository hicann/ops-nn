...
/*!
 * \file batch_norm3d_welford.h
 * \brief
 */
#ifndef NORM_BATCH_NORM3D_WELFORD_H
#define NORM_BATCH_NORM3D_WELFORD_H
...
public:
    __aicore__ inline BatchNorm3DWelford(){};
    ...
    __aicore__ inline BatchNorm3DWelford(const BatchNorm3DWelfordRegbaseTilingData* tilingData, TPipe* pipeIn)
    {
        pipe = pipeIn;
...
#endif // NORM_BATCH_NORM3D_WELFORD_H
