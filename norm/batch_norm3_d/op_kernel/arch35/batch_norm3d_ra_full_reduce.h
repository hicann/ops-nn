...
/*!
 * \file batch_norm3d_ra_full_reduce.h
 * \brief
 */
#ifndef NORM_BATCH_NORM3D_RA_FULL_REDUCE_H
#define NORM_BATCH_NORM3D_RA_FULL_REDUCE_H
...
class BatchNorm3DRAFullReduce {
public:
    __aicore__ inline BatchNorm3DRAFullReduce(const BatchNorm3DRAFullReduceTilingData* tilingData, TPipe* pipeIn)
    {
        this->pipe = pipeIn;
...
#endif // NORM_BATCH_NORM3D_RA_FULL_REDUCE_H
