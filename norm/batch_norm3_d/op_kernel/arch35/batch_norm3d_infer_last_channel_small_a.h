...
/* !
 * \file batch_norm3d_infer_last_channel_small_a.h
 * \brief
 */

#ifndef BATCH_NORM3D_INFER_LAST_CHANNEL_SMALL_A_H
#define BATCH_NORM3D_INFER_LAST_CHANNEL_SMALL_A_H
...
class BatchNorm3DInferLastChannelSmallA {
...
public:
    __aicore__ inline BatchNorm3DInferLastChannelSmallA(){};

    __aicore__ inline BatchNorm3DInferLastChannelSmallA(const BatchNorm3DInferLastChannelTilingData* tilingDataIn)
    {
