...
/*!
 * \file batch_norm3d_block_split_r.h
 * \brief
 */
#ifndef NORM_BATCH_NORM3D_BLOCK_SPLIT_R_H
#define NORM_BATCH_NORM3D_BLOCK_SPLIT_R_H
...
public:
    ...
    __aicore__ inline BatchNorm3DBlockSplitR(const BatchNorm3DBlockSplitRTilingData* tilingDataIn, TPipe* pipeIn)
    {
        this->pipe = pipeIn;
...
private:
    ...
    const BatchNorm3DBlockSplitRTilingData* tilingData;
    TPipe* pipe;
...
#endif // NORM_BATCH_NORM3D_BLOCK_SPLIT_R_H
