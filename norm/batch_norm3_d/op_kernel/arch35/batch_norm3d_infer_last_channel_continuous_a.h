...
/* !
 * \file batch_norm3d_infer_last_channel_continuous_a.h
 * \brief
 */

#ifndef BATCH_NORM3D_INFER_LAST_CHANNEL_CONTINUOUS_A_H
#define BATCH_NORM3D_INFER_LAST_CHANNEL_CONTINUOUS_A_H

#include "kernel_tiling/kernel_tiling.h"
#include "kernel_operator.h"
#include "batch_norm3d_base.h"

namespace BatchNorm3DOps {
...
class BatchNorm3DInferLastChannelContinuousA {
    static constexpr int32_t BUFFER_NUM = 2;
    static constexpr int32_t BUFFER_DEPTH = 1;

    static constexpr uint16_t VECTOR_LENGTH = BatchNorm3DOps::VECTOR_LENGTH;
    static constexpr uint16_t VL_FP32 = VECTOR_LENGTH / sizeof(float);
    static constexpr int64_t BLOCK_SIZE = BatchNorm3DOps::BLOCK_SIZE;
...
public:
    __aicore__ inline BatchNorm3DInferLastChannelContinuousA(){};

    __aicore__ inline BatchNorm3DInferLastChannelContinuousA(const BatchNorm3DInferLastChannelTilingData* tilingDataIn)
    {
...
private:
    const BatchNorm3DInferLastChannelTilingData* tilingData_;
