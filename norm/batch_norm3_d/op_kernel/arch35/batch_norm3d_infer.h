...
/*!
 * \file batch_norm3d_infer.h
 * \brief
 */

#ifndef NORM_BATCH_NORM3D_INFER_H
#define NORM_BATCH_NORM3D_INFER_H
...
class BatchNorm3DInfer {
public:
    __aicore__ inline BatchNorm3DInfer(){};

    __aicore__ inline BatchNorm3DInfer(const BatchNorm3DInferTilingData* tilingDataIn) { tilingData_ = tilingDataIn; }
...
#endif // NORM_BATCH_NORM3D_INFER_H
