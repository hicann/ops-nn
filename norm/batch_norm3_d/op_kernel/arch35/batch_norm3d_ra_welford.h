...
/*!
 * \file batch_norm3d_ra_welford.h
 * \brief
 */
#ifndef NORM_BATCH_NORM3D_RA_WELFORD_H
#define NORM_BATCH_NORM3D_RA_WELFORD_H
...
class BatchNorm3DRAWelford {
public:
    __aicore__ inline BatchNorm3DRAWelford(const BatchNorm3DRAWelfordTilingData* tilingData, TPipe* pipeIn)
    {
        this->pipe = pipeIn;
        this->r = tilingData->r;
...
#endif // NORM_BATCH_NORM3D_RA_WELFORD_H
