...
/*!
 * \file batch_norm3d_rar_block_split_r.h
 * \brief
 */

#ifndef NORM_BATCH_NORM3D_RAR_BLOCK_SPLIT_R_H
#define NORM_BATCH_NORM3D_RAR_BLOCK_SPLIT_R_H
...
class BatchNorm3DRARBlockSplitR {
...
public:
    ...
    __aicore__ inline BatchNorm3DRARBlockSplitR(const BatchNorm3DRARBlockSplitRTilingData* tilingDataIn, TPipe* pipeIn)
    {
        this->pipe = pipeIn;
...
private:
    ...
    const BatchNorm3DRARBlockSplitRTilingData* tilingData;
    TPipe* pipe;
...
#endif // NORM_BATCH_NORM3D_RAR_BLOCK_SPLIT_R_H
