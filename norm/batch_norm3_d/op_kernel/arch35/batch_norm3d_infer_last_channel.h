...
/*!
 * \file batch_norm3d_infer_last_channel.h
 * \brief
 */

#ifndef NORM_BATCH_NORM3D_INFER_LAST_CHANNEL_H
#define NORM_BATCH_NORM3D_INFER_LAST_CHANNEL_H
...
class BatchNorm3DInferLastChannel {
public:
    __aicore__ inline BatchNorm3DInferLastChannel(){};

    __aicore__ inline BatchNorm3DInferLastChannel(const BatchNorm3DInferLastChannelTilingData* tilingDataIn)
    {
...
#endif // NORM_BATCH_NORM3D_INFER_LAST_CHANNEL_H
