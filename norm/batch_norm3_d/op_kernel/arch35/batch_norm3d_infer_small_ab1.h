...
/* !
 * \file batch_norm3d_infer_small_ab1.h
 * \brief
 */

#ifndef BATCH_NORM3D_INFER_SMALL_AB1_H
#define BATCH_NORM3D_INFER_SMALL_AB1_H
...
class BatchNorm3DInferSmallAB1 {
...
public:
    __aicore__ inline BatchNorm3DInferSmallAB1(){};

    __aicore__ inline BatchNorm3DInferSmallAB1(const BatchNorm3DInferTilingData* tilingDataIn)
    {
...
private:
    ...
    __aicore__ inline void VFPrepareSmallAB1ParamCache(
...
private:
    const BatchNorm3DInferTilingData* tilingData_;
