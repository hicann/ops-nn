...
/*!
 * \file batch_norm3d_full_reduce.h
 * \brief
 */
#ifndef NORM_BATCH_NORM3D_FULL_REDUCE_H
#define NORM_BATCH_NORM3D_FULL_REDUCE_H
...
class BatchNorm3DFullReduce {
public:
    __aicore__ inline BatchNorm3DFullReduce(const BatchNorm3DFullReduceRegbaseTilingData* tilingData, TPipe* pipeIn)
    {
        this->pipe = pipeIn;
...
#endif // NORM_BATCH_NORM3D_FULL_REDUCE_H
