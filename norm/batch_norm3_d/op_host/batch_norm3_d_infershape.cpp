...
/*!
 * \file batch_norm3d_infershape.cpp
 * \brief
 */
#include "log/log.h"
...
static ge::graphStatus BatchNorm3DInferShape(gert::InferShapeContext* context)
{
    ...
    if (Ops::Base::IsUnknownRank(*xShape)) {
        ...
        Ops::Base::SetUnknownRank(*batchVarianceShape);
...
static ge::graphStatus BatchNorm3DInferDataType(gert::InferDataTypeContext* context)
{
    if (context == nullptr) {
        return GRAPH_FAILED;
    }
...
IMPL_OP_INFERSHAPE(BatchNorm3D).InferShape(BatchNorm3DInferShape).InferDataType(BatchNorm3DInferDataType);
} // namespace ops
