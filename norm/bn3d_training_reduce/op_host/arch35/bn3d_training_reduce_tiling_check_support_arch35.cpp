...
namespace ops {
static int BN3D_TRAINING_REDUCE_CHECK_SUPPORT_REGISTERED = []() {
    optiling::OpCheckFuncHelper(FUNC_CHECK_SUPPORTED, "BN3DTrainingReduce", CheckSupport4BN3DTrainingReduce);
    return 0;
}();
} // namespace ops
