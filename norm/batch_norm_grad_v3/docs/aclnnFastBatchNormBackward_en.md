...
- Description: Computes the backward pass of [aclnnBatchNorm](../../batch_norm_v3/docs/aclnnBatchNorm_en.md) (high-performance version) to obtain the gradient of the input tensor for model parameter updates.
- Formula:
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnFastBatchNormBackwardGetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnFastBatchNormBackward** is called to perform computation.
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>The shape length is the same as the length of the channel axis of the input parameter <idp:inline displayname="code" id="code13675397178">input</idp:inline>.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>1</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>The value is a non-negative number. </li><li>The shape length is the same as the length of the channel axis of the input parameter <idp:inline displayname="code" id="code14675179141717">input</idp:inline>.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>1</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>The shape length is the same as the length of the channel axis of the input parameter <idp:inline displayname="code" id="code12676139141717">input</idp:inline>.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>1</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>The value is a non-negative number. </li><li>The shape length is the same as the length of the channel axis of the input parameter <idp:inline displayname="code" id="code1267669171714">input</idp:inline>.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>1</td>
      <td>√</td>
    ...
    <tr>
      <td>version</td>
      <td>Input</td>
      <td>Algorithm version used internally by the operator.</td>
      <td>Currently, the options are 0 (default) and 1.</td>
      <td>INT</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>Optional. If outputMask[0] is true, this output is required. Otherwise, this output is not required. </li><li>The data type, shape, and data format must be the same as those of <idp:inline displayname="code" id="code209149201167">gradOut</idp:inline>.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>NC, NCL, NCHW, NCDHW, ND</td>
      <td>2–8</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are supported. </li><li>Optional. If outputMask[2] is True, the output is required. Otherwise, the output is not required. </li><li>The shape length is the same as the length of the channel axis of the input parameter <idp:inline displayname="code" id="code146767912170">input</idp:inline>.</li></ul></td>
      <td>FLOAT32, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>1</td>
      <td>√</td>
  ...
  - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>:
    ...
    - The data types of `weight`, `runningMean`, `runningVar`, `saveMean`, `saveInvstd`, `gradWeight`, and `gradBias` must be the same as that of `gradOut`.
- **Returns**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The data type, data format, or shape of either input or gradOut is not supported.</td>
    </tr>
    <tr>
      <td>The data type, data format, or shape of weight, runningMean, runningVar, saveMean, or saveInvstd is not supported.</td>
    </tr>
    <tr>
      <td>The length of outputMask is not 3.</td>
    </tr>
    <tr>
      <td>outputMask[0] is true, and the data type, data format, or shape of gradInput is not supported.</td>
    </tr>
    <tr>
      <td>outputMask[1] is true, and the data type, data format, or shape of gradWeight is not supported.</td>
    </tr>
    <tr>
      <td>outputMask[2] is true, and the data type, data format, or shape of gradBias is not supported.</td>
    </tr>
    <tr>
      <td>The shape lengths of weight, runningMean, runningVar, saveMean, saveInvstd, gradWeight (if not empty), and gradBias (if not empty) are not equal to the length of the channel axis in the input shape.</td>
    </tr>
    <tr>
      <td>The data formats of input, gradOut, and gradInput (if not empty) do not match.</td>
    </tr>
    <tr>
      <td>The data types of input, gradOut, and gradInput (if not empty) do not match.</td>
    </tr>
    <tr>
      <td>The shapes of input, gradOut, and gradInput (if not empty) do not match, or the shape has more than 8 dimensions or fewer than 2 dimensions.</td>
    </tr>
  </tbody></table>
...
- **Parameters**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnFastBatchNormBackwardGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  // aclnnBatchNormBackward API call example
  // 3. Call the CANN operator library API. Modify the API as required.
  // Call the first-phase API of aclnnFastBatchNormBackward.
  ...
  // Call the second-phase API of aclnnFastBatchNormBackward.
