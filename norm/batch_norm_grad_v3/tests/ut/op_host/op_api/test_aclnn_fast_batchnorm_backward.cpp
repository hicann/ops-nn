...
protected:
    static void SetUpTestCase() { std::cout << "l2FastBatchNormBackwardTest SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2FastBatchNormBackwardTest TearDown" << std::endl; }
};
