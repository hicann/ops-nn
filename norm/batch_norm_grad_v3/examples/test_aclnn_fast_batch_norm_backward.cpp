...
int main()
{
    ...
    ret = aclnnFastBatchNormBackwardGetWorkspaceSize(gradOut, self, weight, rMean, rVar, sMean, sVar, training, eps,
                                                     outMask, 0, gradIn, gradWeight, gradBias, &workspaceSize,
                                                     &executor);
