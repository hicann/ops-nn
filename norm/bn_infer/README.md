...
<table style="undefined;table-layout: fixed; width: 1005px"><colgroup>
  ...
  <td>待归一化的输入张量。不同数据格式对应的通道维见约束说明。</td>
      ...
      <td>NC1HWC0、NULL、ND、NCHW、NCDHW、NHWC、NDHWC</td>
    </tr>
    <tr>
      <td>scale</td>
      <td>输入</td>
...
- <term>Ascend 950PR/Ascend 950DT</term>：
  - x和y支持ND、NCHW、NCDHW、NHWC和NDHWC格式，不支持NC1HWC0和NULL格式。
...
- <term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>：
  - x和y支持NC1HWC0、NULL和NCDHW格式；动态shape场景下，NULL格式支持NCHW和NHWC映射。
  - scale、offset、mean和variance支持NC1HWC0、NULL和NCDHW格式。
  - x和y不支持ND和NDHWC格式。
