...
/* !
 * \file bn_infer_infer_last_channel_small_a.h
 * \brief
 */

#ifndef BN_INFER_INFER_LAST_CHANNEL_SMALL_A_H
#define BN_INFER_INFER_LAST_CHANNEL_SMALL_A_H
...
class BNInferLastChannelSmallA {
...
public:
    __aicore__ inline BNInferLastChannelSmallA(){};

    __aicore__ inline BNInferLastChannelSmallA(const BNInferLastChannelTilingData* tilingDataIn)
    {
