...
/* !
 * \file bn_infer_infer_last_channel_continuous_a.h
 * \brief
 */

#ifndef BN_INFER_INFER_LAST_CHANNEL_CONTINUOUS_A_H
#define BN_INFER_INFER_LAST_CHANNEL_CONTINUOUS_A_H
...
class BNInferLastChannelContinuousA {
...
public:
    __aicore__ inline BNInferLastChannelContinuousA(){};

    __aicore__ inline BNInferLastChannelContinuousA(const BNInferLastChannelTilingData* tilingDataIn)
    {
