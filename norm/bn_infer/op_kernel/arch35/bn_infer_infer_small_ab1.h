...
/* !
 * \file bn_infer_infer_small_ab1.h
 * \brief
 */

#ifndef BN_INFER_INFER_SMALL_AB1_H
#define BN_INFER_INFER_SMALL_AB1_H
...
public:
    __aicore__ inline BNInferSmallAB1(){};

    __aicore__ inline BNInferSmallAB1(const BNInferTilingData* tilingDataIn) { tilingData_ = tilingDataIn; }
                                ...
                                TPipe* pipeIn)
    {
        ...
        pipe_->InitBuffer(meanQueueSmallAb1_, BUFFER_NUM, tilingData_->totalALen * sizeof(float));
    ...
    __aicore__ inline void Process()
    {
        ...
        CopyInBetaGammaMeanVar<T_GAMMA, T_RUNNING_MEAN>(true, 0, tilingData_->totalALen, betaQueue_, gammaQueue_,
                                                        meanQueueSmallAb1_, varQueue_, betaGm_, gammaGm_, meanGm_,
                                                        varGm_);
        PrepareParamCache<T_GAMMA, T_RUNNING_MEAN>(betaQueue_, gammaQueue_, meanQueueSmallAb1_, varQueue_, offsetBuf_,
...
private:
                                       ...
                                       __ubuf__ float* rstdFp32Local, __ubuf__ T* yLocal, uint16_t curTileB0Len)
    {
        ...
        uint32_t paramCacheElemLen = GetSmallAB1ParamCacheElemLen();
        BNInferOps::NormalizeSmallAB1Unalign(xLocal, gammaFp32Local, betaFp32Local, meanFp32Local, rstdFp32Local,
                                             yLocal, elemLen, paramCacheElemLen);
    }
...
private:
    const BNInferTilingData* tilingData_;
    ...
    TQue<QuePosition::VECIN, BUFFER_DEPTH> meanQueueSmallAb1_;
