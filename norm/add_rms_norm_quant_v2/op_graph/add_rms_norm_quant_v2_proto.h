...
/*!
 * \file add_rms_norm_quant_v2_proto.h
 * \brief
 */
#ifndef OPS_NORM_ADD_RMS_NORM_QUANT_V2_PROTO_H_
#define OPS_NORM_ADD_RMS_NORM_QUANT_V2_PROTO_H_

#include "graph/operator_reg.h"

namespace ge {
/**
* @brief AddRmsNormQuantV2 operator interface implementation.
...
*                   Support dtype: int32/float32/float16/bfloat16, support format: ND.
* @li bias: An optional input tensor. Describing the bias of the rmsnorm operation.
*                   Support dtype: float32/float16/bfloat16, support format: ND.
 ...
 * @li output_res: An optional bool. Whether to output resOut (rmsnorm result before bias).
...
*                  Support dtype: float32/float16/bfloat16, support format: ND.
* @li resOut: An optional tensor. Describing the output of the rmsnorm operation before bias addition.
*                        Support dtype: float32/float16/bfloat16, support format: ND.
*/
...
#endif // OPS_NORM_ADD_RMS_NORM_QUANT_V2_PROTO_H_
