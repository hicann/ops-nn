...
TEST_F(LayerNormQuantKernelTest, kernel_test_a2_non_aligned)
{
    ...
    map<string, string> soc_version = {{"NpuArch", "2201"}, {"Short_SoC_version", "ASCEND910B"}};
    ...
    platform_info.Init();
    // compile info
    optiling::Tiling4LayerNormQuantCompileInfo compile_info;
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .InputShapes({&x_shape, &gamma_shape, &beta_shape, &scale_shape, &offset_shape})
                      .OutputShapes({&y_shape, &scale_out_shape})
