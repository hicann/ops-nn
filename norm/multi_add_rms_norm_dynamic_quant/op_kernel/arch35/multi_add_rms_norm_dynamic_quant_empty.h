...
/*!
 * \file multi_add_rms_norm_dynamic_quant_empty.h
 * \brief
 */
#ifndef MULTI_ADD_RMS_NORM_DYNAMIC_QUANT_EMPTY_H_
#define MULTI_ADD_RMS_NORM_DYNAMIC_QUANT_EMPTY_H_
...
class KernelMultiAddRmsNormDynamicQuantEmpty {
public:
    __aicore__ inline KernelMultiAddRmsNormDynamicQuantEmpty(
        TPipe* pipe, const MultiAddRmsNormDynamicQuantEmptyTilingData* tilingData)
...
private:
    ...
    const MultiAddRmsNormDynamicQuantEmptyTilingData* tiling_;
};
} // namespace MultiAddRmsNormDynamicQuant
#endif // _MULTI_ADD_RMS_NORM_DYNAMIC_QUANT_EMPTY_H_
