...
{
    printf("\n%s\n", "============================================================");
    printf("%s - INFO - [XIR]: Scenario: %s, graph shape = %s, dtype = %d\n", GetTime().c_str(), scenarioName.c_str(),
    ...
    for (size_t t = 0; t < testShapes.size(); ++t) {
        ...
        if (output.size() != 3) {
            printf("%s - ERROR - [XIR]: [%s] Expected 3 outputs, got %d\n", GetTime().c_str(), scenarioName.c_str(),
...
int main(int argc, char* argv[])
{
    ...
    printf("%s - INFO - [XIR]: InplaceApplyFtrl GE IR Dynamic Shape Example\n", GetTime().c_str());
    ...
    // ====================================================================
    {
        ...
        if (RunDynamicScenario("DynamicShape(-1)", graphShape, testShapes, dtype) != SUCCESS) {
            totalFail++;
        }
    }
    ...
    // ====================================================================
    {
        ...
        if (RunDynamicScenario("DynamicRank(-2)", graphShape, testShapes, dtype) != SUCCESS) {
            totalFail++;
        }
    }
