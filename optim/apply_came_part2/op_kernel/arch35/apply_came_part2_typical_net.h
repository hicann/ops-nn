...
private:
    ...
    __aicore__ inline void CopyIn(GlobalTensor<float>& inGm, GlobalTensor<float>& inGradGm, int64_t offset,
                                  int64_t dataCount)
    {
    ...
    __aicore__ inline void CopyOut(GlobalTensor<float> outGm, int64_t offset, int64_t dataCount)
    {
