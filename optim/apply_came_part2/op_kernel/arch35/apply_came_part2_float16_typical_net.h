...
private:
    ...
    __aicore__ inline void ProcessR()
    {
        ...
        int64_t dataCount = (blockIdx_ != tilingData_.rCoreNumToUse - 1) ? tilingData_.rNumPerCore :
                                                                           tilingData_.rNumOnTailCore;
    ...
    __aicore__ inline void ProcessC()
    {
        ...
        int64_t dataCount = (blockIdx_ != tilingData_.cCoreNumToUse - 1) ? tilingData_.cNumPerCore :
                                                                           tilingData_.cNumOnTailCore;
    ...
    __aicore__ inline void CopyIn(GlobalTensor<T>& inGm, GlobalTensor<float>& inGradGm, int64_t offset,
                                  int64_t dataCount)
    {
    ...
    __aicore__ inline void CopyOutFp32(GlobalTensor<float> outGm, int64_t offset, int64_t dataCount)
    {
    ...
    __aicore__ inline void CopyOut(GlobalTensor<T> outGm, int64_t offset, int64_t dataCount)
    {
    ...
    __aicore__ inline void ProcessU()
    {
        ...
        const int64_t rLoopNum = (blockIdx_ != tilingData_.rRcCoreNumToUse - 1) ? tilingData_.rRcNumPerCore :
                                                                                  tilingData_.rRcNumOnTailCore;
    ...
    __aicore__ inline void ComputeU(LocalTensor<float>& cTmp, LocalTensor<float>& sumSquareU, float rValue,
                                    int64_t dataCount)
    {
