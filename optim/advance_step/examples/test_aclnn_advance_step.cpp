...
int main()
{
    ...
    ret = aclnnAdvanceStepGetWorkspaceSize(input1, input2, input3, input4, input5, input6, numseq, numqueries,
                                           blocksize, &workspaceSize, &executor);
    ...
    ret = aclnnAdvanceStep(workspaceAddr, workspaceSize, executor, stream);
