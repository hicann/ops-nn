...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnAdvanceStepV2GetWorkspaceSize** is called to obtain the input parameters and compute the required workspace size based on the process. Then, **aclnnAdvanceStepV2** is called to perform computation.
```Cpp
...
- **Parameters:**
  ...
  <tbody>
    <tr>
      <td>inputTokens</td>
      <td>Input/Output</td>
      <td>Input/Output parameter for the AdvanceStepV2 computation, which is the output inputTokens in the formula. It is used to update the token value in the vLLM model.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The length of the first dimension of the shape is the same as that of numSeqs, and the length of the second dimension is 1+specNum. </li><li>The value is a positive integer greater than 0.</li></ul></td>
      <td>INT64</td>
      <td>ND</td>
      <td>2</td>
      <td>×</td>
    ...
    <tr>
      ...
      <td>Input</td>
      <td>Input parameter for the AdvanceStepV2 computation, which is used to store tokenIDs and corresponds to input sampledTokenIds in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The length of the first dimension of the shape is the same as that of numSeqs, and the length of the second dimension is 1+specNum. </li><li>The value is a positive integer greater than 0.</li></ul></td>
      <td>INT64</td>
      <td>ND</td>
      <td>2</td>
     ...
     <tr>
      ...
      <td>Input/Output</td>
      <td>Input/Output parameter for the AdvanceStepV2 computation, which is the output inputPositions in the formula. It is used to record the token index.</td>
    ...
    <tr>
      <td>seqLens</td>
      <td>Input/Output</td>
      <td>Input/Output parameter for the AdvanceStepV2 computation, which is used to record the seq length under different blockIdx. It corresponds to the input/output seqLens in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The shape length is the same as that of numSeqs. </li><li>The value is a positive integer greater than 0.</li></ul></td>
      <td>INT64</td>
      <td>ND</td>
      <td>1</td>
      ...
      <td>slotMapping</td>
      <td>Input/Output</td>
      <td>Input/Output parameter for the AdvanceStepV2 computation, which is the output slotMapping in the formula. It is used to map the position of the token value in the sequence to the physical position.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The shape length is the same as that of numSeqs. </li><li>The value is a positive integer greater than 0.</li></ul></td>
      <td>INT64</td>
      <td>ND</td>
      <td>1</td>
    ...
    <tr>
      <td>blockTables</td>
      <td>Input</td>
      <td>Input parameter for the AdvanceStepV2 computation, which is used to record the block size under different blockIdx. It corresponds to the input blockTables in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The length of the shape is the same as that of numSeqs, and the length of the second dimension is greater than (maximum value in seqLens)/blockSize. </li><li>The value is a positive integer greater than 0.</li></ul></td>
      <td>INT64</td>
      <td>ND</td>
      <td>2</td>
      <td>×</td>
      ...
      <td>specToken</td>
      <td>Input</td>
      <td>Input parameter for the AdvanceStepV2 computation, which is used to record the token index of the current speculative model.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The length of the first dimension of the shape is the same as that of numSeqs, and the length of the second dimension is specNum. </li><li>The value is a positive integer greater than 0.</li></ul></td>
      <td>INT64</td>
      <td>ND</td>
      <td>2</td>
      <td>×</td>
      ...
      <td>acceptedNum</td>
      <td>Input</td>
      <td>Input parameter for the AdvanceStepV2 computation, which is used to record the number of speculative records accepted by each request.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The shape length is the same as that of numSeqs. </li><li>The value is a positive integer greater than 0.</li></ul></td>
      <td>INT64</td>
      <td>ND</td>
      <td>1</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>The passed inputTokens, sampledTokenIds, inputPositions, seqLens, slotMapping, blockTables, specToken, or acceptedNum is a null pointer.</td>
    </tr>
    <tr>
      <td>ACLNN_ERR_PARAM_INVALID</td>
      <td>161002</td>
      <td>The data type of inputTokens, sampledTokenIds, inputPositions, seqLens, slotMapping, blockTables, specToken, or acceptedNum is not supported.</td>
    </tr>
    <tr>
      <td rowspan="5">aclnnAdvanceStepV2GetWorkspaceSize failed</td>
      <td rowspan="5">561002</td>
      <td>The length of the first dimension of the shape of inputTokens, inputPositions, seqLens, slotMapping, blockTables, specToken, or acceptedNum is inconsistent with that of numSeqs.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>The length of the second dimension of the shape of inputTokens is not 1+specNum.</td>
    </tr>
      <tr>
      <td>The length of the second dimension of the shape of specToken is not specNum.</td>
    </tr>
      <tr>
      <td>The value of numSeqs is not equal to that of numQueries.</td>
    </tr>
  </tbody>
  </table>  
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, obtained by calling the first-phase API aclnnAdvanceStepV2GetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
#include <vector>
#include "acl/acl.h"
#include "aclnnop/aclnn_advance_step_V2.h"// Uncertain header file name
...
int main() {
    ...
    // Call the first-phase API of aclnnAdvanceStepV2.
    ...
    // Call the second-phase API of aclnnAdvanceStepV2.
