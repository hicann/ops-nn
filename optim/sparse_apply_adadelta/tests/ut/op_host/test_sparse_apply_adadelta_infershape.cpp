...
protected:
    static void SetUpTestCase() { std::cout << "SparseApplyAdadeltaInfershape SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "SparseApplyAdadeltaInfershape TearDown" << std::endl; }
};
