 ...
 */
#ifndef OPS_NN_APPLY_CAME_PART1_TILING_KEY_H
#define OPS_NN_APPLY_CAME_PART1_TILING_KEY_H
...
ASCENDC_TPL_ARGS_DECL(ApplyCamePart1,
...
#endif // OPS_NN_APPLY_CAME_PART1_TILING_KEY_H
