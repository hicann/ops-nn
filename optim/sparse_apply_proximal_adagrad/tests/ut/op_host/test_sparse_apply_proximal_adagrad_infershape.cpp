...
/*!
 * \file test_sparse_apply_proximal_adagrad_infershape.cpp
 * \brief InferShape UT for SparseApplyProximalAdagrad operator.
 *
 * Schema:
 *   Inputs  (7): var, accum, lr, l1, l2, grad, indices
 *   Outputs (2): var, accum (each takes the shape of the corresponding input)
 */
...
#include "../../../op_graph/sparse_apply_proximal_adagrad_proto.h"
...
// case_0: 2D shape -> var/accum outputs follow var shape.
...
// case_3: empty indices (M == 0); var/accum output shapes still follow inputs.
