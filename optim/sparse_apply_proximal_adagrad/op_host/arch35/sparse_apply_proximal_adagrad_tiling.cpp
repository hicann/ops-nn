...
static constexpr int64_t kLrIdx = 2;
static constexpr int64_t kL1Idx = 3;
static constexpr int64_t kL2Idx = 4;
static constexpr int64_t kGradIdx = 5;
static constexpr int64_t kIndicesIdx = 6;
static constexpr int64_t kStateTensorIdx[] = {kAccumIdx};
