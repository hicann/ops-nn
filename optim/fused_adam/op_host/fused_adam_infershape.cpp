...
/*!
 * \file fused_adam_infershape.cpp
 * \brief
 */
...
static constexpr size_t OUTPUT_EXP_AVGS_INDEX = 2;
static constexpr size_t OUTPUT_EXP_AVG_SQS_INDEX = 3;
static constexpr size_t OUTPUT_MAX_EXP_AVG_SQS_INDEX = 4;

namespace ops {
static ge::graphStatus InferShapeForFusedAdam(gert::InferShapeContext* context)
{
    OP_LOGD(context, "Begin to do InferShapeForFusedAdam.");
    ...
    OP_CHECK_NULL_WITH_CONTEXT(context, gradsOutInstanceInfo);
    ...
    OP_LOGD(context, "End to do InferShapeForFusedAdam.");
    return ge::GRAPH_SUCCESS;
}

static graphStatus InferDataTypeForFusedAdam(gert::InferDataTypeContext* context)
{
    auto computeNodeInfo = context->GetComputeNodeInfo();
    OP_CHECK_NULL_WITH_CONTEXT(context, computeNodeInfo);
...
IMPL_OP_INFERSHAPE(FusedAdam).InferShape(InferShapeForFusedAdam).InferDataType(InferDataTypeForFusedAdam);
} // namespace ops
