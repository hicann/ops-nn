...
TEST_F(LambUpdateWithLrV2ProtoTest, lambupdatewithlrv2_infer_datatype)
{
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl("LambUpdateWithLrV2"), nullptr);
    auto dataTypeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LambUpdateWithLrV2")->infer_datatype;
    ...
    auto contextHolder = gert::InferDataTypeContextFaker()
                             ...
                             .NodeInputTd(6, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                             .NodeOutputTd(0, ge::DT_FLOAT, ge::FORMAT_ND, ge::FORMAT_ND)
                             .InputDataTypes({&in0, &in1, &in2, &in3, &in4, &in5, &in6})
