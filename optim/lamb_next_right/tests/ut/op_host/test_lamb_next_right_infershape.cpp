...
class LambNextRightProtoTest : public testing::Test {
protected:
    static void SetUpTestCase() {}
    static void TearDownTestCase() {}
};

TEST_F(LambNextRightProtoTest, lamb_next_right_case_2d)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LambNextRight")->infer_shape;
    ...
    auto holder = gert::InferShapeContextFaker()
                      ...
                      .InputShapes({&inShape, &inShape, &inShape, &inShape, &inShape, &inShape})
...
TEST_F(LambNextRightProtoTest, lamb_next_right_case_fp16_4d)
{
    auto inferShapeFunc = gert::OpImplRegistry::GetInstance().GetOpImpl("LambNextRight")->infer_shape;
