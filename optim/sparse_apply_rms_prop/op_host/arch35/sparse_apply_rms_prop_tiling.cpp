...
static constexpr int64_t kMsIdx = 1;
static constexpr int64_t kMomIdx = 2;
static constexpr int64_t kLrIdx = 3;
static constexpr int64_t kRhoIdx = 4;
static constexpr int64_t kMomentumIdx = 5;
static constexpr int64_t kEpsilonIdx = 6;
static constexpr int64_t kGradIdx = 7;
static constexpr int64_t kIndicesIdx = 8;
static constexpr int64_t kStateTensorIdx[] = {kMsIdx, kMomIdx};
static constexpr int64_t kDataInputIdx[] = {kMsIdx, kMomIdx, kLrIdx, kRhoIdx, kMomentumIdx, kEpsilonIdx, kGradIdx};
static constexpr int64_t kScalarInputIdx[] = {kLrIdx, kRhoIdx, kMomentumIdx, kEpsilonIdx};
...
static ge::graphStatus GetShapeInfo(const gert::TilingContext* context, int64_t& totalIndices, int64_t& innerDim,
                                    int64_t& varFirstDim)
{
    ...
    OP_CHECK_IF(ValidateInputs(context, totalIndices) != ge::GRAPH_SUCCESS, OP_LOGE(context, "ValidateInputs failed"),
                return ge::GRAPH_FAILED);
