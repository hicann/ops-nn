...
#include "../../../op_api/aclnn_fused_adamw.h"
...
class l2_fused_adamw_test : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "l2_fused_adamw_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2_fused_adamw_test TearDown" << std::endl; }
};

TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_nullptr)
{
...
TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_grad_nullptr)
{
    vector<vector<int64_t>> selfDims = {{2, 2}, {1}};
    vector<vector<int64_t>> outDims = {{2, 2}};
    auto params = TensorDesc(selfDims[0], ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_attr_error)
{
    vector<vector<int64_t>> selfDims = {{2, 2}, {1}};
    vector<vector<int64_t>> outDims = {{2, 2}};
    auto params = TensorDesc(selfDims[0], ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_diff_list_num)
{
...
TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_error_dtype)
{
    vector<vector<int64_t>> selfDims = {{2, 2}, {1}, {8, 8}};
...
TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_step_error_dtype)
{
    vector<vector<int64_t>> selfDims = {{2, 2}, {1}, {8, 8}};
...
TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_diff_params_grad_dtype)
{
    vector<vector<int64_t>> selfDims = {{2, 2}, {1}, {8, 8}};
    vector<vector<int64_t>> outDims = {{2, 2}};
    auto params = TensorDesc(selfDims[0], ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_diff_params_grad_shape)
{
    vector<vector<int64_t>> selfDims = {{2, 2}, {1}, {8, 8}};
    vector<vector<int64_t>> outDims = {{2, 2}};
    auto params = TensorDesc(selfDims[0], ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
...
TEST_F(l2_fused_adamw_test, ascend910B2_fused_adamw_test_success)
{
    vector<vector<int64_t>> selfDims = {{2, 2}, {1}, {8, 8}};
    vector<vector<int64_t>> outDims = {{2, 2}};
    auto params = TensorDesc(selfDims[0], ACL_FLOAT, ACL_FORMAT_ND).ValueRange(-1, 1);
    ...
    auto maxExpAvgSqsList = TensorListDesc({maxExpAvgSqs});
    auto stateStepsList = TensorListDesc({step});
    auto ut = OP_API_UT(aclnnFusedAdamw,
