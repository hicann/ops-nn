...
protected:
    static void SetUpTestCase() { std::cout << "EmbeddingHashTableImportTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "EmbeddingHashTableImportTiling TearDown" << std::endl; }
};
