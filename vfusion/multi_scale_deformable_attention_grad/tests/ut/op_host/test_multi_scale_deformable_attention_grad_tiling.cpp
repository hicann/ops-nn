...
protected:
    static void SetUpTestCase() { std::cout << "MultiScaleDeformableAttentionGradTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "MultiScaleDeformableAttentionGradTiling TearDown" << std::endl; }
};
...
TEST_F(MultiScaleDeformableAttentionGradTiling, MultiScaleDeformableAttentionGrad_tiling_multi_batch)
{
    ...
    gert::StorageShape grad_output_shape = {{batch, num_query, num_heads, channels},
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .InputShapes({&value_shape, &value_spatial_shapes_shape, &value_level_start_index_shape,
                                    &sampling_locations_shape, &attention_weights_shape, &grad_output_shape})
