...
#include "../../../op_api/aclnn_multi_scale_deformable_attention_grad.h"
...
protected:
    static void SetUpTestCase() { std::cout << "l2_multi_scale_deformable_attention_grad_test SetUp" << std::endl; }
