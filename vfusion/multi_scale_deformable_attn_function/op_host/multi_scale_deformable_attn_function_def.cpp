...
public:
    explicit MultiScaleDeformableAttnFunction(const char* name) : OpDef(name)
    {
        ...
        config950.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "multi_scale_deformable_attn_function");
        ...
        config310p.Input("value")
            ...
            .UnknownShapeFormat({ge::FORMAT_ND})
            .AutoContiguous();
        config310p.Input("value_spatial_shapes")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT32})
            .Format({ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND})
            .AutoContiguous();
        config310p.Input("value_level_start_index")
            .ParamType(REQUIRED)
            .DataType({ge::DT_INT32})
            .Format({ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND})
            .AutoContiguous();
        config310p.Input("sampling_locations")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT})
            .Format({ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND})
            .AutoContiguous();
        config310p.Input("attention_weights")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT})
            .Format({ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND})
