...
#include "../../../../op_api/aclnn_multi_scale_deformable_attn_function.h"
...
protected:
    static void SetUpTestCase() { std::cout << "l2_multi_scale_deformable_attn_function_test SetUp" << std::endl; }
