...
protected:
    static void SetUpTestCase() { std::cout << "MultiScaleDeformableAttnFunctionTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "MultiScaleDeformableAttnFunctionTiling TearDown" << std::endl; }
};
...
TEST_F(MultiScaleDeformableAttnFunctionTiling, MultiScaleDeformableAttnFunction_tiling_generic)
{
    ...
    gert::StorageShape value_shape = {{batch, spatial_size, num_heads, channels},
    ...
    gert::StorageShape attention_weights_shape = {{batch, num_query, num_heads, num_levels, num_point},
                                                  {batch, num_query, num_heads, num_levels, num_point}};
    gert::StorageShape output_shape = {{batch, num_query, num_heads * channels},
                                       {batch, num_query, num_heads * channels}};

    auto holder = gert::TilingContextFaker()
                      .NodeIoNum(5, 1)
                      .IrInstanceNum({1, 1, 1, 1, 1})
                      .InputShapes({&value_shape, &value_spatial_shapes_shape, &value_level_start_index_shape,
                                    &sampling_locations_shape, &attention_weights_shape})
...
TEST_F(MultiScaleDeformableAttnFunctionTiling, MultiScaleDeformableAttnFunction_tiling_trans)
{
    ...
    uint64_t num_query = 100;
    uint64_t num_point = 2;
    gert::StorageShape value_shape = {{batch, num_heads, spatial_size, channels},
                                      {batch, num_heads, spatial_size, channels}};
    gert::StorageShape value_spatial_shapes_shape = {{num_levels, 2}, {num_levels, 2}};
    gert::StorageShape value_level_start_index_shape = {{num_levels}, {num_levels}};
    ...
    gert::StorageShape attention_weights_shape = {{batch, num_heads, num_levels, num_point, num_query},
                                                  {batch, num_heads, num_levels, num_point, num_query}};
    gert::StorageShape output_shape = {{batch, num_heads * channels, num_query},
                                       {batch, num_heads * channels, num_query}};
