                                                     ...
                                                     uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    // Use 1.0f/6.0f instead of 0.16666666f literal to match PyTorch hardsigmoid
    // semantics exactly at boundary x=-3.0 (fp32-precision-aware: 1/6*(-3)+0.5 == 0
    // strictly, whereas 0.16666666f*(-3)+0.5 = 2.98e-08 leaks into mask=1 region).
