...
// Relu6 需要 4 个 LocalTensor：inputLocal x2（双缓冲）+ tmpLocal（Maxs中间结果）+ outputLocal
...
static ge::graphStatus Relu6TilingFunc(gert::TilingContext* context)
{
    ...
    // bufferNum = 4（inputLocal x2 双缓冲 + tmpLocal + outputLocal）
