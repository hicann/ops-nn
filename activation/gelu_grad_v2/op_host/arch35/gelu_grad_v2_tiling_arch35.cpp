...
ge::graphStatus GeluGradV2Tiling::GetShapeAttrsInfo() { return ge::GRAPH_SUCCESS; }

bool GeluGradV2Tiling::IsCapable() { return true; }
...
ge::graphStatus GeluGradV2Tiling::CheckValid()
{
    ...
    OP_CHECK_IF(this->outputDtype != dyInputDtype,
...
ge::graphStatus GeluGradV2Tiling::DoLibApiTiling() { return ge::GRAPH_SUCCESS; }

uint64_t GeluGradV2Tiling::GetTilingKey() const { return tilingKey; }

ge::graphStatus GeluGradV2Tiling::GetWorkspaceSize() { return ge::GRAPH_SUCCESS; }

ge::graphStatus GeluGradV2Tiling::PostTiling() { return ge::GRAPH_SUCCESS; }

ge::graphStatus GeluGradV2Tiling::GetPlatformInfo() { return ge::GRAPH_SUCCESS; }
