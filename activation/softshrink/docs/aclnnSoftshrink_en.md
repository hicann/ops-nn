...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/activation/softshrink)
...
- Description: Forcibly shrinks elements in the range of **λ** by element.
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnSoftshrinkGetWorkspaceSize** is called to obtain the workspace size required for computation and the executor that contains the operator computation process. Then, **aclnnSoftshrink** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
      ...
      <td>lambd</td>
      <td>Input</td>
      <td>Input scalar, corresponding to the input λ in the formula.</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output parameter of the Softshrink computation.</td>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnSoftshrinkGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic compute:
  - **aclnnSoftshrink** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnSoftshrink.
  ...
  // Call the second-phase API of aclnnSoftshrink.
