...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/activation/hardtanh_grad)
...
- Description: Performs backpropagation of the activation function aclnnHardtanh.
- Formula:
...
- **Parameters:**
  ...
  <thead>
   ...
   <tbody>
      ...
      <td>gradOutput</td>
      <td>Input</td>
      <td>Gradient output in the previous step during backpropagation, corresponding to grad_output in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The shapes of gradOutput, self, and out are the same. </li><li>The data types of gradOutput, self, and out are the same.</li></ul></td>
    ...
    <tr>
      <td>self</td>
      <td>Input</td>
      <td>Forward input data, corresponding to self in the formula.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The shapes of gradOutput, self, and out are the same. </li><li>The data types of gradOutput, self, and out are the same.</li></ul></td>
      <td>BFLOAT16, FLOAT16, FLOAT</td>
      <td>ND</td>
      <td>0–8</td>
      ...
      <td>min</td>
      <td>Input</td>
      <td>Lower limit of the linear range, corresponding to min in the formula.</td>
      <td>-</td>
      <td>BFLOAT16, FLOAT16, FLOAT</td>
      <td>-</td>
      <td>-</td>
      ...
      <td>max</td>
      <td>Input</td>
      <td>Upper limit of the linear range, corresponding to max in the formula.</td>
      <td>-</td>
      <td>BFLOAT16, FLOAT16, FLOAT</td>
      <td>-</td>
      <td>-</td>
     ...
     <tr>
      <td>out</td>
      <td>Output</td>
      <td>Gradient obtained through computation.</td>
      <td><ul><li>Empty tensors are not supported. </li><li>The shapes of gradOutput, self, and out are the same. </li><li>The data types of gradOutput, self, and out are the same.</li></ul></td>
      <td>BFLOAT16, FLOAT16, FLOAT</td>
      <td>ND</td>
      <td>0–8</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>The passed gradOutput, self, out, min, or max is a null pointer.</td>
    </tr>
    <tr>
      <td rowspan="8">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="8">161002</td>
      <td>The data type of gradOutput, self, or out is not supported.</td>
    </tr>
    <tr>
      <td>The data types of gradOutput and self are different.</td>
    </tr>
    <tr>
      <td>The shapes of gradOutput and self are different.</td>
    </tr>
    <tr>
      <td>gradOutput or self has more than eight dimensions.</td>
    </tr>
  </tbody></table>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnHardtanhBackwardGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnHardtanhBackward.
  ...
  // Call the second-phase API of aclnnHardtanhBackward.
