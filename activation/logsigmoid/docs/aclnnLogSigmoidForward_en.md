...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnLogSigmoidForwardGetWorkspaceSize** is called to obtain the workspace size required for computation and the executor that contains the operator computation process. Then, **aclnnLogSigmoidForward** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
      ...
      <td>self</td>
      <td>Input</td>
      <td>Input parameter for LogSigmoidForward computation, corresponding to x in the formula.</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output parameter, corresponding to out in the formula.</td>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by the first-phase API aclnnLogSigmoidForwardGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- Deterministic compute:
  - **aclnnLogSigmoidForward** defaults to a deterministic implementation.
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnLogSigmoidForward.
  ...
  // Call the second-phase API of aclnnLogSigmoidForward.
