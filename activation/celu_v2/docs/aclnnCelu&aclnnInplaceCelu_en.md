...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/activation/celu_v2)
...
- Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnCeluGetWorkspaceSize** or **aclnnInplaceCeluGetWorkspaceSize** is called to obtain the workspace size required for computation and the executor that contains the operator computation process. Then, **aclnnCelu** or **aclnnInplaceCelu** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
      ...
      <td>self</td>
      <td>Input</td>
      <td>Input of the CELU activation function, corresponding to x in the formula.</td>
      ...
      <td>alpha</td>
      <td>Input</td>
      <td>Activation coefficient of the CELU activation function, corresponding to \alpha in the formula.</td>
      <td><ul><li>The data type must be convertible to FLOAT (see <a href="../../../docs/en/context/conversion_relationship.md" target="_blank">Conversion Relationship</a>). </li><li>The value of alpha cannot be 0.</li></ul></td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output of the CELU activation function.</td>
      <td><ul><li>The data type must be a data type that can be converted from that of self (see <a href="../../../docs/en/context/conversion_relationship.md" target="_blank">Conversion Relationship</a>). </li><li>The shape must be the same as that of self.</li></ul></td>
      <td>FLOAT, FLOAT16, BFLOAT16</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    <tr>
      ...
      <td>161001</td>
      <td>The passed self, alpha, or out is a null pointer.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>The data type of alpha cannot be converted to FLOAT.</td>
    </tr>
    <tr>
      <td>The data type of out cannot be converted from that of self.</td>
    </tr>
    <tr>
      <td>The shapes of self and out are inconsistent.</td>
    </tr>
    <tr>
      <td>The shape of self or out is greater than 8D.</td>
    </tr>
      <tr>
      <td>The value of alpha is 0.</td>
    </tr>
  </tbody></table>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API **aclnnCeluGetWorkspaceSize**.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    <tr>
      <td>ACLNN_ERR_PARAM_NULLPTR</td>
      <td>161001</td>
      <td>The passed selfRef or alpha is a null pointer.</td>
    </tr>
    <tr>
      <td rowspan="8">ACLNN_ERR_PARAM_INVALID</td>
      <td rowspan="8">161002</td>
    ...
    <tr>
      <td>The shape of selfRef is greater than 8D.</td>
    </tr>
    <tr>
      <td>The value of alpha is 0.</td>
    </tr>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API **aclnnInplaceCeluGetWorkspaceSize**.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnCelu.
  ...
  // Call the second-phase API of aclnnCelu.
...
int main() {
  ...
  uint64_t workspaceSize = 0;
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnInplaceCelu.
  ...
  // Call the second-phase API of aclnnInplaceCelu.
