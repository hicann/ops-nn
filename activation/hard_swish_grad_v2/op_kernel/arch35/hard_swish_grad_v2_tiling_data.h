...
/*!
 * \file hard_swish_grad_v2_tiling_data.h
 * \brief HardSwishGradV2 tiling data struct
 */

#ifndef _HARD_SWISH_GRAD_V2_TILING_DATA_H_
#define _HARD_SWISH_GRAD_V2_TILING_DATA_H_
