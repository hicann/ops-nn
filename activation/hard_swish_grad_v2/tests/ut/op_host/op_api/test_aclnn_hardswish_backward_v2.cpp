...
#include "../../../../op_api/aclnn_hardswish_backward_v2.h"
#include "op_api_ut_common/tensor_desc.h"
#include "op_api_ut_common/op_api_ut.h"

class l2_hardswish_backward_v2_test : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "l2_hardswish_backward_v2_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2_hardswish_backward_v2_test TearDown" << std::endl; }
};
