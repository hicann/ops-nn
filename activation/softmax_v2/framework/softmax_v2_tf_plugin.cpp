...
namespace domi {
// TensorFlow Softmax uses attribute `axis`, while the GE op expects `axes`.
static Status ParseParamsSoftmaxV2(const google::protobuf::Message* op_src, ge::Operator& op)
{
...
REGISTER_CUSTOM_OP("SoftmaxV2")
    ...
    .ParseParamsFn(ParseParamsSoftmaxV2)
