...
{
    vector<aclDataType> ValidList = {ACL_DT_UNDEFINED, ACL_INT16,  ACL_INT64,     ACL_UINT8,
                                     ACL_UINT16,       ACL_UINT32, ACL_UINT64,    ACL_DOUBLE,
...
{
    vector<aclFormat> ValidList = {ACL_FORMAT_NDHWC, ACL_FORMAT_NCDHW, ACL_FORMAT_ND};
...
{
    vector<aclFormat> ValidList = {ACL_FORMAT_ND, ACL_FORMAT_NCL};
