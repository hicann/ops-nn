...
TEST_F(l2_rrelu_with_noise_test, case_nullptr_1)
{
    ...
    auto ut = OP_API_UT(aclnnRReluWithNoise, INPUT(nullptr, noise, lower, upper, training, seed, offset), OUTPUT(out));
...
TEST_F(l2_rrelu_with_noise_test, case_nullptr_2)
{
    ...
    auto ut = OP_API_UT(aclnnRReluWithNoise, INPUT(self, nullptr, lower, upper, training, seed, offset), OUTPUT(out));
...
TEST_F(l2_rrelu_with_noise_test, case_nullptr_3)
{
    ...
    auto ut = OP_API_UT(aclnnRReluWithNoise, INPUT(self, noise, nullptr, upper, training, seed, offset), OUTPUT(out));
...
TEST_F(l2_rrelu_with_noise_test, case_nullptr_4)
{
    ...
    auto ut = OP_API_UT(aclnnRReluWithNoise, INPUT(self, noise, lower, nullptr, training, seed, offset), OUTPUT(out));
...
TEST_F(l2_rrelu_with_noise_test, case_nullptr_5)
{
    ...
    auto ut = OP_API_UT(aclnnRReluWithNoise, INPUT(self, noise, lower, nullptr, training, seed, offset),
                        OUTPUT(nullptr));
