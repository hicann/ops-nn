...
namespace domi {
// TensorFlow LeakyRelu uses attribute `alpha`, while the GE op expects `negative_slope`.
static Status ParseParamsLeakyRelu(const google::protobuf::Message* op_src, ge::Operator& op)
{
