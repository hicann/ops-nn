...
namespace ops {
static const std::vector<ge::DataType> geluV2DataType = {ge::DT_BF16, ge::DT_FLOAT16, ge::DT_FLOAT};
static const std::vector<ge::Format> geluV2Format = {ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND};
