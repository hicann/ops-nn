...
#define TPL_NO_CLAMP_MODE 0
#define TPL_CLAMP_MODE 1
...
ASCENDC_TPL_ARGS_DECL(ClippedSwiglu,
                      ...
                      ASCENDC_TPL_UINT_DECL(clampMode, 1, ASCENDC_TPL_UI_LIST, TPL_NO_CLAMP_MODE, TPL_CLAMP_MODE));
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ...
    ASCENDC_TPL_UINT_SEL(clampMode, ASCENDC_TPL_UI_LIST, TPL_NO_CLAMP_MODE, TPL_CLAMP_MODE)));
} // namespace ClippedSwigluOp
