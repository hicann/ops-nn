...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/activation/hard_sigmoid)
...
- **Parameters:**
  ...
  <tbody>
      ...
      <td>self</td>
      <td>Input</td>
      <td>Input of the activation function, corresponding to self in the formula.</td>
      <td><ul><li>The shape of self is the same as that of out. </li><li>Empty tensors are supported.</li></ul></td>
    ...
    <tr>
      <td>out</td>
      <td>Output</td>
      <td>Output of the activation function, corresponding to Hardsigmoid(self) in the formula.</td>
      <td>The data types and shapes of self and out must be the same.</td>
      <td>FLOAT, FLOAT16, INT32, BFLOAT16</td>
      <td>ND</td>
      <td>0–8</td>
      <td>√</td>
   ...
   - <term>Atlas training series products</term>: The data type can be FLOAT, FLOAT16, or INT32.
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnHardsigmoidGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
- **Parameters:**
  ...
  <tbody>
      ...
      <td>self</td>
      <td>Input</td>
      <td>Input self and output Hardsigmoid(self) in the formula.</td>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnInplaceHardsigmoidGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  // Call the first-phase API of aclnnHardsigmoid
  ...
  // Call the second-phase API of aclnnHardsigmoid.
...
int main() {
  ...
  // 3. Call the CANN operator library API.
  // Call the first-phase API of aclnnInplaceHardsigmoid.
  ...
  // Call the second-phase API of aclnnInplaceHardsigmoid.
