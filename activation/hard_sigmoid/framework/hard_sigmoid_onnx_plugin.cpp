...
REGISTER_CUSTOM_OP("HardSigmoid")
    .FrameworkType(ONNX)
    .OriginOpType({ge::AscendString("ai.onnx::1::HardSigmoid"), ge::AscendString("ai.onnx::6::HardSigmoid"),
                   ge::AscendString("ai.onnx::8::HardSigmoid"), ge::AscendString("ai.onnx::9::HardSigmoid"),
                   ge::AscendString("ai.onnx::10::HardSigmoid"), ge::AscendString("ai.onnx::11::HardSigmoid"),
                   ge::AscendString("ai.onnx::12::HardSigmoid"), ge::AscendString("ai.onnx::13::HardSigmoid"),
                   ge::AscendString("ai.onnx::14::HardSigmoid"), ge::AscendString("ai.onnx::15::HardSigmoid"),
                   ge::AscendString("ai.onnx::16::HardSigmoid"), ge::AscendString("ai.onnx::17::HardSigmoid"),
