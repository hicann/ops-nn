...
static bool CheckNotNull(const aclTensor* features, const aclTensor* labels, const aclTensor* loss,
                         const aclTensor* backprop)
{
...
static bool CheckDtypeValid(const aclTensor* features, const aclTensor* labels, const aclTensor* loss,
                            const aclTensor* backprop)
{
...
static bool CheckShape(const aclTensor* features, const aclTensor* labels, const aclTensor* loss,
                       const aclTensor* backprop)
{
...
static aclnnStatus CheckParams(const aclTensor* features, const aclTensor* labels, const aclTensor* loss,
                               const aclTensor* backprop)
{
    // 1. 检查参数是否为空指针
...
aclnnStatus ExecSoftmaxCrossEntropyWithLogitsGetWorkspaceSize(const aclTensor* features, const aclTensor* labels,
                                                              const aclTensor* loss, const aclTensor* backprop,
                                                              uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    // 调用l0算子GeGlu行计算
    auto SoftmaxCrossEntropyWithLogitsResult = l0op::SoftmaxCrossEntropyWithLogits(featuresContiguous, labelsContiguous,
                                                                                   uniqueExecutor.get());
...
aclnnStatus aclnnSoftmaxCrossEntropyWithLogitsGetWorkspaceSize(const aclTensor* features, aclTensor* labels,
...
aclnnStatus aclnnSoftmaxCrossEntropyWithLogits(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
