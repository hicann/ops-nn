...
int main()
{
    ...
    ret = aclnnSoftmaxCrossEntropyWithLogitsGetWorkspaceSize(features, labels, loss, backprop, &workspaceSize,
                                                             &executor);
    CHECK_RET(ret == ACL_SUCCESS,
              LOG_PRINT("aclnnSoftmaxCrossEntropyWithLogitsGetWorkspaceSize failed. ERROR: %d\n", ret);
              return ret);
