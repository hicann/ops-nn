...
/*!
 * \file sigmoid_tiling_key.h
 * \brief sigmoid tiling key declare
 */
...
ASCENDC_TPL_ARGS_DECL(Sigmoid, ASCENDC_TPL_UINT_DECL(schMode, 1, ASCENDC_TPL_UI_LIST, ELEMENTWISE_TPL_SCH_MODE_0,
