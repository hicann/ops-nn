        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                AscendC::Reg::Adds<float, float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg5, vreg4,
                                                                                       static_cast<float>(1), preg0);
                AscendC::Reg::Div<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg6, vreg1, vreg5, preg0);
                AscendC::Reg::Sub<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg7, vreg1, vreg6, preg0);
                AscendC::Reg::Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg8, vreg7, vreg2, preg0);
                AscendC::Reg::Add<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg9, vreg1, vreg8, preg0);
                AscendC::Reg::Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg10, vreg6, vreg9, preg0);
                AscendC::Reg::Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg11, vreg0, vreg10, preg0);
                AscendC::Reg::StoreAlign<float, AscendC::Reg::StoreDist::DIST_NORM_B32>(
                    bufferOut0Addr + i * (AscendC::VECTOR_REG_WIDTH / 4), vreg11, preg0);
            }
        }
