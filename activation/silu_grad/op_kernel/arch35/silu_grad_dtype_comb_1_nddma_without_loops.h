        ...
        __VEC_SCOPE__
        {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                AscendC::Reg::LoadAlign<float, AscendC::Reg::LoadDist::DIST_NORM>(
                    vreg3, bufferIn1Addr + i * (AscendC::VECTOR_REG_WIDTH / 4));
                ...
                AscendC::Reg::Adds<float, float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg6, vreg5,
                                                                                       static_cast<float>(1), preg0);
                AscendC::Reg::Div<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg7, vreg2, vreg6, preg0);
                AscendC::Reg::Sub<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg8, vreg2, vreg7, preg0);
                AscendC::Reg::Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg9, vreg8, vreg3, preg0);
                AscendC::Reg::Add<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg10, vreg2, vreg9, preg0);
                AscendC::Reg::Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg11, vreg7, vreg10, preg0);
                AscendC::Reg::Mul<float, AscendC::Reg::MaskMergeMode::ZEROING>(vreg12, vreg1, vreg11, preg0);
