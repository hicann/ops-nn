...
| --- | --- | --- | --- | --- |
| `23` | `torch.float8_e5m2` | PyTorch原生dtype int值 | `DT_FLOAT8_E5M2` / `ACL_FLOAT8_E5M2` | `0`、`1` |
| `24` | `torch.float8_e4m3fn` | PyTorch原生dtype int值 | `DT_FLOAT8_E4M3FN` / `ACL_FLOAT8_E4M3FN` | `0`、`1` |
