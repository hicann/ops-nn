...
/*!
 * \file test_confusion_softmax_grad_apt.cpp
 * \brief
 */
...
#include "confusion_softmax_grad_tiling_def.h"
...
class confusion_softmax_grad_test : public testing::Test {
protected:
    static void SetUpTestCase() { cout << "confusion_softmax_grad_test SetUp\n" << endl; }
    static void TearDownTestCase() { cout << "confusion_softmax_grad_test TearDown\n" << endl; }
};
                    ...
                    uint8_t* tiling)
{
    ...
    ICPU_RUN_KF(confusion_softmax_grad, realBlockNum, grad, x, y, workspace, tiling);
...
TEST_F(confusion_softmax_grad_test, test_ar_small_r_float32)
{
...
TEST_F(confusion_softmax_grad_test, test_ar_float32)
{
...
TEST_F(confusion_softmax_grad_test, test_ar_recompute_float32)
{
