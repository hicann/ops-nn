...
static ge::graphStatus InferShape4Shrink(gert::InferShapeContext* context)
{
    ...
    // Propagate empty tensor: if input has 0 elements, output is also empty
...
IMPL_OP_INFERSHAPE(Shrink).InferShape(InferShape4Shrink);
