...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBig<T, IS_ERF>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR gelu,
                                                                    GM_ADDR workspace,
                                                                    const GeGluV2TilingData* tilingData)
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBig<T, IS_ERF>::Process()
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBig<T, IS_ERF>::ProcessPerCore()
{
    // process core
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBig<T, IS_ERF>::CopyInX(const int64_t& idx_x, const int64_t& idx_y,
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBig<T, IS_ERF>::ComputeGeluAndMul(const int64_t& ub_num)
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBig<T, IS_ERF>::CopyOutGelu(const int64_t& idx_x, const int64_t& idx_y,
                                                                           const int64_t& length)
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Bf16AlignLastAxisBig<T, IS_ERF>::CopyOutMul(const int64_t& idx_x, const int64_t& idx_y,
                                                                          const int64_t& length)
{
