...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::Init(GM_ADDR x, GM_ADDR y, GM_ADDR gelu, GM_ADDR workspace,
                                                         const GeGluV2TilingData* tilingData)
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::Process()
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::ProcessPerCore()
{
    // process core
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::ProcessLastCore()
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::CopyInX(const int64_t& index, const int64_t& blockCount)
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::ComputeGelu(const int64_t& ub_num)
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::ComputeMul(const int64_t& ub_num)
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::CopyOutGelu(const int64_t& index, const int64_t& ub_num,
                                                                const int64_t& group)
{
...
template <typename T, bool IS_ERF>
__aicore__ inline void GeGluV2Fp16Align<T, IS_ERF>::CopyOutMul(const int64_t& index, const int64_t& ub_num,
                                                               const int64_t& group)
{
