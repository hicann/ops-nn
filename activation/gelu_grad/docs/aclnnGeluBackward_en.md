...
[📄 View source code](https://gitcode.com/cann/ops-nn/tree/master/activation/gelu_grad)
...
- Description: Performs backpropagation of [aclnnGelu](../../gelu/docs/aclnnGelu_en.md).
...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnGeluBackwardGetWorkspaceSize** is called to obtain the workspace size required for computation and the executor that contains the operator computation process. Then, **aclnnGeluBackward** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
      ...
      <td>gradOutput</td>
      <td>Input</td>
      <td>Weight for computing the gradient, that is, the weight tensor needed to convert a forward output tensor into a scalar.</td>
      ...
      <td>self</td>
      <td>Input</td>
      <td>Forward input value of Gelu.</td>
      ...
      <td>gradInput</td>
      <td>Output</td>
      <td>Backpropagation output, gradient value of the Gelu forward input parameter, and result of input deduction.</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The data type or format of gradOutput, self, or gradInput is not supported.</td>
    </tr>
    <tr>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnGeluBackwardGetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnGeluBackward.
  ...
  // Call the second-phase API of aclnnGeluBackward.
