...
/*!
 * \file test_geir_softmax_focal_loss.cpp
 * \brief GE graph construction sample for SoftmaxFocalLoss (arch35 ND format).
 */
#include <iostream>
#include <string.h>
#include <stdint.h>
...
#include "../op_graph/softmax_focal_loss_proto.h"
...
{
    Status ret = SUCCESS;
    auto op_node = op::SoftmaxFocalLoss("softmax_focal_loss_op");
    // ND 2D: [N, C], 归约轴为最后一维
