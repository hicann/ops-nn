...
static ge::graphStatus InferShapeSigmoidCrossEntropyWithLogitsGrad(gert::InferShapeContext* context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE(context, "context is nullptr"), return ge::GRAPH_FAILED);
    OP_LOGD(context->GetNodeName(), "Begin to do InferShapeSigmoidCrossEntropyWithLogitsGrad");
...
IMPL_OP_INFERSHAPE(SigmoidCrossEntropyWithLogitsGrad).InferShape(InferShapeSigmoidCrossEntropyWithLogitsGrad);
} // namespace ops
