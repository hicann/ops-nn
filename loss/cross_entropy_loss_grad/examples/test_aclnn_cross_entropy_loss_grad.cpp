...
int main()
{
    ...
    ret = aclnnCrossEntropyLossGradGetWorkspaceSize(gradLoss, logProb, target, weight, gradZloss, lseForZloss, "mean",
                                                    ignoreIndex, labelSmoothing, lseSquareScaleForZloss, xGradOut,
