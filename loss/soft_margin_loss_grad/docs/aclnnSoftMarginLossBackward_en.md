...
- **Parameters:**
  ...
  * **self** (aclTensor*, compute input): aclTensor on the device. Its shape and the shapes of **gradOutput** and **target** must meet the [broadcast relationship](../../../docs/en/context/broadcast_relationship.md). [Non-contiguous tensors](../../../docs/en/context/non_contiguous_tensors.md) are supported. The [data format](../../../docs/en/context/data_formats.md) can be ND.
    - <term>Atlas training series products</term>: The data type can be FLOAT16 or FLOAT.
    - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>: The data type can be FLOAT16, FLOAT, or BFLOAT16.
  * **target** (aclTensor*, compute input): aclTensor on the device. Its shape and the shapes of **gradOutput** and **self** must meet the [broadcast relationship](../../../docs/en/context/broadcast_relationship.md). [Non-contiguous tensors](../../../docs/en/context/non_contiguous_tensors.md) are supported. The [data format](../../../docs/en/context/data_formats.md) can be ND.
    - <term>Atlas training series products</term>: The data type can be FLOAT16 or FLOAT.
    - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>: The data type can be FLOAT16, FLOAT, or BFLOAT16.
  ...
  * **out** (aclTensor*, compute output): aclTensor on the device. Its shape must be the shape of **target**, **self**, or **gradOutput** after broadcasting. For details, see [broadcast relationship](../../../docs/en/context/broadcast_relationship.md). [Non-contiguous tensors](../../../docs/en/context/non_contiguous_tensors.md) are supported. The [data format](../../../docs/en/context/data_formats.md) can be ND.
    - <term>Atlas training series products</term>: The data type can be FLOAT16 or FLOAT.
    - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>: The data type can be FLOAT16, FLOAT, or BFLOAT16.
...
161002 (ACLNN_ERR_PARAM_INVALID): 1. The data type of gradOutput, self, target, or out is not supported.
                                     2. The shapes of gradOutput, self, target, and out do not meet the broadcast rules.
                                     3. The shape of gradOutput, self, or target after broadcasting is different from that of out.
```
