                                                    ...
                                                    int64_t reduction, aclTensor* out, aclOpExecutor* executor)
{
    ...
    if ((Ops::NN::AclnnUtil::IsRegbase() && posWeight != nullptr) || (!Ops::NN::AclnnUtil::IsRegbase())) {
                                                              ...
                                                              aclOpExecutor** executor)
{
    L2_DFX_PHASE_1(aclnnBinaryCrossEntropyWithLogits,
                   DFX_IN(self, target, weightOptional, posWeightOptional, reduction), DFX_OUT(out));
    ...
    // 开始bce with logits计算
    auto bceWithLogitsRet = BinaryCrossEntropyWithLogitsStub(self, target, weightOptional, posWeightOptional, reduction,
