...
- **Parameters:**
  ...
  - **self** (aclTensor*, compute input): input `self` in the formula, aclTensor on the device. Its data type and the data type of **gradOutput** and **target** must meet the type deduction rules (see [Deduction Relationship](../../../docs/en/context/deduction_relationship.md)). Its shape and the shape of **gradOutput** and **target** must meet the [broadcast relationship](../../../docs/en/context/broadcast_relationship.md). The shape must be less than nine dimensions. [Non-contiguous tensors](../../../docs/en/context/non_contiguous_tensors.md) are supported, and the [data format](../../../docs/en/context/data_formats.md) supports ND.
    - <term>Atlas training series products</term> and <term>Atlas inference series products</term>: The data type can be FLOAT16 or FLOAT32.
    - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>: The data type can be BFLOAT16, FLOAT16, or FLOAT32.
  - **target** (aclTensor*, compute input): input `target` in the formula, aclTensor on the device. Its data type and the data type of **self** and **gradOutput** must meet the type deduction rules (see [Deduction Relationship](../../../docs/en/context/deduction_relationship.md)). Its shape and the shape of **gradOutput** and **self** must meet the [broadcast relationship](../../../docs/en/context/broadcast_relationship.md). The shape must be less than nine dimensions. [Non-contiguous tensors](../../../docs/en/context/non_contiguous_tensors.md) are supported, and the [data format](../../../docs/en/context/data_formats.md) supports ND.
    - <term>Atlas training series products</term> and <term>Atlas inference series products</term>: The data type can be FLOAT16 or FLOAT32.
    - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>: The data type can be BFLOAT16, FLOAT16, or FLOAT32.
  ...
  - **gradInput** (aclTensor*, compute output): output `gradInput` in the formula, aclTensor on the device. Its data type and the data type of **self** must meet the type deduction rules (see [Deduction Relationship](../../../docs/en/context/deduction_relationship.md)). Its shape and the shape of **target**, **self**, and **gradOutput** must meet the [broadcast relationship](../../../docs/en/context/broadcast_relationship.md). The shape must be less than nine dimensions. [Non-contiguous tensors](../../../docs/en/context/non_contiguous_tensors.md) are supported, and the [data format](../../../docs/en/context/data_formats.md) supports ND.
    - <term>Atlas training series products</term> and <term>Atlas inference series products</term>: The data type can be FLOAT16 or FLOAT32.
    - <term>Atlas A2 training series products/Atlas A2 inference series products</term> and <term>Atlas A3 training series products/Atlas A3 inference series products</term>: The data type can be BFLOAT16, FLOAT16, or FLOAT32.
...
- **Returns:**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  161001 (ACLNN_ERR_PARAM_NULLPTR): 1. The passed gradOutput, self, target, or gradInput is a null pointer.
  161002 (ACLNN_ERR_PARAM_INVALID): 1. The data types of self, gradOutput, and target do not meet the type deduction rules.
                                       2. The deduced data types of gradOutput, target, and self are not supported.
                                       3. Broadcasting cannot be performed for the shapes of gradOutput, self, and target.
                                       4. gradOutput, self, and target each have more than eight dimensions.
                                       5. The broadcasted shape of gradOutput, self, and target is different from the shape of gradInput.
                                       6. The reduction value is not within the range of 0 to 2.
                                       7. The computation result cannot be cast to the dtype of gradInput.
  ```
