...
| [aclnnFusedSgd](../../optim/fused_adamw/docs/aclnnFusedAdamw.md) | 实现fusedadamw算子。将传统 adamw 更新过程中原本分散的多个细粒度操作（如梯度缩放、权重衰减、动量更新、参数赋值等）融合为单个NPU Kernel执行。 | 默认确定性实现 | 默认确定性实现 |
