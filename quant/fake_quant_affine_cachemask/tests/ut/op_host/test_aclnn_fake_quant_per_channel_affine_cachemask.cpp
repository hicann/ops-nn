...
protected:
    static void SetUpTestCase() { cout << "fake_quant_per_channel_affine_cachemask_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "fake_quant_per_channel_affine_cachemask_test TearDown" << endl; }
};
...
TEST_F(fake_quant_per_channel_affine_cachemask_test, case_norm_float32)
{
    ...
    auto ut = OP_API_UT(aclnnFakeQuantPerChannelAffineCachemask,
                        INPUT(selfDesc, scaleDesc, zeroPointDesc, axis, quant_min, quant_max),
