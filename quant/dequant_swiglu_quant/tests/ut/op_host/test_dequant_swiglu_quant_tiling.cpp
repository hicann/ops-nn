...
TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_30013)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .InputShapes({&xShape, &weightScaleShape, &activationScaleShape, nullptr, &quantScaleShape,
                                    nullptr, nullptr})
                      ...
                      .NodeAttrs({
                          {"activate_left", Ops::NN::AnyValue::CreateFrom<bool>(false)},
...
TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_not_support_bias)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeIoNum(7, 2)
                      .IrInstanceNum({1, 1, 1, 1, 1, 1, 1})
                      .InputShapes({&xShape, &weightScaleShape, &activationScaleShape, &xShape, &quantScaleShape,
                                    nullptr, &groupShape})
                      .OutputShapes({&yShape, &sCaleShape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
...
TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_x_dtype_int32_bias_dtype_bf16_qs_dtype_fp32)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeIoNum(7, 2)
                      .IrInstanceNum({1, 1, 1, 1, 1, 1, 1})
                      .InputShapes({&xShape, &weightScaleShape, &activationScaleShape, &biasShape, &quantScaleShape,
                                    nullptr, &groupShape})
                      .OutputShapes({&yShape, &sCaleShape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
...
TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_v35_notfull_1000100)
{
    gert::StorageShape xShape = {{210, 23456}, {210, 23456}};
    gert::StorageShape qScaleShape = {{11728}, {11728}};
    gert::StorageShape yShape = {{210, 11728}, {210, 11728}};
    gert::StorageShape scaleShape = {{210}, {210}};
    std::string compile_info_string = R"({
        "hardware_info": {"BT_SIZE": 0, "load3d_constraints": "1",
                          "Intrinsic_fix_pipe_l0c2out": false,
                          "Intrinsic_data_move_l12ub": true,
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("DequantSwigluQuant")
                      .NodeIoNum(2, 2)
                      .IrInstanceNum({1, 0, 0, 0, 1, 0, 0})
                      .InputShapes({&xShape, &qScaleShape})
                      .OutputShapes({&yShape, &scaleShape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
    ...
    // ASSERT_NE(tilingData, nullptr);
    auto tiling_key = tiling_context->GetTilingKey();
    // ASSERT_EQ(tiling_key, 1000100);
}

TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_v35_notfull_1011111)
{
    gert::StorageShape xShape = {{210, 23456}, {210, 23456}};
    gert::StorageShape wScaleShape = {{3, 23456}, {3, 23456}};
    gert::StorageShape aScaleShape = {{210}, {210}};
    gert::StorageShape biasShape = {{3, 23456}, {3, 23456}};
    gert::StorageShape qScaleShape = {{3, 1}, {3, 1}};
    gert::StorageShape qOffsetShape = {{3, 1}, {3, 1}};
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .NodeIoNum(7, 2)
                      .IrInstanceNum({1, 1, 1, 1, 1, 1, 1})
                      .InputShapes({&xShape, &wScaleShape, &aScaleShape, &biasShape, &qScaleShape, &qOffsetShape,
                                    &groupIndexShape})
                      .OutputShapes({&yShape, &scaleShape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
    ...
    // ASSERT_NE(tilingData, nullptr);
    auto tiling_key = tiling_context->GetTilingKey();
    // ASSERT_EQ(tiling_key, 1011111);
}

TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_v35_notfull_1010110)
{
    gert::StorageShape xShape = {{210, 23456}, {210, 23456}};
    gert::StorageShape wScaleShape = {{23456}, {23456}};
    gert::StorageShape biasShape = {{23456}, {23456}};
    gert::StorageShape qScaleShape = {{1, 11728}, {1, 11728}};
    gert::StorageShape qOffsetShape = {{1, 11728}, {1, 11728}};
    gert::StorageShape yShape = {{210, 11728}, {210, 11728}};
    gert::StorageShape scaleShape = {{210}, {210}};
    std::string compile_info_string = R"({
        "hardware_info": {"BT_SIZE": 0, "load3d_constraints": "1",
    ...
    auto holder = gert::TilingContextFaker()
                      .SetOpType("DequantSwigluQuant")
                      .NodeIoNum(5, 2)
                      .IrInstanceNum({1, 1, 0, 1, 1, 1, 0})
                      .InputShapes({&xShape, &wScaleShape, &biasShape, &qScaleShape, &qOffsetShape})
                      .OutputShapes({&yShape, &scaleShape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
    ...
    // ASSERT_NE(tilingData, nullptr);
    auto tiling_key = tiling_context->GetTilingKey();
    // ASSERT_EQ(tiling_key, 1010110);
}

TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_v35_notfull_1141100)
{
    gert::StorageShape xShape = {{210, 23456}, {210, 23456}};
    gert::StorageShape wScaleShape = {{1, 23456}, {1, 23456}};
    gert::StorageShape aScaleShape = {{210}, {210}};
    gert::StorageShape biasShape = {{1, 23456}, {1, 23456}};
    gert::StorageShape qScaleShape = {{1, 11728}, {1, 11728}};
    gert::StorageShape yShape = {{210, 11728}, {210, 11728}};
    gert::StorageShape scaleShape = {{210}, {210}};
    std::string compile_info_string = R"({
...
TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_requirement2_activation_scale_is_None)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .IrInstanceNum({1, 1, 1, 1, 1, 1, 1})
                      .InputShapes(
                          {&xShape, &weightScaleShape, nullptr, nullptr, &quantScaleShape, nullptr, &groupShape})
                      .OutputShapes({&yShape, &sCaleShape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
...
TEST_F(DequantSwigluQuantTiling, dequant_swiglu_quant_tiling_requirement3_quant_scale_nullptr)
{
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .IrInstanceNum({1, 1, 1, 1, 1, 1, 1})
                      .InputShapes(
                          {&xShape, &weightScaleShape, &activationScaleShape, nullptr, nullptr, nullptr, &groupShape})
                      .OutputShapes({&yShape, &sCaleShape})
                      .CompileInfo(&compile_info)
                      .PlatformInfo(reinterpret_cast<char*>(&platform_info))
                      .NodeInputTd(0, ge::DT_INT32, ge::FORMAT_ND, ge::FORMAT_ND)
...
// 测试合法的输入的数据类型: x_dtype_int32_bias_dtype_bf16_qs_dtype_fp32
TEST_F(DequantSwigluQuantTiling,
       dequant_swiglu_quant_tiling_x_dtype_int32_bias_dtype_bf16_qs_dtype_fp32_more_expert_fewer_tokens)
{
    string compile_info_string = R"({
       "hardware_info": {"BT_SIZE": 0, "load3d_constraints": "1",
                         "Intrinsic_fix_pipe_l0c2out": false, "Intrinsic_data_move_l12ub": true, "Intrinsic_data_move_l0c2ub": true, "Intrinsic_data_move_out2l1_nd2nz": false,
