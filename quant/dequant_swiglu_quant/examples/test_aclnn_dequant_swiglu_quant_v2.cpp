...
int main()
{
    ...
    ret = aclnnDequantSwigluQuantV2GetWorkspaceSize(
        x, weightScale, activationScale, bias, scale, nullptr, groupIndex, activateLeft, "dynamic", dstType, "rint",
        activateDim, swigluMode, clampLimit, gluAlpha, gluBias, out, scaleOut, &workspaceSize, &executor);
