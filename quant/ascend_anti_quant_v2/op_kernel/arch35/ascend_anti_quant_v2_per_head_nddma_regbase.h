...
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::Init(GM_ADDR x,
                                                                                                     GM_ADDR scale,
                                                                                                     GM_ADDR offset,
                                                                                                     GM_ADDR y)
{
    ...
    pipe_.InitBuffer(inQueueX_, bufferNum,
                     this->CeilAlign(tilingData_->baseN * tilingData_->baseLen * sizeof(xCopyDtype), this->BLOCK_SIZE));
    pipe_.InitBuffer(inQueueScale_, bufferNum,
    ...
    if constexpr (HasOffset) {
        ...
        pipe_.InitBuffer(inQueueOffset_, bufferNum,
                         this->CeilAlign(tilingData_->baseN * tilingData_->baseLen * sizeof(T2), this->BLOCK_SIZE));
    }

    pipe_.InitBuffer(outQueueY_, bufferNum,
                     this->CeilAlign(tilingData_->baseN * tilingData_->baseLen * sizeof(U), this->BLOCK_SIZE));
}

template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::Process()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::ProcessParamOneLoop(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
template <typename dtypeCopyIn>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::CopyInParam(
    ...
    int64_t paramOffset)
{
    ...
    NdDmaLoopInfo<AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM> multiCopyParams;
    ...
    AscendC::NdDmaParams<dtypeCopyIn, AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM> paramsMain = {
        multiCopyParams, constValue};
    AscendC::DataCopy<dtypeCopyIn, AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM, copyConfig>(
        paramLocal, inGm[paramOffset], paramsMain);
    inQueue.EnQue(paramLocal);
}

template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::ParseCoreBlocks(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::ProcessInputLoop(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::CopyInX(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::Compute(
        ...
        for (uint16_t i = 0; i < vfLoopNum; i++) {
            ...
            if constexpr (HasOffset) {
                ...
                if constexpr (IsSameType<T2, float>::value) {
                    // fp32
                    AscendC::Reg::LoadAlign<float, AscendC::Reg::LoadDist::DIST_NORM>(vregFloatO,
                                                                                      offsetLocalAddr + i * VL);
                } else if constexpr (IsSameType<T2, bfloat16_t>::value) {
                    // bf16
                    AscendC::Reg::LoadAlign<T2, AscendC::Reg::LoadDist::DIST_UNPACK_B16>(vregO,
                                                                                         offsetLocalAddr + i * VL);
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerHeadNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::CopyOutY(
