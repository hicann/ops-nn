...
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::Init(GM_ADDR x,
                                                                                                        GM_ADDR scale,
                                                                                                        GM_ADDR offset,
                                                                                                        GM_ADDR y)
{
    ...
    if constexpr (HasOffset) {
        ...
        pipe_.InitBuffer(inQueueOffset_, bufferNum_,
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::Process()
{
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::ParseCoreBlocks(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::CopyInScale(
    int64_t sLen, int64_t sInOffset)
{
    ...
    NdDmaLoopInfo<AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM> copyLoopInfo;
    ...
    T1 constValue = 0;
    AscendC::NdDmaParams<T1, AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM> copyParams = {copyLoopInfo,
                                                                                                          constValue};
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::CopyInOffset(
    int64_t sLen, int64_t sInOffset)
{
    ...
    T2 constValue = 0;
    AscendC::NdDmaParams<T2, AscendAntiQuantV2Base<T, T1, T2, U, SqrtMode>::MULTI_COPY_DIM> copyParams = {copyLoopInfo,
                                                                                                          constValue};
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::CopyXAndCompute(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::CopyInX(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::Compute(
...
template <typename T, typename T1, typename T2, typename U, uint64_t SqrtMode, uint64_t HasOffset>
__aicore__ inline void AscendAntiQuantV2PerChannelNddmaRegbase<T, T1, T2, U, SqrtMode, HasOffset>::CopyOutY(
