                                                ...
                                                GM_ADDR tiling)
{
    ...
    if constexpr (perMode == TPL_PER_TENSOR) {
        ...
        AscendAntiQuantV2PerTensorRegbase<DTYPE_X, DTYPE_SCALE, DTYPE_SCALE, DTYPE_Y, sqrtMode, zeroPointsType> op(
            &tilingData);
        ...
        REGISTER_TILING_DEFAULT(AscendAntiQuantV2TilingData);
        GET_TILING_DATA_WITH_STRUCT(AscendAntiQuantV2TilingData, tilingData, tiling);
        AscendAntiQuantV2PerChannelRegbase<DTYPE_X, DTYPE_SCALE, DTYPE_SCALE, DTYPE_Y, sqrtMode, zeroPointsType> op(
            &tilingData);
        op.Init(x, scale, offset, y);
        op.Process();
        ...
        REGISTER_TILING_DEFAULT(AscendAntiQuantV2TilingData);
        GET_TILING_DATA_WITH_STRUCT(AscendAntiQuantV2TilingData, tilingData, tiling);
        AscendAntiQuantV2PerHeadRegbase<DTYPE_X, DTYPE_SCALE, DTYPE_SCALE, DTYPE_Y, sqrtMode, zeroPointsType> op(
            &tilingData);
        op.Init(x, scale, offset, y);
        op.Process();
        ...
        REGISTER_TILING_DEFAULT(AscendAntiQuantV2TilingData);
        GET_TILING_DATA_WITH_STRUCT(AscendAntiQuantV2TilingData, tilingData, tiling);
        AscendAntiQuantV2PerChannelNddmaRegbase<DTYPE_X, DTYPE_SCALE, DTYPE_SCALE, DTYPE_Y, sqrtMode, zeroPointsType>
            op(&tilingData);
        op.Init(x, scale, offset, y);
        op.Process();
        ...
        REGISTER_TILING_DEFAULT(AscendAntiQuantV2TilingData);
        GET_TILING_DATA_WITH_STRUCT(AscendAntiQuantV2TilingData, tilingData, tiling);
        AscendAntiQuantV2PerHeadNddmaRegbase<DTYPE_X, DTYPE_SCALE, DTYPE_SCALE, DTYPE_Y, sqrtMode, zeroPointsType> op(
            &tilingData);
        op.Init(x, scale, offset, y);
        op.Process();
    }
