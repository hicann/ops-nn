 ...
 */
#ifndef ACLNN_GROUPED_DYNAMIC_MX_QUANT_V2_H_
#define ACLNN_GROUPED_DYNAMIC_MX_QUANT_V2_H_
 ...
 * @param [in] workspaceSize: 在npu device侧申请的workspace大小，由第一段接口aclnnGroupQuantV2GetWorkspaceSize获取。
