...
inline static aclnnStatus CheckParams(const aclTensor* x, const aclTensor* groupIndex, const char* roundMode,
                                      int64_t dstType, int64_t blocksize, const aclTensor* y, const aclTensor* mxscale)
{
...
aclnnStatus aclnnGroupedDynamicMxQuant(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
                                       aclrtStream stream)
{
