...
<table><colgroup>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>属性</td>
      <td>预留参数，scale_alg=2且dst_type=FLOAT4_E1M2时生效。<br>当前仅支持取值为0.0。</td>
      <td>FLOAT</td>
      <td>-</td>
    </tr>
    <tr>
...
| 调用方式 | 调用样例 | 说明 |
| :------- | :------- | :--- |
| aclnn调用 | [test_aclnn_swiglu_mx_quant_with_dual_axis](./examples/arch35/test_aclnn_swiglu_mx_quant_with_dual_axis.cpp) | 通过[aclnnSwigluMxQuantWithDualAxis](./docs/aclnnSwigluMxQuantWithDualAxis.md)接口方式调用SwigluMxQuantWithDualAxis算子。 |
