...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerChannelRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInX(int64_t xN,
                                                                                                      int64_t xLen,
                                                                                                      int64_t xInOffset)
{
        ...
        for (uint16_t j = 0; j < static_cast<uint16_t>(nRow); ++j) {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                if constexpr (IsSameType<T1, float>::value) {
                    ...
                    // fp16
                    AscendC::Reg::LoadAlign<half, AscendC::Reg::LoadDist::DIST_UNPACK_B16>(vregS,
                                                                                           scaleLocalAddr + i * VL);
                    AscendC::Reg::Cast<
                    ...
                    // bf16
                    AscendC::Reg::LoadAlign<T1, AscendC::Reg::LoadDist::DIST_UNPACK_B16>(vregS,
                                                                                         scaleLocalAddr + i * VL);
                    AscendC::Reg::Cast<
                ...
                if constexpr (IsSameType<T2, int32_t>::value) {
                    ...
                    // int8
                    AscendC::Reg::LoadAlign<T2, AscendC::Reg::LoadDist::DIST_UNPACK4_B8>(vregO,
                    ...
                    // fp32
                    AscendC::Reg::LoadAlign<T2, AscendC::Reg::LoadDist::DIST_NORM>(vregFloatO,
                                                                                   offsetLocalAddr + i * VL);
                }
                ...
                if constexpr (IsSameType<U, hifloat8_t>::value) {
                    ...
                    AscendC::Reg::StoreAlign<U, AscendC::Reg::StoreDist::DIST_PACK4_B32>(
                    ...
                    AscendC::Reg::Cast<
                        ...
                        vregY, vregFloatY, mask);
                    AscendC::Reg::StoreAlign<U, AscendC::Reg::StoreDist::DIST_NORM>(
                        outLocalAddr + i * VL + j * xLocalOffset, vregY, mask);
