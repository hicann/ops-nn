...
template <typename T, typename T1, typename T2, typename U, uint64_t DivMode, uint64_t RoundMode, uint64_t SqrtMode>
__aicore__ inline void QuantizePerTensorRegbase<T, T1, T2, U, DivMode, RoundMode, SqrtMode>::CopyInX(int64_t xN,
                                                                                                     int64_t xLen,
                                                                                                     int64_t xInOffset)
{
        ...
        for (uint16_t j = 0; j < static_cast<uint16_t>(nRow); ++j) {
            ...
            for (uint16_t i = 0; i < vfLoopNum; i++) {
                ...
                if constexpr (IsSameType<T1, float>::value) {
                    ...
                    // fp16
                    AscendC::Reg::LoadAlign<half, AscendC::Reg::LoadDist::DIST_BRC_B16>(vregS, scaleLocalAddr);
                    AscendC::Reg::Cast<
                ...
                if constexpr (IsSameType<T2, int32_t>::value) {
                    // int32
                    AscendC::Reg::LoadAlign<T2, AscendC::Reg::LoadDist::DIST_BRC_B32>(vregO, offsetLocalAddr);
                    AscendC::Reg::Cast<
                    ...
                    // int8
                    AscendC::Reg::LoadAlign<T2, AscendC::Reg::LoadDist::DIST_BRC_B8>(vregO, offsetLocalAddr);
                    AscendC::Reg::Cast<
                    ...
                    // fp32
                    AscendC::Reg::LoadAlign<T2, AscendC::Reg::LoadDist::DIST_BRC_B32>(vregFloatO, offsetLocalAddr);
                }
