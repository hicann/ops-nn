...
/*!
 * \file act_ulq_clamp_max_grad_tiling_key.h
 * \brief ActULQClampMaxGrad TilingKey 模板参数声明（arch35 / RegBase）。
 *
 ...
 *   DTYPE_CLAMP_MAX_MASK（mask 承载 fp16/fp32/uint8）编译期实例化（跨 H4 不变量 #1）。
 *
 * ✅ 使用 ASCENDC_TPL_ARGS_DECL 模板编程方式
 * ❌ 禁止使用废弃的 TILING_KEY_IS 宏
 */
#ifndef OPS_ACT_ULQ_CLAMP_MAX_GRAD_TILING_KEY_H_
#define OPS_ACT_ULQ_CLAMP_MAX_GRAD_TILING_KEY_H_

#include "ascendc/host_api/tiling/template_argument.h"

ASCENDC_TPL_ARGS_DECL(ActULQClampMaxGrad, ASCENDC_TPL_BOOL_DECL(templateType, 0, 1), // 0=normal/empty, 1=group
...
#endif // OPS_ACT_ULQ_CLAMP_MAX_GRAD_TILING_KEY_H_
