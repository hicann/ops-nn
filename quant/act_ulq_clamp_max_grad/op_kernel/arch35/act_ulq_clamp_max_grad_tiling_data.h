...
/*!
 * \file act_ulq_clamp_max_grad_tiling_data.h
 * \brief ActULQClampMaxGrad 算子 TilingData 定义（arch35 / RegBase）。
 *
 ...
 *   - group 模板：rGroupCnt
 */
#ifndef OPS_ACT_ULQ_CLAMP_MAX_GRAD_TILING_DATA_H_
#define OPS_ACT_ULQ_CLAMP_MAX_GRAD_TILING_DATA_H_
...
struct ActULQClampMaxGradTilingData {
...
#endif // OPS_ACT_ULQ_CLAMP_MAX_GRAD_TILING_DATA_H_
