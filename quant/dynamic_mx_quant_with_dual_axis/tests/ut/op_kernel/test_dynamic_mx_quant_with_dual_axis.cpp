...
// scaleAlg=2 (DynamicDtypeRange) + FP4_E2M1 + 默认dstTypeMax
TEST_F(dynamic_mx_quant_with_dual_axis_test, test_case_scaleAlg2_fp4_e2m1_default)
{
    size_t inputXSize = 128 * 256 * sizeof(half);
    size_t outputY1 = 128 * 256 * sizeof(int8_t);
    size_t outputScale1 = 128 * 4 * 2 * sizeof(int8_t);
    ...
    tilingDatafromBin->usedCoreNum = 2;
    tilingDatafromBin->roundMode = 4;
    tilingDatafromBin->dstType = 40;
    tilingDatafromBin->scaleAlg = 2;
    tilingDatafromBin->blockSize = 32;
    tilingDatafromBin->dim0 = 1;
    tilingDatafromBin->dimNeg2 = 128;
    tilingDatafromBin->dimNeg1 = 256;
...
// scaleAlg=2 (DynamicDtypeRange) + FP4_E2M1 + 自定义dstTypeMax=8.0
TEST_F(dynamic_mx_quant_with_dual_axis_test, test_case_scaleAlg2_fp4_e2m1_custom)
{
    size_t inputXSize = 128 * 256 * sizeof(half);
    size_t outputY1 = 128 * 256 * sizeof(int8_t);
    size_t outputScale1 = 128 * 4 * 2 * sizeof(int8_t);
    ...
    tilingDatafromBin->scale1ColCountPerBatch = 8;
    tilingDatafromBin->scale2RowCountPerBatch = 4;
    tilingDatafromBin->dstTypeMax = 8.0f;
    tilingDatafromBin->invDstTypeMax = 1.0f / 8.0f;
...
// scaleAlg=2 (DynamicDtypeRange) + FP4_E2M1 + dstTypeMax=7.0 + floor roundMode
TEST_F(dynamic_mx_quant_with_dual_axis_test, test_case_scaleAlg2_fp4_e2m1_dst7_floor)
{
    size_t inputXSize = 128 * 256 * sizeof(half);
    size_t outputY1 = 128 * 256 * sizeof(int8_t);
    size_t outputScale1 = 128 * 4 * 2 * sizeof(int8_t);
    ...
    tilingDatafromBin->scale1ColCountPerBatch = 8;
    tilingDatafromBin->scale2RowCountPerBatch = 4;
    tilingDatafromBin->dstTypeMax = 7.0f;
    tilingDatafromBin->invDstTypeMax = 1.0f / 7.0f;
