...
Each operator has [two-phase API](../../../docs/en/context/two_phase_api.md) calls. First, **aclnnTransQuantParamV2GetWorkspaceSize** is called to obtain the workspace size required for computation and the executor that contains the operator computation process. Then, **aclnnTransQuantParamV2** is called to perform computation.
...
- **Parameters:**
  ...
  <tbody>
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>Ensure that NaN and inf do not exist in the data of scale. </li><li>For details about the constraints for shape, see <a href="#constraints">Constraints</a>.</li></ul></td>
      <td>FLOAT32</td>
      <td>ND</td>
      <td>1-2</td>
      <td>×</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>Ensure that NaN and inf do not exist in the data of offset. </li><li>For details about the constraints for shape, see <a href="#constraints">Constraints</a>.</li></ul></td>
      <td>FLOAT32</td>
      <td>ND</td>
      <td>1-2</td>
      <td>×</td>
    ...
    <tr>
      ...
      <td><ul><li>Empty tensors are not supported. </li><li>For details about the constraints for shape, see <a href="#constraints">Constraints</a>.</li></ul></td>
      <td>UINT64, INT64</td>
      <td>ND</td>
      <td>1-2</td>
      <td>√ </td>
...
- **Returns:**
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <tbody>
    ...
    <tr>
      <td>The error is reported if the shape of offset is not (t,) or (1, n), where t = 1 or n, and n is the same as that of x2 in the matmul computation (or the same as the shape n of the right matrix (corresponding to weight) in the grouped matmul computation).</td>
    </tr>
    <tr>
      <td>The error is reported if the shape of scale is not one-dimensional (t,), (g,), or two-dimensional (1, n), (g, 1), or (g, n), where t = 1 or n, n is the same as that of x2 in the matmul computation (or the same as the shape n of the right matrix (corresponding to weight) in the grouped matmul computation), and g is the same as the number of groups (corresponding to the shape size of groupListOptional) in the grouped matmul computation.</tr>
  </tbody></table>
...
- **Parameters:**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by the first-phase API aclnnTransQuantParamV2GetWorkspaceSize.</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>Input</td>
