...
#ifndef SITU_MX_QUANT_TILING_DEF_H_
#define SITU_MX_QUANT_TILING_DEF_H_
...
struct SituMxQuantTilingDataMock {
    uint32_t reverse;
};
...
#define GET_TILING_DATA(tilingData, tilingPointer)                                 \
    SituMxQuantTilingDataMock tilingData;                                          \
    INIT_TILING_DATA(SituMxQuantTilingDataMock, tilingDataPointer, tilingPointer); \
...
// Default dtype macros — can be overridden per test via #undef/#define
#define DTYPE_X bfloat16_t
#define DTYPE_Y fp8_e4m3fn_t

#endif // SITU_MX_QUANT_TILING_DEF_H_
