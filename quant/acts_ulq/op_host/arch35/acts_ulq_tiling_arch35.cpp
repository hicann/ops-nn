...
bool FindSplitAxis(const std::vector<int64_t>& max_bro_shape, int64_t ub_per_core, int64_t phys_nodes, SplitResult& out)
{
...
ge::graphStatus ActsUlqTiling::DoTilingAndSet()
{
    ...
    bool is_fp16 = (inputTensor != nullptr && inputTensor->GetDataType() == ge::DataType::DT_FLOAT16);
