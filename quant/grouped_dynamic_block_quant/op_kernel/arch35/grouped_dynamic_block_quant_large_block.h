...
private:
    ...
    __aicore__ inline void ComputeXTmpMax(int64_t rowNum, int64_t colNum, __ubuf__ T* xLocalAddr,
                                          __ubuf__ T* xLocalMaxTmp);
    __aicore__ inline void ComputeScaleVF(__ubuf__ float* scaleLocalTmp, __ubuf__ T* xLocalMaxTmp);
    __aicore__ inline void ComputeOutVF(int64_t xTotalNum, __ubuf__ T* xLocalAddr, __ubuf__ float* scaleLocal,
                                        __ubuf__ U* outLocal);
