...
[📄 查看源码](https://gitcode.com/cann/ops-nn/tree/master/quant/swiglu_backward_mx_quant_with_dual_axis)
...
每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnSwigluBackwardMxQuantWithDualAxisGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnSwigluBackwardMxQuantWithDualAxis”接口执行计算。
