...
TEST_F(conv3d_transpose_v2_test, test_conv3d_dx_17) {
    ...
    system("cp -r ../../../../conv/conv3d_transpose_v2/tests/ut/op_kernel/conv3d_transpose_v2/conv3d_transpose_v2_data ./");
...
TEST_F(conv3d_transpose_v2_test, test_group_1) {
    ...
    system("cp -r ../../../../../../../ops/built-in/tests/ut/fast_op_test/conv3d_transpose_v2/conv3d_transpose_v2_data ./");
    system("chmod -R 755 ./conv3d_transpose_v2_data/");
    system("cd ./conv3d_transpose_v2_data/ && rm -rf ./*bin");
