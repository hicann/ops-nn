...
public:
    ...
    __aicore__ inline void SetSingleShapeK(uint64_t singleCoreK)
    {
        using Local = typename Ext::SetSingleShapeK;
        if constexpr (CHECK_FUN(Local, ConvolutionBackpropFunc, this, singleCoreK)) {
            Local::call(this, singleCoreK);
        }
    }
