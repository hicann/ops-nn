...
#define CONV2D_INNER_BATCH_WEIGHT_UB_ONLY_MN_FULLLOAD_SEL()                                                          \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),                                                            \
        ...
        CONV2D_COMMON_INNER_BATCH_WEIGHT_UB_SEL(), CONV2D_SCALAR_OPT_SEL_NK(CONV_NOT_SMALL_WEIGHT)
...
#define CONV_INNER_BATCH_ONLY_MN_FULLLOAD_SEL()                                                                      \
    ASCENDC_TPL_UINT_SEL(FmapTiling, ASCENDC_TPL_UI_LIST, CONV_FMAP_TILING_ONLY_M_FULLLOAD_AL1_AL0),                 \
        ...
        ASCENDC_TPL_UINT_SEL(IterOrder, ASCENDC_TPL_UI_LIST, CONV_ITER_ORDER_MITER_FIRST,                            \
                             CONV_ITER_ORDER_NITER_FIRST),                                                           \
        CONV_COMMON_INNER_BATCH_SEL(), CONV2D_SCALAR_OPT_SEL_NK(CONV_NOT_SMALL_WEIGHT)
...
#define CONV_INNER_BATCH_ONLY_BL1_FULLLOAD_SEL()                                                                      \
    ASCENDC_TPL_UINT_SEL(FmapTiling, ASCENDC_TPL_UI_LIST, CONV_FMAP_TILING_OTHER),                                    \
        ...
        CONV2D_SCALAR_OPT_SEL_NK(CONV_NOT_SMALL_WEIGHT, CONV_FULLLOAD_KL1_NL0, CONV_WEIGHT_SMALLER_THAN_BL0)
...
#define CONV_INNER_BATCH_NO_FULLLOAD_AL0_OPEN_ENABLE_C04_SEL()                                                       \
    ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),                                                            \
        ...
        ASCENDC_TPL_UINT_SEL(InnerBatch, ASCENDC_TPL_UI_LIST, CONV_INNER_BATCH_KERNEL_1X1_MULTI,                     \
                             CONV_INNER_BATCH_MULTI),                                                                \
        ASCENDC_TPL_UINT_SEL(DisContinuous, ASCENDC_TPL_UI_LIST, CONV_DIS_CONTINUOUS_CLOSE),                         \
        CONV2D_SCALAR_OPT_SEL_NK(CONV_NOT_SMALL_WEIGHT)
