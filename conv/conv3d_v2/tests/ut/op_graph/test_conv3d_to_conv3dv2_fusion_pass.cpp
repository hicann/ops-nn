        ...
        switch (profile) {
            ...
            case SocProfile::Reject310B1:
                SetSocRaw("Ascend310B1",
                          {{"Intrinsic_fix_pipe_l0c2out", {"bfloat16"}}, {"Intrinsic_fix_pipe_l0c2ub", {"bfloat16"}}});
                break;
...
protected:
    ...
    void SetConv3DDynamicShapes(TestGraph& testGraphBuilder, const std::string& nodeName, DataType dtype, Format format,
                                bool dynamicFmap, bool dynamicFilter, bool dynamicBias = false)
    {
    ...
    GraphPtr BuildFp16Conv3DWithIfmrAdd(TestGraph& testGraphBuilder)
    {
        ...
        return testGraphBuilder.AddConv3D(Conv3DConfig::Basic("Conv3D", DT_FLOAT16, FORMAT_NCDHW))
    ...
    GraphPtr BuildConv3DWithTransData(TestGraph& testGraphBuilder, int64_t originC, SocProfile soc)
    {
        ...
        auto graph = testGraphBuilder.AddTransData(TransDataConfig::NdhwcToNdc1hwc0("TransData", DT_FLOAT16, originC))
...
TEST_F(Conv3dToConv3dV2FusionPassTest, conv3d_to_conv3dv2_no_fusion)
{
    struct Point {
        ...
        {"nonarch35_bf16_bad_bias",
         [this]() {
             return BuildSingleConvGraph("conv3d_to_conv3dv2_no_fusion_nonarch35_bf16_bad_bias", SocProfile::NonArch35,
                                         Conv3DConfig::Basic("Conv3D", DT_BF16).WithBias(DT_BF16));
         }},
        {"nonarch35_bf16_dynamic",
         [this]() {
        ...
        {"nonarch35_bf16_fixpipe",
         [this]() {
             ApplySoc(SocProfile::NonArch35);
             TestGraph builder("conv3d_to_conv3dv2_no_fusion_nonarch35_bf16_fixpipe");
             const std::vector<int64_t> outShape = {1, 16, 16, 244, 244};
             auto graph = builder.AddConv3D(Conv3DConfig::Basic("Conv3D", DT_BF16))
        ...
        {"nonarch35_fp32_fixpipe",
         [this]() {
             ApplySoc(SocProfile::NonArch35);
             TestGraph builder("conv3d_to_conv3dv2_no_fusion_nonarch35_fp32_fixpipe");
             const std::vector<int64_t> outShape = {1, 16, 16, 244, 244};
             auto graph = builder.AddConv3D(Conv3DConfig::Basic("Conv3D", DT_FLOAT))
...
TEST_F(Conv3dToConv3dV2FusionPassTest, conv3d_to_conv3dv2_replacement_attr_and_desc)
{
    struct Point {
        ...
        {"pad_mode_from_padding_explicit",
         [this]() {
             auto config = Conv3DConfig::Basic("Conv3D", DT_FLOAT, FORMAT_NCDHW);
             config.SetAttr("padding", std::string("EXPLICIT"));
             return BuildSingleConvGraph("conv3d_to_conv3dv2_pad_mode_from_padding_explicit", SocProfile::Arch35,
                                         config);
         },
         [](GNode& fused) {
             AscendString padMode;
        ...
        {"enable_hf32_false_nonarch35",
         [this]() {
             auto config = Conv3DConfig::Basic("Conv3D", DT_FLOAT);
             config.SetAttr("_op_impl_mode_enum", int64_t(0x40));
             return BuildSingleConvGraph("conv3d_to_conv3dv2_enable_hf32_false_nonarch35", SocProfile::NonArch35,
                                         config);
         },
         [](GNode& fused) {
        ...
        {"attr_strides_pads_dilations_groups",
         [this]() {
             ...
             return BuildSingleConvGraph("conv3d_to_conv3dv2_attr_strides_pads_dilations_groups", SocProfile::Arch35,
                                         config);
         },
         [](GNode& fused) {
        ...
        {"desc_input_output_preserved",
         [this]() {
             return BuildSingleConvGraph("conv3d_to_conv3dv2_desc_input_output_preserved", SocProfile::Arch35,
                                         Conv3DConfig::Basic("Conv3D", DT_FLOAT16, FORMAT_NCDHW, {1, 16, 16, 240, 352},
                                                             {3, 16, 3, 3, 3}, {1, 3, 16, 240, 352}));
         },
         [](GNode& fused) {
...
TEST_F(Conv3dToConv3dV2FusionPassTest, conv3d_to_conv3dv2_graph_topology)
{
    struct {
        ...
        {"dynamic_shape_fp16",
         [](Conv3dToConv3dV2FusionPassTest& self) {
        ...
        {"multi_conv3d_same_graph",
         [](Conv3dToConv3dV2FusionPassTest& self) {
             self.ApplySoc(SocProfile::Arch35);
             TestGraph builder("conv3d_to_conv3dv2_graph_topology_multi_conv3d_same_graph");
             auto graph = builder.AddConv3D(Conv3DConfig::Basic("Conv3D_1", DT_FLOAT16, FORMAT_NCDHW))
        ...
        {"multi_conv3d_serial",
         [](Conv3dToConv3dV2FusionPassTest& self) {
             ...
             auto graph = builder.AddConv3D(Conv3DConfig::Basic("Conv3D_1", DT_FLOAT16, FORMAT_NCDHW))
                              .AddConv3D(Conv3DConfig::Basic("Conv3D_2", DT_FLOAT16, FORMAT_NCDHW, {1, 3, 16, 244, 244},
                                                             {3, 3, 3, 3, 3}, {1, 3, 16, 244, 244}))
        ...
        {"multi_conv3d_mixed_eligibility",
         [](Conv3dToConv3dV2FusionPassTest& self) {
             self.ApplySoc(SocProfile::Arch35);
             TestGraph builder("conv3d_to_conv3dv2_graph_topology_multi_conv3d_mixed_eligibility");
             auto graph = builder.AddConv3D(Conv3DConfig::Basic("Conv3D_ok", DT_FLOAT16, FORMAT_NCDHW))
