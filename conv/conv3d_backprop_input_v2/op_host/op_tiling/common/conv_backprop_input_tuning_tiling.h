...
DECLARE_SCHEMA(
    Conv3DBackpropInputTunerTiling, FIELD(Conv3DBackpropInputTunerTiling, al0Pbuffer),
    FIELD(Conv3DBackpropInputTunerTiling, bl0Pbuffer), FIELD(Conv3DBackpropInputTunerTiling, cl0Pbuffer),
    FIELD(Conv3DBackpropInputTunerTiling, al1Pbuffer), FIELD(Conv3DBackpropInputTunerTiling, bl1Pbuffer),
    FIELD(Conv3DBackpropInputTunerTiling, iterateOrder), FIELD(Conv3DBackpropInputTunerTiling, c0),
    ...
    FIELD(Conv3DBackpropInputTunerTiling, backpropPadTail), FIELD(Conv3DBackpropInputTunerTiling, backpropPadUp),
    FIELD(Conv3DBackpropInputTunerTiling, backpropPadDown), FIELD(Conv3DBackpropInputTunerTiling, backpropPadLeft),
    FIELD(Conv3DBackpropInputTunerTiling, backpropPadRight), FIELD(Conv3DBackpropInputTunerTiling, singleCoreGroup),
    FIELD(Conv3DBackpropInputTunerTiling, singleCoreCout), FIELD(Conv3DBackpropInputTunerTiling, singleCoreCin),
    FIELD(Conv3DBackpropInputTunerTiling, singleCoreDin), FIELD(Conv3DBackpropInputTunerTiling, baseM),
    ...
    FIELD(Conv3DBackpropInputTunerTiling, enableC04Flag), FIELD(Conv3DBackpropInputTunerTiling, enableFullLoadTiling),
