...
#define REGISTER_DX_IMPL(name, context, impl, intf)                                                               \
    template <class X_T, class W_TYPE, class DEDY_T, class Y_T, class BIAS_T, class SCALE_T,                      \
              const Conv3dConfig& CONV3D_CONFIG = CONV3D_CFG_DEFAULT, class Y1_T = Y_T, class SCALE1_T = SCALE_T> \
    using name = intf<context<X_T, W_TYPE, DEDY_T, Y_T, BIAS_T, SCALE_T, CONV3D_CONFIG, Y1_T, SCALE1_T>, impl>
} // namespace Convolution3DBackprop
#endif
