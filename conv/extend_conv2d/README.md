...
<td>clip_value0</td>
<td>可选输入</td>
<td>输出0对应的截断值clip_value0（未使用）。</td>
...
<td>clip_value1</td>
<td>可选输入</td>
<td>输出1对应的截断值clip_value1（未使用）。</td>
<td>FLOAT16、HIFLOAT8、INT8、FLOAT8_E4M3FN、BFLOAT16</td>
<td>ND</td>
</tr>
<tr>
...
<td>groups</td>
<td>可选属性</td>
<td>从输入通道到输出通道的块链接个数，必须满足groups × filter的in_channels维度 = x的in_channels维度，且filter的out_channels必须是groups的倍数。支持范围 [1, 65535]。</td>
<td>INT32</td>
<td>-</td>
</tr>
<tr>
...
<td>enable_hf32</td>
<td>可选属性</td>
<td>表示是否启用hf32计算，支持true、false。该参数暂不支持。</td>
<td>BOOL</td>
<td>-</td>
</tr>
<tr>
<td>enable_relu0</td>
<td>可选属性</td>
<td>表示是否为第0个输出启用relu计算，支持true、false。</td>
<td>BOOL</td>
<td>-</td>
</tr>
<tr>
<td>enable_relu1</td>
<td>可选属性</td>
<td>表示是否为第1个输出启用relu计算，支持true、false。</td>
<td>BOOL</td>
<td>-</td>
</tr>
<tr>
...
| 调用方式 | 调用样例                                                                   | 说明                                                             |
|--------------|------------------------------------------------------------------------|----------------------------------------------------------------|
| aclnn调用 | [test_aclnn_extend_conv2d](./examples/arch35/test_aclnn_extend_conv2d.cpp) | 通过 [aclnnQuantConvolution](../convolution_forward/docs/aclnnQuantConvolution.md)接口方式调用extend_conv2d算子。
