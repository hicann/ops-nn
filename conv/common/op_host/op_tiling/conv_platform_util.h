...
class PlatformUtil {
public:
    static void ParseRuntimePlatformInfo(Conv3DBackpropV2CompileInfo& compileInfo, const char* op_name,
...
private:
    ...
    static void GetAICoreIntrinsicDtype(fe::PlatFormInfos& platform_info, const std::string& intrinsic_name,
                                        bool& value);
};
