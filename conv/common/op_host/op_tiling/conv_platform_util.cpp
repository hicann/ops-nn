...
void PlatformUtil::ParseRuntimePlatformInfo(Conv3DBackpropV2CompileInfo& compileInfo, const char* op_name,
                                            fe::PlatFormInfos& platform_info)
{
    ...
    OP_LOGD(op_name,
            ...
            compileInfo.l0b_size, compileInfo.l0c_size, compileInfo.bt_size);
    OP_LOGD(op_name, "The platform info of soc version: %s, cube_freq %i", compileInfo.soc_version.c_str(),
            compileInfo.cube_freq);

    GetChipFeature(platform_info, "AICoreintrinsicDtypeMap", "Intrinsic_data_move_l12bt", "bf16",
                   compileInfo.intrinsic_data_move_l12bt_bf16);
    ...
    GetAICoreIntrinsicDtype(platform_info, "Intrinsic_data_move_out2l1_nd2nz",
                            compileInfo.intrinsic_data_move_out2l1_nd2nz);
