...
TEST_F(MaskedScatterV1Tiling, test_masked_scatter_tilingKey0)
{
    std::string op_type("MaskedScatter");
    ...
    gert::StorageShape x_shape = {{32, 57}, {32, 57}};
    gert::StorageShape mask_shape = {{32, 1}, {32, 1}};
    gert::StorageShape updates_shape = {{32, 57}, {32, 57}};
    gert::StorageShape y_shape = {{32, 57}, {32, 57}};
...
TEST_F(MaskedScatterV1Tiling, test_masked_scatter_tilingKey1)
{
    std::string op_type("MaskedScatter");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    auto workspace_size_holer = gert::ContinuousVector::Create<size_t>(4096);
    auto ws_size = reinterpret_cast<gert::ContinuousVector*>(workspace_size_holer.get());
    gert::StorageShape x_shape = {{32, 257}, {32, 257}};
    gert::StorageShape mask_shape = {{32, 1}, {32, 1}};
    gert::StorageShape updates_shape = {{32, 257}, {32, 257}};
    gert::StorageShape y_shape = {{32, 257}, {32, 257}};
