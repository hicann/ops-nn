...
void ScatterNdCommonSimtSortTiling::CalcTilingWhenTight(
    int64_t halfUbSize, int64_t indicesAlignSize, ge::DataType sortTmpType)
{
...
// 处理ub空间充裕时的分块策略
void ScatterNdCommonSimtSortTiling::CalcTilingWhenSpacious(
    int64_t halfUbSize, int64_t ubBlock, int64_t indicesAlignSize, int64_t updateAlignSize, ge::DataType sortTmpType)
{
    int64_t alignNum = ALIGN_SIZE / varTypeSize_;
    int64_t indicesDtypeCastSize = indiceCastMode_ ? indiceCastDtypeSize_ : 0;
    int64_t indicesRealTypeSize = indiceCastMode_ ? indiceCastDtypeSize_ : indicesTypeSize_;
