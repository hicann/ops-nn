...
#include "../op_graph/non_zero_with_value_shape_v2_proto.h"
                ...
                std::vector<ge::Operator>& graphOutputs, ge::Graph& graph)
{
    ...
    auto nonZeroWithValueShapeV2 = ge::op::NonZeroWithValueShapeV2("non_zero_with_value_shape_v2");
    nonZeroWithValueShapeV2.set_input_value(valueData);
    nonZeroWithValueShapeV2.set_input_index(indexData);
    nonZeroWithValueShapeV2.set_input_count(countData);
    ...
    graphOutputs.push_back(nonZeroWithValueShapeV2);
    return kSuccess;
}
...
int main()
{
    std::cout << GetTime() << " - INFO - Start NonZeroWithValueShapeV2 GEIR example" << std::endl;
    ...
    ge::Graph graph("non_zero_with_value_shape_v2_graph");
    ...
    std::cout << GetTime() << " - INFO - NonZeroWithValueShapeV2 GEIR example success" << std::endl;
    return kSuccess;
}
