...
protected:
    static void SetUpTestCase() { cout << "l2_nanmedian_dim_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "l2_nanmedian_dim_test TearDown" << endl; }
};
...
TEST_F(l2_nanmedian_dim_test, aclnnNanMedianDim_test_zero_dim_tensor)
{
    ...
    auto ut = OP_API_UT(aclnnNanMedianDim, INPUT(self_tensor_desc, dim, keepdim),
