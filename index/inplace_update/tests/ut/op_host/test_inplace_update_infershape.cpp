...
protected:
    static void SetUpTestCase() { std::cout << "InplaceUpdate Infershape Test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "InplaceUpdate Infershape Test TearDown" << std::endl; }
};
