...
protected:
    static void SetUpTestCase() { std::cout << "ScatterListTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "ScatterListTiling TearDown" << std::endl; }
};
...
TEST_F(ScatterListTiling, test_tiling_updates_dims_too_large)
{
    std::string op_type("ScatterList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape varShape = {{2, 256, 128}, {2, 256, 128}};
    gert::StorageShape indiceShape = {{1}, {1}};
    gert::StorageShape updatesShape = {{1, 2, 256, 128, 4}, {1, 2, 256, 128, 4}};
    gert::StorageShape maskShape = {{1}, {1}};
    string reduction = "update";
    int64_t axis = -1;
...
TEST_F(ScatterListTiling, test_tiling_updates_dims_too_small)
{
    std::string op_type("ScatterList");
    ASSERT_NE(gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str()), nullptr);
    auto tiling_func = gert::OpImplRegistry::GetInstance().GetOpImpl(op_type.c_str())->tiling;
    ...
    gert::StorageShape varShape = {{2, 256, 128}, {2, 256, 128}};
    gert::StorageShape indiceShape = {{1}, {1}};
    gert::StorageShape updatesShape = {{1, 2}, {1, 2}};
    gert::StorageShape maskShape = {{1}, {1}};
    string reduction = "update";
    int64_t axis = -1;
