...
#define USS_TEMPLATE_INPUT_PART 6
#define USS_TEMPLATE_SEGMENT_SORT 7
#define USS_TEMPLATE_OUT_FL_WS_MERGE 8
...
ASCENDC_TPL_ARGS_DECL(UnsortedSegmentProd,
                      ASCENDC_TPL_UINT_DECL(TEMPLATE_MODE, 4, ASCENDC_TPL_UI_LIST, USS_TEMPLATE_SIMT,
                                            ...
                                            USS_TEMPLATE_INPUT_PART, USS_TEMPLATE_SEGMENT_SORT,
                                            USS_TEMPLATE_OUT_FL_WS_MERGE),
                      ASCENDC_TPL_UINT_DECL(CAST_MODE, 3, ASCENDC_TPL_UI_LIST, USS_CAST_NONE));
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0),
                         ASCENDC_TPL_UINT_SEL(TEMPLATE_MODE, ASCENDC_TPL_UI_LIST, USS_TEMPLATE_INPUT_PART),
                         ASCENDC_TPL_UINT_SEL(CAST_MODE, ASCENDC_TPL_UI_LIST, USS_CAST_NONE),
                         ASCENDC_TPL_TILING_STRUCT_SEL(UnsortedSegment::UnsortedSegmentProdInputPartTilingData)),
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0),
                         ASCENDC_TPL_UINT_SEL(TEMPLATE_MODE, ASCENDC_TPL_UI_LIST, USS_TEMPLATE_SEGMENT_SORT),
                         ASCENDC_TPL_UINT_SEL(CAST_MODE, ASCENDC_TPL_UI_LIST, USS_CAST_NONE),
                         ASCENDC_TPL_TILING_STRUCT_SEL(UnsortedSegment::UnsortedSegmentProdSegmentSortTilingData)),
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0),
                         ASCENDC_TPL_UINT_SEL(TEMPLATE_MODE, ASCENDC_TPL_UI_LIST, USS_TEMPLATE_OUT_FL_WS_MERGE),
                         ASCENDC_TPL_UINT_SEL(CAST_MODE, ASCENDC_TPL_UI_LIST, USS_CAST_NONE),
                         ASCENDC_TPL_TILING_STRUCT_SEL(UnsortedSegment::UnsortedSegmentOutFlTilingData)));
} // namespace UnsortedSegmentProd
