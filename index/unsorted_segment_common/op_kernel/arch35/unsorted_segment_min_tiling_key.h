...
/*!
 * \file unsorted_segment_min_tiling_key.h
 * \brief unsorted_segment_min_tiling_key
 */

#ifndef UNSORTED_SEGMENT_MIN_TILING_KEY_H_
#define UNSORTED_SEGMENT_MIN_TILING_KEY_H_
...
namespace UnsortedSegmentMin {
ASCENDC_TPL_ARGS_DECL(UnsortedSegmentMin,
...
#endif // UNSORTED_SEGMENT_MIN_TILING_KEY_H_
