...
class QuantUpdateScatterRegbase : public QuantUpdateScatterBase<VarType, IndicesType, UpdatesType, ScalesType,
...
public:
                                ...
                                GM_ADDR quant_zero_points, GM_ADDR out, const QuantUpdateScatterTilingData* tiling)
    {
        ...
        pipe_.InitBuffer(outQueueVar_, BUFFER_NUM,
                         copyBlockCount_ * tilingData_.updateOriLastDimAlign * sizeof(VarType));
    }
    ...
    __aicore__ inline void QuantUpdate(int64_t bsIdx, LocalTensor<UpdatesType> updateLocal,
                                       LocalTensor<ScalesType> scaleLocal, LocalTensor<OffsetsType> offsetLocal)
    {
    ...
    __aicore__ inline void QuantUpdateWithoutOffset(int64_t bsIdx, LocalTensor<UpdatesType> updateLocal,
                                                    LocalTensor<ScalesType> scaleLocal)
    {
        LocalTensor<VarType> outLocal = outQueueVar_.AllocTensor<VarType>();
