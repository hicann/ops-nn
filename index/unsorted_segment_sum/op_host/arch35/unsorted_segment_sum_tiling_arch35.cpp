...
{
    OP_CHECK_IF(core_num == 0, OP_LOGE_FOR_INVALID_VALUE(context->GetNodeName(), "core_num", "0", "> 0"),
                                                   ...
                                                   const int32_t& core_num, int32_t& need_core_num)
{
    ...
    if (comm_ub_size_params.num_segments == 1) {
        if (comm_ub_size_params.e_size <= comm_ub_size_params.output_ub_ele_num_one_row) {
            ...
            OP_CHECK_IF(comm_ub_size_params.output_ub_ele_num_one_row == 0,
                        OP_LOGE_FOR_INVALID_VALUE(context->GetNodeName(), "output_ub_ele_num_one_row", "0", ">0"),
                        return ge::GRAPH_FAILED);
                          ...
                          const int32_t& mode, UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    ...
    if (e_mov_times_gm2ub_input_scalar > 1) {
        ...
        e_ub2gm_front_burst_len_input_scalar = UssCeilDiv(tiling_params->e_num_front_part_input_scalar * ele_byte,
                                                          BYTE_BLOCK);
        ...
        tiling_params->e_num_last_part_input_scalar = ComputeDivRemainders(num_segments_front_core_input_scalar,
                                                                           tiling_params->e_num_front_part_input_scalar,
                                                                           e_mov_times_gm2ub_input_scalar - 1);
        e_ub2gm_last_burst_len_input_scalar = UssCeilDiv(tiling_params->e_num_last_part_input_scalar * ele_byte,
                                                         BYTE_BLOCK);
        ...
        if (repeat_times_last_part > 1) {
            repeat_time_last_part_input_scalar = UssCeilDiv(
                tiling_params->e_num_last_part_input_scalar - (repeat_times_last_part - 1) * mask * MASK_NUM_UNIT,
                mask);
        } else {
        ...
        if (tiling_params->repeat_times > 1) {
            ...
            tiling_params->repeat_time_front_part_input_scalar = UssCeilDiv(
                tiling_params->e_num_front_part_input_scalar, mask);
        }
...
static void ComputeEleNumOneCore(const int32_t& ids_num, const int32_t& e_size, const int32_t& num_segments,
                                 UnsortedSegmentSumTilingParamsFp32* tiling_params)
{
    ...
    if (num_segments > 1) {
        ...
        tiling_params->input_ele_num_front_core_input_scalar = tiling_params->ids_ele_num_front_core_input_scalar *
                                                               e_size;
        tiling_params->input_ele_num_last_core_input_scalar = tiling_params->ids_ele_num_last_core_input_scalar *
                                                              e_size;
    } else {
        tiling_params->ids_ele_num_front_core_input_scalar = (ids_num + core_need - 1) / core_need;
        tiling_params->ids_ele_num_last_core_input_scalar = ComputeDivRemainders(
                                   ...
                                   UnsortedSegmentSumTilingParamsFp32* tiling_params)
{
    if (gm_ub_out_params.mode == FRONT_PART_FRONT_CORE) {
        tiling_params->input_mov_times_gm2ub_front_part_front_core_input_scalar = gm_ub_out_params
                                                                                      .input_mov_times_gm2ub;
        tiling_params->input_front_burst_len_front_part_front_core_input_scalar = gm_ub_out_params
                                                                                      .input_front_burst_len;
        tiling_params->input_last_burst_len_front_part_front_core_input_scalar = gm_ub_out_params.input_last_burst_len;
        tiling_params->input_front_ele_num_ub_front_part_front_core_input_scalar = gm_ub_out_params
                                                                                       .input_ele_num_ub_front_part;
        tiling_params->input_last_ele_num_ub_front_part_front_core_input_scalar = gm_ub_out_params
                                                                                      .input_ele_num_ub_last_part;
        ...
        tiling_params->input_front_ele_num_ub_last_part_front_core_input_scalar = gm_ub_out_params
                                                                                      .input_ele_num_ub_front_part;
        tiling_params->input_last_ele_num_ub_last_part_front_core_input_scalar = gm_ub_out_params
                                                                                     .input_ele_num_ub_last_part;
        ...
        tiling_params->input_front_ele_num_ub_front_part_last_core_input_scalar = gm_ub_out_params
                                                                                      .input_ele_num_ub_front_part;
        tiling_params->input_last_ele_num_ub_front_part_last_core_input_scalar = gm_ub_out_params
                                                                                     .input_ele_num_ub_last_part;
        ...
        tiling_params->input_front_ele_num_ub_last_part_last_core_input_scalar = gm_ub_out_params
                                                                                     .input_ele_num_ub_front_part;
        tiling_params->input_last_ele_num_ub_last_part_last_core_input_scalar = gm_ub_out_params
                                                                                    .input_ele_num_ub_last_part;
                                       ...
                                       InputParamsGm2UbOut& gm_ub_out_params)
{
    ...
    if (e_mov_times_gm2ub == 1) {
        ...
        if (gm_ub_out_params.input_mov_times_gm2ub > 1) {
            gm_ub_out_params.input_front_burst_len = e_byte_align_32B * gm_ub_out_params.input_rows_front_part /
                                                     BYTE_BLOCK;
            ...
            gm_ub_out_params.input_last_burst_len = e_byte_align_32B * gm_ub_out_params.input_rows_last_part /
                                                    BYTE_BLOCK;
            ...
            gm_ub_out_params.input_front_burst_len = UssCeil(gm_ub_out_params.input_ele_num_ub_front_part *
                                                                 input_ele_byte_int32,
                                                             BYTE_BLOCK) /
                                                     BYTE_BLOCK;
                                     ...
                                     UnsortedSegmentSumTilingParamsFp32* tiling_params)
{
    ...
    if (ids_ele_num_one_core <= max_ids_ele_num_one_ub_tensor) {
        ...
        if (ids_ele_num_one_core % max_ids_ele_num_one_ub_tensor == 0) {
            ...
            ids_ele_num_ub_front_part = max_ids_ele_num_one_ub_tensor;
            ids_ele_num_ub_last_part = ComputeDivRemainders(ids_ele_num_one_core, max_ids_ele_num_one_ub_tensor,
                                                            ids_mov_times_gm2ub - 1);
        }
    }
                                             ...
                                             UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    ...
    if (ids_ele_num_one_core <= max_ids_ele_num_one_ub_tensor) {
        ...
        if (ids_ele_num_one_core % max_ids_ele_num_one_ub_tensor == 0) {
            ...
            tiling_params->ids_ele_num_ub_last_part_input_scalar = tiling_params
                                                                       ->ids_ele_num_ub_front_part_input_scalar;
        } else {
            // exist last part
            ...
            tiling_params->ids_ele_num_ub_last_part_input_scalar = ComputeDivRemainders(
                ids_ele_num_one_core, max_ids_ele_num_one_ub_tensor,
                tiling_params->ids_mov_times_gm2ub_input_scalar - 1);
        }
    }
    tiling_params->ids_front_burst_len_input_scalar = UssCeilDiv(
        tiling_params->ids_ele_num_ub_front_part_input_scalar * ids_ele_byte, BYTE_BLOCK);
    tiling_params->ids_last_burst_len_input_scalar = UssCeilDiv(
        tiling_params->ids_ele_num_ub_last_part_input_scalar * ids_ele_byte, BYTE_BLOCK);
}
                                      ...
                                      UnsortedSegmentSumTilingParamsFp32* tiling_params, int32_t mode)
{
    ...
    if (repeat_times % MAX_REPEAT_TIME == 0) {
        ...
        output_ub_init_last_repeat_time = ComputeDivRemainders(repeat_times, repeat_times / MAX_REPEAT_TIME,
                                                               MAX_REPEAT_TIME);
    }
    if (mode == 0) {
        tiling_params
            ->output_ub_init_last_repeat_time_front_part_front_core_input_scalar = output_ub_init_last_repeat_time;
        ...
        tiling_params
            ->output_ub_init_last_repeat_time_last_part_front_core_input_scalar = output_ub_init_last_repeat_time;
        ...
        tiling_params
            ->output_ub_init_last_repeat_time_front_part_last_core_input_scalar = output_ub_init_last_repeat_time;
        ...
        tiling_params
            ->output_ub_init_last_repeat_time_last_part_last_core_input_scalar = output_ub_init_last_repeat_time;
                                     ...
                                     UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    if (tiling_params->need_core_num_input_scalar == 1 && num_segmens > 1) {
        ...
        tiling_params->num_segments_front_core_input_scalar = UssCeilDivNoAtomic(
            num_segmens, tiling_params->need_core_num_input_scalar, e_size, output_ub_ele_num_one_row);
        tiling_params->num_segments_last_core_input_scalar = ComputeDivRemainders(
            num_segmens, tiling_params->num_segments_front_core_input_scalar,
                                         ...
                                         UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    ...
    tiling_params->e_mov_times_gm2ub_input_scalar = UssCeilDiv(tiling_params->e_num_input_scalar,
                                                               comm_paras.e_once_num);
    ...
    if (last < byte) {
        tiling_params->e_mov_times_gm2ub_input_scalar = UssCeilDiv(tiling_params->e_num_input_scalar,
                                                                   comm_paras.e_once_num - mask);
    }
    // front part
    tiling_params->e_gm2ub_front_burst_len_input_scalar = UssCeilDiv(comm_paras.e_once_num * comm_paras_ele_byte,
                                                                     BYTE_BLOCK);
    ...
    tiling_params->e_num_last_part_input_scalar = ComputeDivRemainders(
        tiling_params->e_num_input_scalar, tiling_params->e_num_front_part_input_scalar,
        tiling_params->e_mov_times_gm2ub_input_scalar - 1);
    tiling_params->e_gm2ub_last_burst_len_input_scalar = UssCeilDiv(
    ...
    tiling_params->e_ub2gm_last_burst_len_input_scalar = tiling_params->e_num_last_part_input_scalar *
                                                         comm_paras_ele_byte / BYTE_BLOCK;
                                                      ...
                                                      UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    ...
    tiling_params->e_ub2gm_front_burst_len_input_scalar = tiling_params->e_num_input_scalar * comm_paras_ele_byte /
                                                          BYTE_BLOCK;
    ...
    tiling_params->e_gm2ub_front_burst_len_input_scalar = UssCeilDiv(
    ...
    if (tiling_params->e_num_input_scalar % byte == 0 && comm_paras.all_size <= comm_paras.e_once_num) {
        tiling_params->e_gm2ub_front_burst_len_input_scalar = UssCeilDiv(comm_paras.all_size * comm_paras_ele_byte,
                                                                         BYTE_BLOCK);
        tiling_params->e_gm2ub_last_burst_len_input_scalar = tiling_params->e_gm2ub_front_burst_len_input_scalar;
    }
                                                          ...
                                                          UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    ...
    tiling_params->num_segment_max_time = tiling_params->num_segments_front_core_input_scalar /
                                          tiling_params->num_segment_max;
    tiling_params->num_segment_max_time = (tiling_params->num_segments_front_core_input_scalar %
                                               tiling_params->num_segment_max ==
                                           0) ?
    ...
    tiling_params->align_scalar = (tiling_params->front_num_segment_last * tiling_params->e_num_input_scalar % byte ==
                                   0) ?
                                      0 :
                                      byte -
                                          (tiling_params->front_num_segment_last * tiling_params->e_num_input_scalar -
                                           (tiling_params->front_num_segment_last * tiling_params->e_num_input_scalar /
                                            byte) *
                                               byte);
    tiling_params->e_ub2gm_front_burst_len_input_scalar = tiling_params->num_segment_max *
                                                          tiling_params->e_num_input_scalar * comm_paras.ele_byte /
                                                          BYTE_BLOCK;
    tiling_params->e_gm2ub_front_burst_len_input_scalar = 1;
    tiling_params->repeat_time_front_part_input_scalar = 1;
    ...
    tiling_params->e_num_front_part_input_scalar = tiling_params->e_num_input_scalar;
    tiling_params->e_num_last_part_input_scalar = tiling_params->e_num_input_scalar;
    tiling_params->e_ub2gm_last_burst_len_input_scalar = tiling_params->front_num_segment_last *
                                                         tiling_params->e_num_input_scalar * comm_paras.ele_byte /
                                                         BYTE_BLOCK;
    tiling_params->e_gm2ub_last_burst_len_input_scalar = tiling_params->e_gm2ub_front_burst_len_input_scalar;
    tiling_params->repeat_time_last_part_input_scalar = tiling_params->repeat_time_front_part_input_scalar;
                                                         ...
                                                         UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    ...
    tiling_params->align_scalar_lastcore = (lastcore_count % byte == 0) ?
                                               0 :
                                               byte - (lastcore_count - (lastcore_count / byte) * byte);
    tiling_params->e_num_front_part_input_scalar = tiling_params->e_num_input_scalar;
    tiling_params->e_num_last_part_input_scalar = tiling_params->e_num_input_scalar;
    tiling_params->e_ub2gm_front_burst_len_input_scalar_lastcore = lastcore_count * comm_paras_ele_byte / BYTE_BLOCK;
    tiling_params->e_ub2gm_last_burst_len_input_scalar_lastcore = tiling_params
                                                         ...
                                                         UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    ...
    tiling_params->num_segment_max_time_lastcore = tiling_params->num_segments_last_core_input_scalar /
                                                   tiling_params->num_segment_max;
    tiling_params->num_segment_max_time_lastcore = (tiling_params->num_segments_last_core_input_scalar %
                                                        tiling_params->num_segment_max ==
                                                    0) ?
    ...
    if (tiling_params->front_num_segment_last_lastcore * tiling_params->e_num_input_scalar < byte) {
        ...
        int32_t front = tiling_params->num_segments_last_core_input_scalar -
                        tiling_params->front_num_segment_last_lastcore;
        int32_t num_segment_max_lastcore_front = (front / (tiling_params->num_segment_max_time_lastcore - 1) / byte) *
                                                 byte;
        tiling_params->front_num_segment_lastcore = num_segment_max_lastcore_front;
        tiling_params->front_num_segment_last_lastcore = tiling_params->num_segments_last_core_input_scalar -
                                                         tiling_params->front_num_segment_lastcore *
                                                             (tiling_params->num_segment_max_time_lastcore - 1);
    }

    tiling_params->align_scalar_lastcore = (tiling_params->front_num_segment_last_lastcore *
                                                tiling_params->e_num_input_scalar % byte ==
                                            0) ?
                                               0 :
                                               byte - (tiling_params->front_num_segment_last_lastcore *
...
static void ComputeENumParams(const CommParas4Int32& comm_paras, UnsortedSegmentSumTilingParamsInt32* tiling_params)
{
    ...
    if (tiling_params->e_num_input_scalar % byte == 0 && tiling_params->e_num_input_scalar > byte) {
        ...
        tiling_params->align_scalar = byte - (tiling_params->e_num_input_scalar -
                                              (tiling_params->e_num_input_scalar / byte) * byte);
    }
    ...
    if (tiling_params->e_num_input_scalar >= max_ele_num_one_ub_tensor && comm_paras.num_segments > 1) {
        ...
        tiling_params->e_mov_times_gm2ub_input_scalar = UssCeilDiv(tiling_params->num_segments_front_core_input_scalar,
                                                                   max_ele_num_one_ub_tensor);
        tiling_params->e_mov_times_gm2ub_input_scalar_lastcore = UssCeilDiv(
            tiling_params->num_segments_last_core_input_scalar, max_ele_num_one_ub_tensor);
        // front core
                                     ...
                                     const UnsortedSegmentSumTilingParamsFp32* tiling_param)
{
    ...
    OP_LOGD(context->GetNodeName(),
            "tiling_param->output_ub_init_last_repeat_time_front_part_front_core_input_scalar=%d",
    ...
    OP_LOGD(context->GetNodeName(),
            "tiling_param->output_ub_init_last_repeat_time_last_part_front_core_input_scalar=%d",
    ...
    OP_LOGD(context->GetNodeName(),
            "tiling_param->output_ub_init_last_repeat_time_front_part_last_core_input_scalar=%d",
                                    ...
                                    const int32_t x_ub_size, const EleByte input_ele_byte, const int32_t e_size)
{
    ...
    tiling_params->e_num_front_part_input_scalar = tiling_params->e_num_input_scalar;
    tiling_params->e_num_last_part_input_scalar = tiling_params->e_num_input_scalar;
    tiling_params->e_ub2gm_front_burst_len_input_scalar = tiling_params->e_num_front_part_input_scalar *
                                                          input_ele_byte / BYTE_BLOCK;
    tiling_params->e_ub2gm_last_burst_len_input_scalar = tiling_params->e_ub2gm_front_burst_len_input_scalar;
    // input data params
    ...
    if (perf) {
        ...
        if (num <= comm_paras.num_segments) {
            tiling_params->output_ub_init_times_front_part_last_core_input_scalar = (comm_paras.e_num * num * MULTI) /
                                                                                    BYTE_BLOCK;
        } else {
            tiling_params->output_ub_init_times_front_part_last_core_input_scalar = (comm_paras.e_num *
                                                                                     comm_paras.num_segments * MULTI) /
                                                                                    BYTE_BLOCK;
        }
    }
    return;
                                 ...
                                 const int32_t output_ub_ele_num_one_row)
{
    ...
    // front part front core
    tiling_params
        ->input_front_burst_len_front_part_front_core_input_scalar = tiling_params
                                                                         ->ids_front_burst_len_front_core_input_scalar;
    ...
    // last part front core
    tiling_params
        ->input_front_burst_len_last_part_front_core_input_scalar = tiling_params
                                                                        ->ids_last_burst_len_front_core_input_scalar;
    ...
    // front part last core
    tiling_params
        ->input_front_burst_len_front_part_last_core_input_scalar = tiling_params
                                                                        ->ids_front_burst_len_last_core_input_scalar;
    ...
    // last part last core
    tiling_params
        ->input_front_burst_len_last_part_last_core_input_scalar = tiling_params
                                                                       ->ids_last_burst_len_last_core_input_scalar;
                                            ...
                                            const int32_t output_ub_ele_num_one_row)
{
    ...
    tiling_params->input_last_axis_align_front_part_ele_num_input_scalar = e_size / FP32_ELE_NUM_ALIGN_32B *
                                                                           FP32_ELE_NUM_ALIGN_32B;

    tiling_params->last_part_vadd_mask_input_scalar = e_size -
                                                      tiling_params
                                                          ->input_last_axis_align_front_part_ele_num_input_scalar;
                                       ...
                                       UnsortedSegmentSumTilingParamsFp32* tiling_params)
{
    ...
    tiling_params->e_ub2gm_last_burst_len_input_scalar = tiling_params->e_num_last_part_input_scalar * input_ele_byte /
                                                         BYTE_BLOCK;
    ...
    tiling_params->input_last_ele_num_ub_front_part_front_core_input_scalar = tiling_params
    ...
    tiling_params->input_last_ele_num_ub_last_part_front_core_input_scalar = tiling_params
                                                                                 ->e_num_last_part_input_scalar;
    // front part last core
    ...
    tiling_params->input_last_ele_num_ub_front_part_last_core_input_scalar = tiling_params
                                                                                 ->e_num_last_part_input_scalar;
    // last part last core
                                          ...
                                          const int32_t ub_tensor_ele_num)
{
    ...
    // output init params
    tiling_params->input_last_axis_align_front_part_ele_num_input_scalar = tiling_params->e_num_last_part_input_scalar /
                                                                           FP32_ELE_NUM_ALIGN_32B *
                                                                           FP32_ELE_NUM_ALIGN_32B;
    tiling_params->input_last_axis_align_floor_ele_num_input_scalar = UssCeil(
        tiling_params->e_num_last_part_input_scalar, FP32_ELE_NUM_ALIGN_32B);
...
void CalcTilingFloat4LastAxisModify(UnsortedSegmentSumTilingParamsFp32* tiling_params)
{
    ...
    // output init params
    tiling_params->output_ub_init_times_front_part_front_core_input_scalar = UssCeilDiv(
        tiling_params->ids_ele_num_ub_front_part_front_core_input_scalar, MASK_FP32);
    tiling_params->output_ub_init_times_last_part_front_core_input_scalar = UssCeilDiv(
        tiling_params->ids_ele_num_ub_last_part_front_core_input_scalar, MASK_FP32);
    tiling_params->output_ub_init_times_front_part_last_core_input_scalar = UssCeilDiv(
        tiling_params->ids_ele_num_ub_front_part_last_core_input_scalar, MASK_FP32);
    tiling_params->output_ub_init_times_last_part_last_core_input_scalar = UssCeilDiv(
        tiling_params->ids_ele_num_ub_last_part_last_core_input_scalar, MASK_FP32);
    tiling_params
        ->last_part_vadd_mask_input_scalar = tiling_params->ids_ele_num_ub_last_part_last_core_input_scalar -
                                   ...
                                   const int32_t x_ub_size, const int32_t e_size, const int32_t ub_tensor_ele_num)
{
    ...
    tiling_params->e_num_last_part_input_scalar = ComputeDivRemainders(
        e_size, tiling_params->e_num_front_part_input_scalar, tiling_params->e_mov_times_gm2ub_input_scalar - 1);
    tiling_params->e_ub2gm_last_burst_len_input_scalar = UssCeilDiv(
        tiling_params->e_num_last_part_input_scalar * input_ele_byte, BYTE_BLOCK);
                                 ...
                                 const EleByte ids_ele_byte)
{
    ...
    OP_CHECK_IF(!GetTilingMode(commParas, x_ub_size, tiling_params->select_key_input_scalar),
                OP_LOGE(context->GetNodeName(), "GetTilingMode failed."), return ge::GRAPH_FAILED);
    ...
    OP_CHECK_IF(ids_ele_byte == 0, OP_LOGE(context->GetNodeName(), "CalcTiling4Float check failed ids_ele_byte is 0."),
                return ge::GRAPH_FAILED);

    // calc need core num
    OP_CHECK_IF(CalcNeededCoreNum(context, commParas, ids_size, compile_info->core_num,
                                  tiling_params->need_core_num_input_scalar),
                OP_LOGE(context->GetNodeName(), "CalcNeededCoreNum failed."), return ge::GRAPH_FAILED);
    ...
    if (tiling_params->select_key_input_scalar == SELECT_KEY_MODE_FP32_INPUT_LAST_AXIS_ALIGN_SMALL_E ||
        ...
        CalcTilingFloat4LastAxisOne(tiling_params, output_ub_ele_num_one_row);
               ...
               tiling_params->select_key_input_scalar ==
                   SELECT_KEY_MODE_FP32_INPUT_LAST_AXIS_NOT_ALIGN_SMALL_E_HP_PAD) {
...
ge::graphStatus CalcTiling4Int(gert::TilingContext* context, const ge::DataType input_dtype,
                               const int32_t output_ub_ele_num_one_row, const int32_t num_segments,
                               const int32_t e_size, const int32_t input_size, const int32_t ids_size,
                               const EleByte input_ele_byte, const EleByte ids_ele_byte)
{
    ...
    OP_CHECK_IF(CalcNeededCoreByNumSegments(context, comm_ub_size_params, compile_info->core_num,
                                            tiling_params->need_core_num_input_scalar),
                OP_LOGE(context->GetNodeName(), "CalcNeededCoreByNumSegments failed."), return ge::GRAPH_FAILED);
    ...
    OP_CHECK_IF(!GetTilingModeNoAtomic(comm_tiling_mode_params, tiling_params->select_key_input_scalar, e_once_num,
                ...
                OP_LOGE(context->GetNodeName(), "GetTilingModeNoAtomic failed."), return ge::GRAPH_FAILED);
...
ge::graphStatus Tiling4SegmentSumComm(gert::TilingContext* context, const int32_t num_segments)
{
    ...
    OP_CHECK_IF(input_segment_ids_shape == nullptr,
                OP_LOGE_FOR_INVALID_SHAPE_WITH_REASON(context->GetNodeName(), "segment_ids", "null",
                                                      "input shape cannot be null"),
                return ge::GRAPH_FAILED);
    const gert::Shape& input_segment_ids_shape_sizes = Ops::Base::EnsureNotScalar(
        input_segment_ids_shape->GetStorageShape());
    ...
    OP_CHECK_IF(segment_ids_dec_ptr == nullptr,
                OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(context->GetNodeName(), "segment_ids", "null",
                                                      "input desc cannot be null"),
                return ge::GRAPH_FAILED);
    ...
    OP_CHECK_IF(
        !GetEleDtype(input_dtype, input_ele_byte),
        OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(context->GetNodeName(), "input", Ops::Base::ToString(input_dtype).c_str(),
    ...
    OP_CHECK_IF(!GetEleDtype(ids_dtype, ids_ele_byte),
                OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(context->GetNodeName(), "segment_ids",
                                                      Ops::Base::ToString(ids_dtype).c_str(),
                                                      "failed to get dtype size, dtype may be unsupported"),
                return ge::GRAPH_FAILED);

    if (input_dtype == ge::DT_FLOAT) {
        if (CalcTiling4Float(context, e_size, num_segments, input_size, ids_size, output_ub_ele_num_one_row,
...
ge::graphStatus TilingPrepare4SegmentSumComm(gert::TilingParseContext* context)
{
    ...
    OP_CHECK_IF((compile_info->core_num <= 0),
                OP_LOGE_FOR_INVALID_VALUE(context->GetNodeName(), "core_num",
                                          std::to_string(compile_info->core_num).c_str(), ">0"),
                return ge::GRAPH_FAILED);
    OP_CHECK_IF((compile_info->max_thread <= 0),
                OP_LOGE_FOR_INVALID_VALUE(context->GetNodeName(), "max_thread",
                                          std::to_string(compile_info->max_thread).c_str(), ">0"),
                return ge::GRAPH_FAILED);
    return ge::GRAPH_SUCCESS;
}
