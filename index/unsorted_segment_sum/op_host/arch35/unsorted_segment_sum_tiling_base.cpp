...
uint32_t UnsortedSegmentSumBaseTiling::GetSortTmpSize(ge::DataType dataType, uint32_t lastAxisNum, bool isDescend)
{
...
ge::graphStatus UnsortedSegmentSumBaseTiling::GetCastType()
{
    indicesCastDtype_ = idType_;
