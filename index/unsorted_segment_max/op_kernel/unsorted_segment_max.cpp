...
#include "../unsorted_segment_common/arch35/unsorted_segment_max_tiling_key.h"
...
__global__ __aicore__ void unsorted_segment_max(GM_ADDR x, GM_ADDR segment_ids, GM_ADDR num_segments, GM_ADDR output,
