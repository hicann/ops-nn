                                                       ...
                                                       int32_t batchNum)
    {
        if (tiling->indicesDim == 1) {
            if (tiling->axis == SECOND_LAST_DIM) {
                asc_vf_call<SimtOneCoreCompute0<T1, T2, T3>>(
                    dim3(THREAD_NUM), (__gm__ T1*)(updatesGm.GetPhyAddr()), (__gm__ T2*)(indicesGm.GetPhyAddr()),
                    (__gm__ T1*)(outputGm.GetPhyAddr()), factorArr, coefArr, shiftArr, mArr, startOffset, batchNum);
            } else {
                asc_vf_call<SimtOneCoreCompute1<T1, T2, T3>>(
                    dim3(THREAD_NUM), (__gm__ T1*)(updatesGm.GetPhyAddr()), (__gm__ T2*)(indicesGm.GetPhyAddr()),
                    (__gm__ T1*)(outputGm.GetPhyAddr()), factorArr, coefArr, shiftArr, mArr, startOffset, batchNum);
            }
        } else {
            if (tiling->axis == SECOND_LAST_DIM) {
                asc_vf_call<SimtOneCoreCompute2<T1, T2, T3>>(
                    dim3(THREAD_NUM), (__gm__ T1*)(updatesGm.GetPhyAddr()), (__gm__ T2*)(indicesGm.GetPhyAddr()),
                    (__gm__ T1*)(outputGm.GetPhyAddr()), factorArr, coefArr, shiftArr, mArr, startOffset, batchNum);
            } else {
                asc_vf_call<SimtOneCoreCompute3<T1, T2, T3>>(
                    dim3(THREAD_NUM), (__gm__ T1*)(updatesGm.GetPhyAddr()), (__gm__ T2*)(indicesGm.GetPhyAddr()),
                    (__gm__ T1*)(outputGm.GetPhyAddr()), factorArr, coefArr, shiftArr, mArr, startOffset, batchNum);
            }
        }
