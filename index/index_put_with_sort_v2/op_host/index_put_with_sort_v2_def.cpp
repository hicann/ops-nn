...
public:
    ...
    {
        this->Input("self").ParamType(REQUIRED).DataType(valueType).Format(format).UnknownShapeFormat(format);
        this->Input("linear_index").ParamType(REQUIRED).DataType(indicesType).Format(format).UnknownShapeFormat(format);
        this->Input("pos_idx").ParamType(REQUIRED).DataType(posType).Format(format).UnknownShapeFormat(format);
        this->Input("values").ParamType(REQUIRED).DataType(valueType).Format(format).UnknownShapeFormat(format);
        this->Output("self").ParamType(REQUIRED).DataType(valueType).Format(format).UnknownShapeFormat(format);
        this->Attr("indexed_sizes").AttrType(REQUIRED).ListInt();
