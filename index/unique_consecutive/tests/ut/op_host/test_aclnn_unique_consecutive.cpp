...
#include "../../../op_api/aclnn_unique_consecutive.h"
...
protected:
    static void SetUpTestCase() { cout << "unique_consecutive_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "unique_consecutive_test TearDown" << endl; }
};
