...
static const std::vector<ge::DataType> g_xDtypes = {
    ...
    ge::DT_UINT16,  ge::DT_INT32, ge::DT_INT64, ge::DT_BOOL, ge::DT_DOUBLE, ge::DT_COMPLEX64,
    ge::DT_FLOAT16, ge::DT_FLOAT, ge::DT_BF16,  ge::DT_INT8, ge::DT_UINT8,  ge::DT_INT16,
    ge::DT_UINT16,  ge::DT_INT32, ge::DT_INT64, ge::DT_BOOL, ge::DT_DOUBLE, ge::DT_COMPLEX64};
...
public:
    ...
    {
        this->Input("x").ParamType(REQUIRED).DataType(g_xDtypes).Format(g_formats).UnknownShapeFormat(g_formats);
        this->Input("seq_lengths")
            .ParamType(REQUIRED)
            .DataType(g_seqLengthsDtypes)
            .Format(g_formats)
            .UnknownShapeFormat(g_formats);
        this->Output("y").ParamType(REQUIRED).DataType(g_yDtypes).Format(g_formats).UnknownShapeFormat(g_formats);
