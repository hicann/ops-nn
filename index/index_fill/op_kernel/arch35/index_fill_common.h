 ...
 *     1).sortedOut的前32字节为前哨兵区域，值都为actualSortOut[0] - 1,区域为: [0, frontSentinelAreaSize - 1],
 * 哨兵区域大小为: frontSentinelAreaSize 2).sortedOut[frontSentinelAreaSize, size - 1]为实际的排序结果
