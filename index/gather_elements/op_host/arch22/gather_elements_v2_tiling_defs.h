 ...
 */
/*!
 * \file gather_elements_v2_tiling_defs.h
 * \brief
 */
#ifndef GATHER_ELEMENTS_V2_TILING_DEFS_H
#define GATHER_ELEMENTS_V2_TILING_DEFS_H
#include "register/tilingdata_base.h"

namespace optiling {

constexpr int64_t GATHER_ELEMENTS_V2_TILING_ARRAY_LEN_EIGHT = 8;
...
REGISTER_TILING_DATA_CLASS(GeV2TilingParamOp, GatherElementsV2TilingParam)
...
REGISTER_TILING_DATA_CLASS(GeV2TransTilingOp, GatherElementsV2TransTiling)
...
REGISTER_TILING_DATA_CLASS(GeV2ScalarTilingOp, GatherElementsV2ScalarTiling)

BEGIN_TILING_DATA_DEF(GatherElementsV2LastDimTilingParam)
TILING_DATA_FIELD_DEF_ARR(int64_t, GATHER_ELEMENTS_V2_TILING_ARRAY_LEN_EIGHT, xShape)
TILING_DATA_FIELD_DEF_ARR(int64_t, GATHER_ELEMENTS_V2_TILING_ARRAY_LEN_EIGHT, indexShape)
TILING_DATA_FIELD_DEF_ARR(int64_t, GATHER_ELEMENTS_V2_TILING_ARRAY_LEN_EIGHT, xStrideArray)
TILING_DATA_FIELD_DEF_ARR(int64_t, GATHER_ELEMENTS_V2_TILING_ARRAY_LEN_EIGHT, indexStrideArray)
...
REGISTER_TILING_DATA_CLASS(GeV2LastDimTilingParamOp, GatherElementsV2LastDimTilingParam)
...
REGISTER_TILING_DATA_CLASS(GeV2TilingDataForGatherElements, GatherElementsV2TilingData)

} // namespace optiling
#endif // GATHER_ELEMENTS_V2_TILING_DEFS_H
