...
constexpr uint64_t V2_BLOCK_SIZE = 32;
constexpr uint64_t BYTE8 = 8;
...
protected:
    __aicore__ inline void InitBasicParams(const GatherElementsV2TilingData& tiling)
    {
        ...
        xAlign_ = static_cast<uint32_t>(V2_BLOCK_SIZE / sizeof(T_X));
        idxAlign_ = static_cast<uint32_t>(V2_BLOCK_SIZE / sizeof(T_IDX));
