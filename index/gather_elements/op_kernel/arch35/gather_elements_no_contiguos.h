...
public:
    ...
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR index, GM_ADDR y,
                                const GatherElementsNoContiguousTilingData* tilingData);
...
__aicore__ inline void GatherElementsKernelNoContiguous<X_T, INDEX_T, COM_T, DIM_NUM, AXIS, IS_SPECIAL>::Init(
    GM_ADDR x, GM_ADDR index, GM_ADDR y, const GatherElementsNoContiguousTilingData* tilingData)
{
...
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_2048) inline void GatherDim1NoContiguousCompute(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U indexStride, U xStridex, U batchNum, U coreOffset)
{
...
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_2048) inline void GatherDim2NoContiguousCompute(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U m, U shift, U indexStride, U xStridex,
    U indexContiguousStride, U indexStride1, U xStridex1, U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
...
template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_2048) inline void GatherDim3NoContiguousCompute(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U m, U shift, U m1, U shift1, U indexStride, U xStridex,
    U indexContiguousStride, U indexStride1, U xStridex1, U indexContiguousStride1, U indexStride2, U xStridex2,
...
template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_2048) inline void GatherDim3NoContiguousComputeB64(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, __ubuf__ U* stride, U m, U shift, U m1, U shift1,
    U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
        U dim0Index = Simt::UintDiv(i, m, shift);
...
template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_1024) inline void GatherDim4NoContiguousCompute(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U m, U shift, U m1, U shift1, U m2, U shift2,
    U indexStride, U xStridex, U indexContiguousStride, U indexStride1, U xStridex1, U indexContiguousStride1,
    U indexStride2, U xStridex2, U indexContiguousStride2, U indexStride3, U xStridex3, U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
        U dim0Index = Simt::UintDiv(i, m, shift);
        U newIdx2 = i - dim0Index * indexContiguousStride;
...
template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_1024) inline void GatherDim4NoContiguousComputeB64(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, __ubuf__ U* stride, U m, U shift, U m1, U shift1, U m2,
    U shift2, U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
        U dim0Index = Simt::UintDiv(i, m, shift);
        U newIdx2 = i - dim0Index * stride[0];
        ...
        U indexVal = indexGm[dim0Index * stride[4] + dim1Index * stride[5] + dim2Index * stride[6] +
                             dim3Index * stride[7]];

        if constexpr (AXIS == 0) {
            yGm[i] = xGm[indexVal * stride[8] + dim1Index * stride[9] + dim2Index * stride[10] +
                         dim3Index * stride[11]];
        } else if constexpr (AXIS == 1) {
            yGm[i] = xGm[dim0Index * stride[8] + indexVal * stride[9] + dim2Index * stride[10] +
                         dim3Index * stride[11]];
        } else if constexpr (AXIS == 2) {
            yGm[i] = xGm[dim0Index * stride[8] + dim1Index * stride[9] + indexVal * stride[10] +
                         dim3Index * stride[11]];
        } else {
            yGm[i] = xGm[dim0Index * stride[8] + dim1Index * stride[9] + dim2Index * stride[10] +
                         indexVal * stride[11]];
        }
    }
}
...
template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_1024) inline void GatherDim5NoContiguousCompute(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U m, U shift, U m1, U shift1, U m2, U shift2, U m3,
    U shift3, U indexStride, U xStridex, U indexContiguousStride, U indexStride1, U xStridex1, U indexContiguousStride1,
    U indexStride2, U xStridex2, U indexContiguousStride2, U indexStride3, U xStridex3, U indexContiguousStride3,
    U indexStride4, U xStridex4, U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
        U dim0Index = Simt::UintDiv(i, m, shift);
        U newIdx2 = i - dim0Index * indexContiguousStride;
        ...
        U indexVal = indexGm[dim0Index * indexStride + dim1Index * indexStride1 + dim2Index * indexStride2 +
                             dim3Index * indexStride3 + dim4Index * indexStride4];
        ...
        if constexpr (AXIS == 0) {
            ...
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         indexVal * xStridex4];
        }
    }
}
...
template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_512) inline void GatherDim6NoContiguousCompute(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U m, U shift, U m1, U shift1, U m2, U shift2, U m3,
    U shift3, U m4, U shift4, U indexStride, U xStridex, U indexContiguousStride, U indexStride1, U xStridex1,
    U indexContiguousStride1, U indexStride2, U xStridex2, U indexContiguousStride2, U indexStride3, U xStridex3,
    U indexContiguousStride3, U indexStride4, U xStridex4, U indexContiguousStride4, U indexStride5, U xStridex5,
    U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
        U dim0Index = Simt::UintDiv(i, m, shift);
        ...
        U indexVal = indexGm[dim0Index * indexStride + dim1Index * indexStride1 + dim2Index * indexStride2 +
                             dim3Index * indexStride3 + dim4Index * indexStride4 + dim5Index * indexStride5];

        if constexpr (AXIS == 0) {
            yGm[i] = xGm[indexVal * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5];
        } else if constexpr (AXIS == 1) {
            yGm[i] = xGm[dim0Index * xStridex + indexVal * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5];
        } else if constexpr (AXIS == 2) {
            ...
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         indexVal * xStridex4 + dim5Index * xStridex5];
        } else {
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + indexVal * xStridex5];
        }
    }
}

template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_512) inline void GatherDim7NoContiguousCompute(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U m, U shift, U m1, U shift1, U m2, U shift2, U m3,
    U shift3, U m4, U shift4, U m5, U shift5, U indexStride, U xStridex, U indexContiguousStride, U indexStride1,
    U xStridex1, U indexContiguousStride1, U indexStride2, U xStridex2, U indexContiguousStride2, U indexStride3,
    U xStridex3, U indexContiguousStride3, U indexStride4, U xStridex4, U indexContiguousStride4, U indexStride5,
    U xStridex5, U indexContiguousStride5, U indexStride6, U xStridex6, U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
        U dim0Index = Simt::UintDiv(i, m, shift);
        U newIdx2 = i - dim0Index * indexContiguousStride;
        ...
        U indexVal = indexGm[dim0Index * indexStride + dim1Index * indexStride1 + dim2Index * indexStride2 +
                             dim3Index * indexStride3 + dim4Index * indexStride4 + dim5Index * indexStride5 +
                             dim6Index * indexStride6];

        if constexpr (AXIS == 0) {
            yGm[i] = xGm[indexVal * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5 + dim6Index * xStridex6];
        } else if constexpr (AXIS == 1) {
            yGm[i] = xGm[dim0Index * xStridex + indexVal * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5 + dim6Index * xStridex6];
        } else if constexpr (AXIS == 2) {
            ...
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         indexVal * xStridex4 + dim5Index * xStridex5 + dim6Index * xStridex6];
        } else if constexpr (AXIS == 5) {
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + indexVal * xStridex5 + dim6Index * xStridex6];
        } else {
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5 + indexVal * xStridex6];
        }
    }
}

template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_512) inline void GatherDim8NoContiguousCompute(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U m, U shift, U m1, U shift1, U m2, U shift2, U m3,
    U shift3, U m4, U shift4, U m5, U shift5, U m6, U shift6, U indexStride, U xStridex, U indexContiguousStride,
    ...
    U indexStride5, U xStridex5, U indexContiguousStride5, U indexStride6, U xStridex6, U indexContiguousStride6,
    U indexStride7, U xStridex7, U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
        U dim0Index = Simt::UintDiv(i, m, shift);
        U newIdx2 = i - dim0Index * indexContiguousStride;
        ...
        U indexVal = indexGm[dim0Index * indexStride + dim1Index * indexStride1 + dim2Index * indexStride2 +
                             dim3Index * indexStride3 + dim4Index * indexStride4 + dim5Index * indexStride5 +
                             dim6Index * indexStride6 + dim7Index * indexStride7];

        if constexpr (AXIS == 0) {
            yGm[i] = xGm[indexVal * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5 + dim6Index * xStridex6 + dim7Index * xStridex7];
        } else if constexpr (AXIS == 1) {
            yGm[i] = xGm[dim0Index * xStridex + indexVal * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5 + dim6Index * xStridex6 + dim7Index * xStridex7];
        } else if constexpr (AXIS == 2) {
            ...
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         indexVal * xStridex4 + dim5Index * xStridex5 + dim6Index * xStridex6 + dim7Index * xStridex7];
        } else if constexpr (AXIS == 5) {
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + indexVal * xStridex5 + dim6Index * xStridex6 + dim7Index * xStridex7];
        } else if constexpr (AXIS == 6) {
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5 + indexVal * xStridex6 + dim7Index * xStridex7];
        } else {
            yGm[i] = xGm[dim0Index * xStridex + dim1Index * xStridex1 + dim2Index * xStridex2 + dim3Index * xStridex3 +
                         dim4Index * xStridex4 + dim5Index * xStridex5 + dim6Index * xStridex6 + indexVal * xStridex7];
        }
    }
}

template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_2048) inline void GatherDim3ComputeTransPose(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, U m, U shift, U m1, U shift1, U indexStride, U xStridex,
    U indexContiguousStride, U yStride, U indexStride1, U xStridex1, U indexContiguousStride1, U yStride1,
    U indexStride2, U xStridex2, U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
        //  [a, b, c]  -> [b, a, c]
...
template <typename X_T, typename INDEX_T, typename U, int32_t AXIS>
__simt_vf__ __aicore__ LAUNCH_BOUND(THREAD_DIM_2048) inline void GatherDim3ComputeTransPoseB64(
    __gm__ INDEX_T* indexGm, __gm__ X_T* yGm, __gm__ X_T* xGm, __ubuf__ U* stride, U m, U shift, U m1, U shift1,
    U batchNum, U coreOffset)
{
    for (U i = threadIdx.x + coreOffset; i < batchNum; i += blockDim.x) {
...
__aicore__ inline void GatherElementsKernelNoContiguous<X_T, INDEX_T, COM_T, DIM_NUM, AXIS, IS_SPECIAL>::ProcessCommon()
{
    ...
    if constexpr (!IS_SPECIAL) {
        ...
        if constexpr (DIM_NUM == DIM1) {
            asc_vf_call<GatherDim1NoContiguousCompute<X_T, INDEX_T, COM_T>>(
                dim3(THREAD_DIM_2048), indexAddr, yAddr, xAddr, static_cast<COM_T>(tilingData_->indexStride[MS_IDX7]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX7]), batchNum, coreOffset);
        } else if constexpr (DIM_NUM == DIM2) {
            asc_vf_call<GatherDim2NoContiguousCompute<X_T, INDEX_T, COM_T, AXIS>>(
                dim3(THREAD_DIM_2048), indexAddr, yAddr, xAddr, m_[MS_IDX6], shift_[MS_IDX6],
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX6]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX6]), static_cast<COM_T>(indexContigousStride[MS_IDX6]),
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX7]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX7]), batchNum, coreOffset);
        } else if constexpr (DIM_NUM == DIM3) {
            if constexpr (sizeof(COM_T) == B32) {
                asc_vf_call<GatherDim3NoContiguousCompute<X_T, INDEX_T, COM_T, AXIS>>(
                    dim3(THREAD_DIM_2048), indexAddr, yAddr, xAddr, m_[MS_IDX5], shift_[MS_IDX5], m_[MS_IDX6],
                    shift_[MS_IDX6], static_cast<COM_T>(tilingData_->indexStride[MS_IDX5]),
            ...
            if constexpr (sizeof(COM_T) == B32) {
                asc_vf_call<GatherDim4NoContiguousCompute<X_T, INDEX_T, COM_T, AXIS>>(
                    dim3(THREAD_DIM_1024), indexAddr, yAddr, xAddr, m_[MS_IDX4], shift_[MS_IDX4], m_[MS_IDX5],
                    shift_[MS_IDX5], m_[MS_IDX6], shift_[MS_IDX6],
            ...
            asc_vf_call<GatherDim5NoContiguousCompute<X_T, INDEX_T, COM_T, AXIS>>(
                dim3(THREAD_DIM_1024), indexAddr, yAddr, xAddr, m_[MS_IDX3], shift_[MS_IDX3], m_[MS_IDX4],
                shift_[MS_IDX4], m_[MS_IDX5], shift_[MS_IDX5], m_[MS_IDX6], shift_[MS_IDX6],
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX3]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX3]), static_cast<COM_T>(indexContigousStride[MS_IDX3]),
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX4]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX4]), static_cast<COM_T>(indexContigousStride[MS_IDX4]),
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX5]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX5]), static_cast<COM_T>(indexContigousStride[MS_IDX5]),
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX6]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX6]), static_cast<COM_T>(indexContigousStride[MS_IDX6]),
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX7]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX7]), batchNum, coreOffset);
        } else if constexpr (DIM_NUM == DIM6) {
            asc_vf_call<GatherDim6NoContiguousCompute<X_T, INDEX_T, COM_T, AXIS>>(
                dim3(THREAD_DIM_512), indexAddr, yAddr, xAddr, m_[MS_IDX2], shift_[MS_IDX2], m_[MS_IDX3],
                shift_[MS_IDX3], m_[MS_IDX4], shift_[MS_IDX4], m_[MS_IDX5], shift_[MS_IDX5], m_[MS_IDX6],
                shift_[MS_IDX6], static_cast<COM_T>(tilingData_->indexStride[MS_IDX2]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX2]), static_cast<COM_T>(indexContigousStride[MS_IDX2]),
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX3]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX3]), static_cast<COM_T>(indexContigousStride[MS_IDX3]),
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX4]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX4]), static_cast<COM_T>(indexContigousStride[MS_IDX4]),
            ...
            asc_vf_call<GatherDim7NoContiguousCompute<X_T, INDEX_T, COM_T, AXIS>>(
                dim3(THREAD_DIM_512), indexAddr, yAddr, xAddr, m_[MS_IDX1], shift_[MS_IDX1], m_[MS_IDX2],
                shift_[MS_IDX2], m_[MS_IDX3], shift_[MS_IDX3], m_[MS_IDX4], shift_[MS_IDX4], m_[MS_IDX5],
                shift_[MS_IDX5], m_[MS_IDX6], shift_[MS_IDX6], static_cast<COM_T>(tilingData_->indexStride[MS_IDX1]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX1]), static_cast<COM_T>(indexContigousStride[MS_IDX1]),
            ...
            asc_vf_call<GatherDim8NoContiguousCompute<X_T, INDEX_T, COM_T, AXIS>>(
                dim3(THREAD_DIM_512), indexAddr, yAddr, xAddr, m_[MS_IDX0], shift_[MS_IDX0], m_[MS_IDX1],
                shift_[MS_IDX1], m_[MS_IDX2], shift_[MS_IDX2], m_[MS_IDX3], shift_[MS_IDX3], m_[MS_IDX4],
                shift_[MS_IDX4], m_[MS_IDX5], shift_[MS_IDX5], m_[MS_IDX6], shift_[MS_IDX6],
                static_cast<COM_T>(tilingData_->indexStride[MS_IDX0]),
                static_cast<COM_T>(tilingData_->xStride[MS_IDX0]), static_cast<COM_T>(indexContigousStride[MS_IDX0]),
...
GatherElementsKernelNoContiguous<X_T, INDEX_T, COM_T, DIM_NUM, AXIS, IS_SPECIAL>::ProcessSpecial()
{
    if (GetBlockIdx() >= tilingData_->usedCore) {
        return;
    }
    if constexpr (IS_SPECIAL) {
        int64_t indexContigousStride[MAX_DIM_LEN] = {
            1,
            1,
            1,
            1,
            1,
            tilingData_->indexShape[MS_IDX5] * tilingData_->indexShape[MS_IDX7],
            tilingData_->indexShape[MS_IDX7],
            1};
        int64_t yStride[MAX_DIM_LEN] = {1,
                                        1,
                                        1,
                                        1,
                                        1,
                                        tilingData_->indexShape[MS_IDX6] * tilingData_->indexShape[MS_IDX7],
                                        tilingData_->indexShape[MS_IDX7],
                                        1};
        for (uint32_t i = MAX_DIM_LEN - DIM_NUM; i < M_SHIFT_OFFSET; i++) {
            GetUintDivMagicAndShift(m_[i], shift_[i], static_cast<COM_T>(indexContigousStride[i]));
        ...
        if constexpr (DIM_NUM == DIM3) {
            if constexpr (sizeof(COM_T) == B32) {
                asc_vf_call<GatherDim3ComputeTransPose<X_T, INDEX_T, COM_T, AXIS>>(
                    dim3(THREAD_DIM_2048), indexAddr, yAddr, xAddr, m_[MS_IDX5], shift_[MS_IDX5], m_[MS_IDX6],
                    shift_[MS_IDX6], static_cast<COM_T>(tilingData_->indexStride[MS_IDX5]),
                    static_cast<COM_T>(tilingData_->xStride[MS_IDX5]),
                    static_cast<COM_T>(indexContigousStride[MS_IDX5]), static_cast<COM_T>(yStride[MS_IDX5]),
                    static_cast<COM_T>(tilingData_->indexStride[MS_IDX6]),
                    static_cast<COM_T>(tilingData_->xStride[MS_IDX6]),
                    static_cast<COM_T>(indexContigousStride[MS_IDX6]), static_cast<COM_T>(yStride[MS_IDX6]),
                    static_cast<COM_T>(tilingData_->indexStride[MS_IDX7]),
                    static_cast<COM_T>(tilingData_->xStride[MS_IDX7]), batchNum, coreOffset);
            } else {
                LocalTensor<COM_T> strideLocal = strideBuf_.Get<COM_T>();
