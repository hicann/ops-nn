...
#include "gather_elements_last_dim.h"
                                                      ...
                                                      GM_ADDR tiling)
{
    ...
    if (tilingData.tilingMode == Tiling_MODE_SCALAR) {
        AscendC::GatherElementsScalarKernel<DTYPE_X, DTYPE_INDEX> op(x, index, y, tilingData, tpipe);
        op.Process();
        return;
    }
