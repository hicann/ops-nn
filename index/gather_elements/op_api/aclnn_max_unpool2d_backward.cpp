                       ...
                       const aclIntArray* outputSize, const aclTensor* out)
{
    ...
    int64_t gradc = selfDimNum == CHW_DIM_NUM ? gradOutput->GetViewShape().GetDim(0) :
                                                     ...
                                                     aclTensor* out, uint64_t* workspaceSize, aclOpExecutor** executor)
{
    ...
    auto gradReshape = l0op::Reshape(gradContiguous,
                                     uniqueExecutor.get()->AllocIntArray(gradNewShape.data(), gradNewShape.size()),
                                     uniqueExecutor.get());
