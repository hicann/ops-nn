...
static const std::initializer_list<op::DataType> AICORE_DTYPE_SUPPORT_LIST = {
    ...
    op::DataType::DT_UINT8, op::DataType::DT_UINT32, op::DataType::DT_INT16,   op::DataType::DT_UINT16,
...
static const std::initializer_list<op::DataType> AICORE_DTYPE_SUPPORT_LIST_WITH_BOOL = {
    op::DataType::DT_FLOAT,       op::DataType::DT_INT32,       op::DataType::DT_FLOAT16,      op::DataType::DT_INT8,
    op::DataType::DT_UINT8,       op::DataType::DT_UINT32,      op::DataType::DT_INT16,        op::DataType::DT_UINT16,
    op::DataType::DT_INT64,       op::DataType::DT_UINT64,      op::DataType::DT_BF16,         op::DataType::DT_BOOL,
    op::DataType::DT_FLOAT8_E5M2, op::DataType::DT_FLOAT8_E8M0, op::DataType::DT_FLOAT8_E4M3FN};

static const std::initializer_list<op::DataType> ONE_BYTE_DTYPE_LIST = {op::DataType::DT_INT8, op::DataType::DT_UINT8};
...
static const std::initializer_list<op::DataType> VGATHER_DTYPE_LIST = {op::DataType::DT_FLOAT16, op::DataType::DT_BF16};
...
static bool IsLastAxisSupport(const aclTensor* self, const aclTensor* index, const int64_t axis)
{
    ...
    bool cuttingIntoSlicesFlag = last_dim_size >= available_ub_size && if_same_dim_value_except_axis &&
                                 x_axis * x_dsize <= available_ub_size / HALF && index_axis % large_num_per_block == 0;
                                ...
                                aclOpExecutor* executor)
{
    ...
    if (IsAiCoreSupport(self, index, dim)) {
        ...
        OP_CHECK(ret == ACLNN_SUCCESS,
                 OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "GatherElements AiCore ADD_TO_LAUNCHER_LIST_AICORE failed."),
                 return nullptr);
    } else {
        static internal::AicpuTaskSpace space("GatherElements");
        ret = ADD_TO_LAUNCHER_LIST_AICPU(GatherElements, OP_ATTR_NAMES({"dim"}), OP_INPUT(self, index), OP_OUTPUT(out),
                                         OP_ATTR(dim));
        OP_CHECK(ret == ACLNN_SUCCESS,
                 OP_LOGE(ACLNN_ERR_INNER_NULLPTR, "GatherElements AiCpu ADD_TO_LAUNCHER_LIST_AICPU failed."),
                 return nullptr);
    }
    return out;
}
