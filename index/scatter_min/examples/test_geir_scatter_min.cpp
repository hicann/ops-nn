 ...
 */
// test_geir for ScatterMin (GEIR graph-mode verification). Style follows the lamb test_geir templates.
#include <iostream>
#include <vector>
#include <string>
#include <map>
...
#include "array_ops.h"
#include "../op_graph/scatter_min_proto.h"
...
{
    auto op1 = op::ScatterMin("ScatterMin1");
