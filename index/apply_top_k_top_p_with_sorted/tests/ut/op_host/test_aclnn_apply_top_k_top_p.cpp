...
#include "../../../op_api/aclnn_apply_top_k_top_p.h"
...
protected:
    static void SetUpTestCase() { std::cout << "l2_apply_top_k_top_p_test SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "l2_apply_top_k_top_p_test TearDown" << std::endl; }

    void test_run(vector<int64_t> logitsDims, aclDataType logitsDtype, aclFormat logitsFormat,
                  vector<int64_t> logitsRange, vector<int64_t> pDims, aclDataType pDtype, aclFormat pFormat,
                  vector<int64_t> pRange, vector<int64_t> kDims, aclDataType kDtype, aclFormat kFormat,
                  vector<int64_t> kRange, vector<int64_t> outDims, aclDataType outDtype, aclFormat outFormat,
...
{
    test_run({4, 0}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 0}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_SUCCESS);
}

// p空tensor
TEST_F(l2_apply_top_k_top_p_test, l2_apply_top_k_top_p_test_p_empty_success)
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {0}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_SUCCESS);
}

// k空tensor
TEST_F(l2_apply_top_k_top_p_test, l2_apply_top_k_top_p_test_k_empty_success)
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {0}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_SUCCESS);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_SUCCESS);
}
...
{
    test_run({4, 1024}, ACL_FLOAT16, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT16, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT16, ACL_FORMAT_ND, ACLNN_SUCCESS);
}

// 正常路径，bfloat16
TEST_F(l2_apply_top_k_top_p_test, ascend910B2_l2_apply_top_k_top_p_test_bf16_success)
{
    test_run({4, 1024}, ACL_BF16, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_BF16, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_BF16, ACL_FORMAT_ND, ACLNN_SUCCESS);
}

// 正常路径，float16
TEST_F(l2_apply_top_k_top_p_test, l2_apply_top_k_top_p_test_fp16_last_dim_1_success)
{
    test_run({4, 1}, ACL_FLOAT16, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT16, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 1}, {4, 1}, ACL_FLOAT16, ACL_FORMAT_ND, ACLNN_SUCCESS);
}

// CheckDtypeEqual
TEST_F(l2_apply_top_k_top_p_test, l2_apply_top_k_top_p_test_logits_dtype_invalid)
{
    test_run({4, 1024}, ACL_INT32, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}

// CheckDtypeEqual
TEST_F(l2_apply_top_k_top_p_test, l2_apply_top_k_top_p_test_p_dtype_invalid)
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_INT32, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_FLOAT,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_INT32, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}

// CheckDtypeEqual
TEST_F(l2_apply_top_k_top_p_test, l2_apply_top_k_top_p_test_p_logits_dtype_not_equal)
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT16, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT16, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024, 1}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4, 1}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4, 1}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024, 1}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {1, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}

// CheckShapeValid
TEST_F(l2_apply_top_k_top_p_test, l2_apply_top_k_top_p_test_p_logits_shape_invalid)
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {2}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {2}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_UNDEFINED, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_UNDEFINED, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_UNDEFINED, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, ACLNN_ERR_PARAM_INVALID);
}
...
{
    test_run({4, 1024}, ACL_FLOAT, ACL_FORMAT_ND, {-1, 1}, {4}, ACL_FLOAT, ACL_FORMAT_ND, {0, 1}, {4}, ACL_INT32,
             ACL_FORMAT_ND, {1, 10}, {4, 1024}, ACL_FLOAT, ACL_FORMAT_UNDEFINED, ACLNN_ERR_PARAM_INVALID);
}
} // namespace TestAclnnApplyTopKTopP
