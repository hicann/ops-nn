...
{
    __ubuf__ INDEX_TYPE* sortedInputAddr = (__ubuf__ INDEX_TYPE*)sortedInput[(UB_AGLIN_VALUE / sizeof(INDEX_TYPE))]
                                               .GetPhyAddr();
    __ubuf__ int32_t* uniqueIndicesAddr = (__ubuf__ int32_t*)uniqueIndicesOut.GetPhyAddr();
