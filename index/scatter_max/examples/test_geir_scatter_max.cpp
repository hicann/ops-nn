 ...
 */
// test_geir for ScatterMax (GEIR graph-mode verification). Style follows the lamb test_geir templates.
#include <iostream>
#include <vector>
#include <string>
#include <map>
...
#include "array_ops.h"
#include "../op_graph/scatter_max_proto.h"
...
{
    auto op1 = op::ScatterMax("scatterMax1");
