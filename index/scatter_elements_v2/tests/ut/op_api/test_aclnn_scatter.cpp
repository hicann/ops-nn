...
protected:
    static void SetUpTestCase() { cout << "scatter_test SetUp" << endl; }

    static void TearDownTestCase() { cout << "scatter_test TearDown" << endl; }
    ...
    void test_run_invalid(vector<int64_t> selfDims, aclDataType selfDtype, aclFormat selfFormat,
                          ...
                          aclFormat indexFormat, vector<int64_t> indexRange, vector<int64_t> srcDims,
                          aclDataType srcDtype, aclFormat srcFormat, vector<int64_t> srcRange, vector<int64_t> outDims,
                          aclDataType outDtype, aclFormat outFormat, int64_t dim)
    {
        auto self = TensorDesc(selfDims, selfDtype, selfFormat).ValueRange(selfRange[0], selfRange[1]);
        auto index = TensorDesc(indexDims, indexDtype, indexFormat).ValueRange(indexRange[0], indexRange[1]);
        auto src = TensorDesc(srcDims, srcDtype, srcFormat).ValueRange(srcRange[0], srcRange[1]);
...
TEST_F(l2_scatter_test, l2_scatter_test_18)
{
    ...
    test_run({10, 15, 0}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {2, 5, 0}, ACL_INT64, ACL_FORMAT_ND, {0, 2}, {2, 5, 0},
             ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {10, 15, 0}, ACL_FLOAT16, ACL_FORMAT_ND, 0);
    // index + src empty
    test_run({10, 15, 15}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3, 0, 3}, ACL_INT64, ACL_FORMAT_ND, {0, 2},
             {3, 0, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {10, 15, 15}, ACL_FLOAT16, ACL_FORMAT_ND, 2);
    // index empty
    test_run({10, 15, 15}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3, 0, 3}, ACL_INT64, ACL_FORMAT_ND, {0, 2},
             {3, 5, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {10, 15, 15}, ACL_FLOAT16, ACL_FORMAT_ND, 2);

    // self empty
    test_run_invalid({10, 15, 0}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3, 5, 3}, ACL_INT64, ACL_FORMAT_ND, {0, 2},
                     {3, 5, 3}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {10, 15, 0}, ACL_FLOAT16, ACL_FORMAT_ND, 0);
    // src empty
    test_run_invalid({10, 15, 15}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {3, 5, 3}, ACL_INT64, ACL_FORMAT_ND, {0, 2},
                     {3, 5, 0}, ACL_FLOAT16, ACL_FORMAT_ND, {-10, 10}, {10, 15, 15}, ACL_FLOAT16, ACL_FORMAT_ND, 0);
}
