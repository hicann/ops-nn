...
每个算子分为[两段式接口](../../../docs/zh/context/two_phase_api.md)，必须先调用“aclnnScatterReduceGetWorkspaceSize”或者“aclnnInplaceScatterReduceGetWorkspaceSize”接口获取计算所需 workspace 大小以及包含了算子计算流程的执行器，再调用“aclnnScatterReduce”或者“aclnnInplaceScatterReduce”接口执行计算。
