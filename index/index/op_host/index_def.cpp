...
static const std::vector<ge::DataType> valueType = {
    ge::DT_INT64,   ge::DT_INT32, ge::DT_FLOAT,     ge::DT_FLOAT16, ge::DT_BF16,  ge::DT_INT8,
    ge::DT_UINT8,   ge::DT_BOOL,  ge::DT_COMPLEX64, ge::DT_INT64,   ge::DT_INT32, ge::DT_FLOAT,
    ge::DT_FLOAT16, ge::DT_BF16,  ge::DT_INT8,      ge::DT_UINT8,   ge::DT_BOOL,  ge::DT_COMPLEX64};
