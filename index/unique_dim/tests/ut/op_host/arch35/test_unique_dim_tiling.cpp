...
#include "../../../../op_host/op_tiling/unique_dim_tiling_arch35.h"

using namespace ut_util;
using namespace std;
using namespace ge;

class UniqueDimTilingTest : public testing::Test {
protected:
    static void SetUpTestCase() { std::cout << "UniqueDimTiling SetUp" << std::endl; }

    static void TearDownTestCase() { std::cout << "UniqueDimTiling TearDown" << std::endl; }
};
...
TEST_F(UniqueDimTilingTest, unique_dim_tiling_basic_float32)
{
    ...
    gert::StorageShape count_shape = {{8}, {8}};
    ...
    optiling::UniqueDimCompileInfo compile_info;

    std::string op_type("UniqueDim");
    ...
    auto holder = gert::TilingContextFaker()
                      ...
                      .IrInstanceNum({1})
                      .InputShapes({&x_shape})
                      .OutputShapes({&y_shape, &idx_shape, &count_shape})
    ...
    // non-empty input -> tiling key = 1 (TILING_KEY_BASE)
...
TEST_F(UniqueDimTilingTest, unique_dim_tiling_float16)
{
    ...
    gert::StorageShape count_shape = {{16}, {16}};
...
TEST_F(UniqueDimTilingTest, unique_dim_tiling_empty_input)
{
    ...
    gert::StorageShape count_shape = {{0}, {0}};
...
TEST_F(UniqueDimTilingTest, unique_dim_tiling_large_input)
{
    ...
    gert::StorageShape count_shape = {{1024}, {1024}};
...
TEST_F(UniqueDimTilingTest, unique_dim_tiling_1d)
{
    ...
    gert::StorageShape count_shape = {{100}, {100}};
