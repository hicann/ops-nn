...
static const std::set<ge::DataType> SIMT_SORT_DTYPE = {ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_INT64,
                                                       ge::DT_INT32};
static const std::set<ge::DataType> DETERMIN_DTYPE = {ge::DT_FLOAT, ge::DT_FLOAT16, ge::DT_BF16};

bool InplaceIndexAddTiling::IsCapable() { return true; }
...
ge::graphStatus InplaceIndexAddTiling::GetShapeAttrsInfo()
{
    ...
    OP_CHECK_IF((dim > dimMax || dim < dimMin),
                OP_LOGE_WITH_INVALID_ATTR(
                    context_->GetNodeName(), "axis", std::to_string(dim).c_str(),
...
ge::graphStatus InplaceIndexAddTiling::CheckInputDtype()
{
    ...
    OP_CHECK_IF((VAR_DTYPE.find(dtype_) == VAR_DTYPE.end()),
                OP_LOGE_FOR_INVALID_DTYPE(context_->GetNodeName(), "var", Ops::Base::ToString(dtype_).c_str(),
    ...
    OP_CHECK_IF((updatesDtype != dtype_),
                OP_LOGE_FOR_INVALID_DTYPES_WITH_REASON(
                    context_->GetNodeName(), "updates and var",
    ...
    if (varShape.IsScalar() && updatesAxis_ == 1 && indicesAxis_ == 1) {
        ...
        OP_CHECK_IF(!CompareShape(updatesShape, varShape, dim_),
                    OP_LOGE_FOR_INVALID_SHAPE_WITH_REASON(
                        context_->GetNodeName(), "updates", Ops::Base::ToString(updatesShape).c_str(),
...
ge::graphStatus InplaceIndexAddTiling::DoOpTiling() { return ge::GRAPH_SUCCESS; }

ge::graphStatus InplaceIndexAddTiling::DoLibApiTiling() { return ge::GRAPH_SUCCESS; }

uint64_t InplaceIndexAddTiling::GetTilingKey() const { return 0; }
...
ge::graphStatus InplaceIndexAddTiling::PostTiling() { return ge::GRAPH_SUCCESS; }
