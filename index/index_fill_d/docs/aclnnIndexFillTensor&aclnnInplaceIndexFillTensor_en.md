   ...
   <table style="undefined;table-layout: fixed; width: 1457px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>The element value is less than the size of dim corresponding to self.</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <table style="undefined;table-layout: fixed; width: 1244px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
      <td>The index value exceeds the maximum dim value of self.</td>
      </tr>
      <tr>
...
- **Parameters**
   ...
   <table style="undefined;table-layout: fixed; width: 1244px"><colgroup>
      ...
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnIndexFillTensorTensor.</td>
      </tr>
      <tr>
      <td>executor</td>
      <td>Input</td>
  ...
  <table style="undefined;table-layout: fixed; width: 1457px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Input</td>
        <td>Index to be filled by self in the dim dimension.</td>
        <td>The element value is less than the size of dim corresponding to selfRef.</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
  ...
  **aclnnStatus**: status code. For details, see [aclnn Return Codes](../../../docs/en/context/aclnn_return_codes_nn.md).
  ...
  <table style="undefined;table-layout: fixed; width: 1244px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
      <td>The index value exceeds the maximum dim value of selfRef.</td>
      </tr>
    </tbody>
    </table>
...
- **Parameters**
  ...
  <table style="undefined;table-layout: fixed; width: 1244px"><colgroup>
      ...
      <td>workspaceSize</td>
      <td>Input</td>
      <td>Size of the workspace to be allocated on the device, which is obtained by calling the first-phase API aclnnInplaceIndexFillTensorGetWorkspaceSize.</td>
      </tr>
      <tr>
      <td>executor</td>
      <td>Input</td>
...
int main() {
  ...
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnIndexFillTensor.
  ...
  // Call the second-phase API of aclnnIndexFillTensor.
...
int main() {
  ...
  uint64_t workspaceSize = 0;
  aclOpExecutor* executor;
  // Call the first-phase API of aclnnInplaceIndexFillTensor.
  ...
  // Call the second-phase API of aclnnInplaceIndexFillTensor.
